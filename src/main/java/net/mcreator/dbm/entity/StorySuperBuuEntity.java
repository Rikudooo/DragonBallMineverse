...
import net.mcreator.dbm.procedures.SuperBuuDefeatedProcedure;
...
public class StorySuperBuuEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StorySuperBuuEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StorySuperBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StorySuperBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StorySuperBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StorySuperBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StorySuperBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StorySuperBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StorySuperBuuEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StorySuperBuuEntity.class, EntityDataSerializers.STRING);

	public StorySuperBuuEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_SUPER_BUU.get(), world);
	}

	public StorySuperBuuEntity(EntityType<StorySuperBuuEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StorySuperBuuEntity.this.getRandom();
				double dir_x = StorySuperBuuEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StorySuperBuuEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StorySuperBuuEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StorySuperBuuEntity.this.getX();
				double y = StorySuperBuuEntity.this.getY();
				double z = StorySuperBuuEntity.this.getZ();
				Entity entity = StorySuperBuuEntity.this;
				Level world = StorySuperBuuEntity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		SuperBuuDefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ATTACK_DAMAGE, 2500);
