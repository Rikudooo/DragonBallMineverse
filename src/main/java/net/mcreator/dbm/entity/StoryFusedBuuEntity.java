...
public class StoryFusedBuuEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryFusedBuuEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryFusedBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryFusedBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryFusedBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryFusedBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryFusedBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryFusedBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryFusedBuuEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryFusedBuuEntity.class, EntityDataSerializers.STRING);

	public StoryFusedBuuEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_FUSED_BUU.get(), world);
	}

	public StoryFusedBuuEntity(EntityType<StoryFusedBuuEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryFusedBuuEntity.this.getRandom();
				double dir_x = StoryFusedBuuEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryFusedBuuEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryFusedBuuEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryFusedBuuEntity.this.getX();
				double y = StoryFusedBuuEntity.this.getY();
				double z = StoryFusedBuuEntity.this.getZ();
				Entity entity = StoryFusedBuuEntity.this;
				Level world = StoryFusedBuuEntity.this.level();
