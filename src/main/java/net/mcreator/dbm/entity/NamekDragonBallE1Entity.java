...
public class NamekDragonBallE1Entity extends PathfinderMob {
	public NamekDragonBallE1Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.NAMEK_DRAGON_BALL_E_1.get(), world);
	}

	public NamekDragonBallE1Entity(EntityType<NamekDragonBallE1Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
