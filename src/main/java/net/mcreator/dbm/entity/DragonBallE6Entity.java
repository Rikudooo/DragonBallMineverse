...
public class DragonBallE6Entity extends PathfinderMob {
	public DragonBallE6Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.DRAGON_BALL_E_6.get(), world);
	}

	public DragonBallE6Entity(EntityType<DragonBallE6Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
