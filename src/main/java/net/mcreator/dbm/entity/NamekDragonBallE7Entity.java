...
public class NamekDragonBallE7Entity extends PathfinderMob {
	public NamekDragonBallE7Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.NAMEK_DRAGON_BALL_E_7.get(), world);
	}

	public NamekDragonBallE7Entity(EntityType<NamekDragonBallE7Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
