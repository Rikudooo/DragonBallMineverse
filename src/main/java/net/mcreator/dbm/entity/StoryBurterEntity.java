...
import net.mcreator.dbm.procedures.BurterDefeatedProcedure;
import net.mcreator.dbm.procedures.BasicAttackPatternProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StoryBurterEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryBurterEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryBurterEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryBurterEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryBurterEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryBurterEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryBurterEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryBurterEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryBurterEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryBurterEntity.class, EntityDataSerializers.STRING);

	public StoryBurterEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_BURTER.get(), world);
	}

	public StoryBurterEntity(EntityType<StoryBurterEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryBurterEntity.this.getRandom();
				double dir_x = StoryBurterEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryBurterEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryBurterEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryBurterEntity.this.getX();
				double y = StoryBurterEntity.this.getY();
				double z = StoryBurterEntity.this.getZ();
				Entity entity = StoryBurterEntity.this;
				Level world = StoryBurterEntity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		BurterDefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
