...
public class DragonBallE1Entity extends PathfinderMob {
	public DragonBallE1Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.DRAGON_BALL_E_1.get(), world);
	}

	public DragonBallE1Entity(EntityType<DragonBallE1Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
