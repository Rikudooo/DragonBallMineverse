...
import net.mcreator.dbm.procedures.VegetaDefeatedProcedure;
import net.mcreator.dbm.procedures.VegetaAttackPatternProcedure;
import net.mcreator.dbm.procedures.StoryMobFlyConditionProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StoryVegetaEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryVegetaEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryVegetaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryVegetaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryVegetaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryVegetaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryVegetaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryVegetaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryVegetaEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryVegetaEntity.class, EntityDataSerializers.STRING);

	public StoryVegetaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_VEGETA.get(), world);
	}

	public StoryVegetaEntity(EntityType<StoryVegetaEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryVegetaEntity.this.getRandom();
				double dir_x = StoryVegetaEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryVegetaEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryVegetaEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryVegetaEntity.this.getX();
				double y = StoryVegetaEntity.this.getY();
				double z = StoryVegetaEntity.this.getZ();
				Entity entity = StoryVegetaEntity.this;
				Level world = StoryVegetaEntity.this.level();
	...
	public void baseTick() {
		super.baseTick();
		VegetaAttackPatternProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
