...
import net.mcreator.dbm.procedures.RecoomeDefeatedProcedure;
import net.mcreator.dbm.procedures.BasicAttackPatternProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StoryRecoomeEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryRecoomeEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryRecoomeEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryRecoomeEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryRecoomeEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryRecoomeEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryRecoomeEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryRecoomeEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryRecoomeEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryRecoomeEntity.class, EntityDataSerializers.STRING);

	public StoryRecoomeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_RECOOME.get(), world);
	}

	public StoryRecoomeEntity(EntityType<StoryRecoomeEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryRecoomeEntity.this.getRandom();
				double dir_x = StoryRecoomeEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryRecoomeEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryRecoomeEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryRecoomeEntity.this.getX();
				double y = StoryRecoomeEntity.this.getY();
				double z = StoryRecoomeEntity.this.getZ();
				Entity entity = StoryRecoomeEntity.this;
				Level world = StoryRecoomeEntity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		RecoomeDefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ATTACK_DAMAGE, 230);
