...
public class DragonBallE7Entity extends PathfinderMob {
	public DragonBallE7Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.DRAGON_BALL_E_7.get(), world);
	}

	public DragonBallE7Entity(EntityType<DragonBallE7Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
