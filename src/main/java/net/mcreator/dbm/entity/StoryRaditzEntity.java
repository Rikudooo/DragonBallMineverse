...
public class StoryRaditzEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryRaditzEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryRaditzEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryRaditzEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryRaditzEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryRaditzEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryRaditzEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryRaditzEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryRaditzEntity.class, EntityDataSerializers.BOOLEAN);

	public StoryRaditzEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_RADITZ.get(), world);
	}

	public StoryRaditzEntity(EntityType<StoryRaditzEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryRaditzEntity.this.getRandom();
				double dir_x = StoryRaditzEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryRaditzEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryRaditzEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryRaditzEntity.this.getX();
				double y = StoryRaditzEntity.this.getY();
				double z = StoryRaditzEntity.this.getZ();
				Entity entity = StoryRaditzEntity.this;
				Level world = StoryRaditzEntity.this.level();
