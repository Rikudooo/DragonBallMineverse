...
public class NamekDragonBallE2Entity extends PathfinderMob {
	public NamekDragonBallE2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.NAMEK_DRAGON_BALL_E_2.get(), world);
	}

	public NamekDragonBallE2Entity(EntityType<NamekDragonBallE2Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
