...
public class NamekDragonBallE3Entity extends PathfinderMob {
	public NamekDragonBallE3Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.NAMEK_DRAGON_BALL_E_3.get(), world);
	}

	public NamekDragonBallE3Entity(EntityType<NamekDragonBallE3Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
