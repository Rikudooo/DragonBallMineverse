...
public class DragonBallE3Entity extends PathfinderMob {
	public DragonBallE3Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.DRAGON_BALL_E_3.get(), world);
	}

	public DragonBallE3Entity(EntityType<DragonBallE3Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
