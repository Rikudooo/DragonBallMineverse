...
import net.mcreator.dbm.procedures.NappaDefeatedProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StoryNappaEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryNappaEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryNappaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryNappaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryNappaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryNappaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryNappaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryNappaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryNappaEntity.class, EntityDataSerializers.BOOLEAN);

	public StoryNappaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_NAPPA.get(), world);
	}

	public StoryNappaEntity(EntityType<StoryNappaEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryNappaEntity.this.getRandom();
				double dir_x = StoryNappaEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryNappaEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryNappaEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryNappaEntity.this.getX();
				double y = StoryNappaEntity.this.getY();
				double z = StoryNappaEntity.this.getZ();
				Entity entity = StoryNappaEntity.this;
				Level world = StoryNappaEntity.this.level();
