...
public class NamekDragonBallE6Entity extends PathfinderMob {
	public NamekDragonBallE6Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.NAMEK_DRAGON_BALL_E_6.get(), world);
	}

	public NamekDragonBallE6Entity(EntityType<NamekDragonBallE6Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
