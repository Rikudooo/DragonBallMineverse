...
import net.mcreator.dbm.procedures.KidBuuDefeatedProcedure;
import net.mcreator.dbm.procedures.BasicAttackPatternProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StoryKidBuuEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryKidBuuEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryKidBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryKidBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryKidBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryKidBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryKidBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryKidBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryKidBuuEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryKidBuuEntity.class, EntityDataSerializers.STRING);

	public StoryKidBuuEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_KID_BUU.get(), world);
	}

	public StoryKidBuuEntity(EntityType<StoryKidBuuEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryKidBuuEntity.this.getRandom();
				double dir_x = StoryKidBuuEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryKidBuuEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryKidBuuEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryKidBuuEntity.this.getX();
				double y = StoryKidBuuEntity.this.getY();
				double z = StoryKidBuuEntity.this.getZ();
				Entity entity = StoryKidBuuEntity.this;
				Level world = StoryKidBuuEntity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		KidBuuDefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ATTACK_DAMAGE, 2650);
