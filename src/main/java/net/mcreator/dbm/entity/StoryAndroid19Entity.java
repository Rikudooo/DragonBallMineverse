...
import net.mcreator.dbm.procedures.Android19DefeatedProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StoryAndroid19Entity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryAndroid19Entity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryAndroid19Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryAndroid19Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryAndroid19Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryAndroid19Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryAndroid19Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryAndroid19Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryAndroid19Entity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryAndroid19Entity.class, EntityDataSerializers.STRING);

	public StoryAndroid19Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_ANDROID_19.get(), world);
	}

	public StoryAndroid19Entity(EntityType<StoryAndroid19Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryAndroid19Entity.this.getRandom();
				double dir_x = StoryAndroid19Entity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryAndroid19Entity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryAndroid19Entity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryAndroid19Entity.this.getX();
				double y = StoryAndroid19Entity.this.getY();
				double z = StoryAndroid19Entity.this.getZ();
				Entity entity = StoryAndroid19Entity.this;
				Level world = StoryAndroid19Entity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		Android19DefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
