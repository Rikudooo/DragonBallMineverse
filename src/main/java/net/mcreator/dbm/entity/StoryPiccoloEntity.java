...
public class StoryPiccoloEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryPiccoloEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryPiccoloEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryPiccoloEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryPiccoloEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryPiccoloEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryPiccoloEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryPiccoloEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryPiccoloEntity.class, EntityDataSerializers.BOOLEAN);

	public StoryPiccoloEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_PICCOLO.get(), world);
	}

	public StoryPiccoloEntity(EntityType<StoryPiccoloEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryPiccoloEntity.this.getRandom();
				double dir_x = StoryPiccoloEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryPiccoloEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryPiccoloEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryPiccoloEntity.this.getX();
				double y = StoryPiccoloEntity.this.getY();
				double z = StoryPiccoloEntity.this.getZ();
				Entity entity = StoryPiccoloEntity.this;
				Level world = StoryPiccoloEntity.this.level();
