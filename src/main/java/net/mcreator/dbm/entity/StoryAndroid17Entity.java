...
import net.mcreator.dbm.procedures.Android17DefeatedProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StoryAndroid17Entity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryAndroid17Entity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryAndroid17Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryAndroid17Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryAndroid17Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryAndroid17Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryAndroid17Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryAndroid17Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryAndroid17Entity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryAndroid17Entity.class, EntityDataSerializers.STRING);

	public StoryAndroid17Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_ANDROID_17.get(), world);
	}

	public StoryAndroid17Entity(EntityType<StoryAndroid17Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryAndroid17Entity.this.getRandom();
				double dir_x = StoryAndroid17Entity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryAndroid17Entity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryAndroid17Entity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryAndroid17Entity.this.getX();
				double y = StoryAndroid17Entity.this.getY();
				double z = StoryAndroid17Entity.this.getZ();
				Entity entity = StoryAndroid17Entity.this;
				Level world = StoryAndroid17Entity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		Android17DefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
