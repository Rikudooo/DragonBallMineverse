...
public class DragonBallE5Entity extends PathfinderMob {
	public DragonBallE5Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.DRAGON_BALL_E_5.get(), world);
	}

	public DragonBallE5Entity(EntityType<DragonBallE5Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
