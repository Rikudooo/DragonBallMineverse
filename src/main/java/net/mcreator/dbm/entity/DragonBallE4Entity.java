...
public class DragonBallE4Entity extends PathfinderMob {
	public DragonBallE4Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.DRAGON_BALL_E_4.get(), world);
	}

	public DragonBallE4Entity(EntityType<DragonBallE4Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
