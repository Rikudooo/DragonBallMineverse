...
import net.mcreator.dbm.procedures.OpenDendeGUIProcedure;
...
public class DendeEntity extends PathfinderMob {
	public DendeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.DENDE.get(), world);
	}

	public DendeEntity(EntityType<DendeEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		OpenDendeGUIProcedure.execute(world, x, y, z, sourceentity);
		return retval;
	}
