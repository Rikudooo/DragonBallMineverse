...
import net.mcreator.dbm.procedures.DodoriaDefeatedProcedure;
import net.mcreator.dbm.procedures.BasicAttackPatternProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StoryDodoriaEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryDodoriaEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryDodoriaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryDodoriaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryDodoriaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryDodoriaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryDodoriaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryDodoriaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryDodoriaEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryDodoriaEntity.class, EntityDataSerializers.STRING);

	public StoryDodoriaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_DODORIA.get(), world);
	}

	public StoryDodoriaEntity(EntityType<StoryDodoriaEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryDodoriaEntity.this.getRandom();
				double dir_x = StoryDodoriaEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryDodoriaEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryDodoriaEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryDodoriaEntity.this.getX();
				double y = StoryDodoriaEntity.this.getY();
				double z = StoryDodoriaEntity.this.getZ();
				Entity entity = StoryDodoriaEntity.this;
				Level world = StoryDodoriaEntity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		DodoriaDefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
