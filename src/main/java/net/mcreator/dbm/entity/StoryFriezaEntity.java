...
import net.mcreator.dbm.procedures.FriezaAttackPatternProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StoryFriezaEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryFriezaEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryFriezaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryFriezaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryFriezaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryFriezaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryFriezaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryFriezaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryFriezaEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryFriezaEntity.class, EntityDataSerializers.STRING);

	public StoryFriezaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_FRIEZA.get(), world);
	}

	public StoryFriezaEntity(EntityType<StoryFriezaEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryFriezaEntity.this.getRandom();
				double dir_x = StoryFriezaEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryFriezaEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryFriezaEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryFriezaEntity.this.getX();
				double y = StoryFriezaEntity.this.getY();
				double z = StoryFriezaEntity.this.getZ();
				Entity entity = StoryFriezaEntity.this;
				Level world = StoryFriezaEntity.this.level();
	...
	public void baseTick() {
		super.baseTick();
		FriezaAttackPatternProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
