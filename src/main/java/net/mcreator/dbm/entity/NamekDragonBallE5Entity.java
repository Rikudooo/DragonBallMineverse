...
public class NamekDragonBallE5Entity extends PathfinderMob {
	public NamekDragonBallE5Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.NAMEK_DRAGON_BALL_E_5.get(), world);
	}

	public NamekDragonBallE5Entity(EntityType<NamekDragonBallE5Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
