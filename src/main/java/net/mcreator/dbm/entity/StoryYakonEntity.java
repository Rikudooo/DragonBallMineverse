...
import net.mcreator.dbm.procedures.YakonDefeatedProcedure;
...
public class StoryYakonEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryYakonEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryYakonEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryYakonEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryYakonEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryYakonEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryYakonEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryYakonEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryYakonEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryYakonEntity.class, EntityDataSerializers.STRING);

	public StoryYakonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_YAKON.get(), world);
	}

	public StoryYakonEntity(EntityType<StoryYakonEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryYakonEntity.this.getRandom();
				double dir_x = StoryYakonEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryYakonEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryYakonEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryYakonEntity.this.getX();
				double y = StoryYakonEntity.this.getY();
				double z = StoryYakonEntity.this.getZ();
				Entity entity = StoryYakonEntity.this;
				Level world = StoryYakonEntity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		YakonDefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ATTACK_DAMAGE, 900);
