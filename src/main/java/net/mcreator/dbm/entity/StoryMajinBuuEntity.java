...
import net.mcreator.dbm.procedures.MajinBuuDefeatedProcedure;
import net.mcreator.dbm.procedures.BasicAttackPatternProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StoryMajinBuuEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryMajinBuuEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryMajinBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryMajinBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryMajinBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryMajinBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryMajinBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryMajinBuuEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryMajinBuuEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryMajinBuuEntity.class, EntityDataSerializers.STRING);

	public StoryMajinBuuEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_MAJIN_BUU.get(), world);
	}

	public StoryMajinBuuEntity(EntityType<StoryMajinBuuEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryMajinBuuEntity.this.getRandom();
				double dir_x = StoryMajinBuuEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryMajinBuuEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryMajinBuuEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryMajinBuuEntity.this.getX();
				double y = StoryMajinBuuEntity.this.getY();
				double z = StoryMajinBuuEntity.this.getZ();
				Entity entity = StoryMajinBuuEntity.this;
				Level world = StoryMajinBuuEntity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		MajinBuuDefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ATTACK_DAMAGE, 2100);
