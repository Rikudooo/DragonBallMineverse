...
import net.mcreator.dbm.procedures.TagomaDefeatedProcedure;
...
public class StoryTagomaEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryTagomaEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryTagomaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryTagomaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryTagomaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryTagomaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryTagomaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryTagomaEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryTagomaEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryTagomaEntity.class, EntityDataSerializers.STRING);

	public StoryTagomaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_TAGOMA.get(), world);
	}

	public StoryTagomaEntity(EntityType<StoryTagomaEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryTagomaEntity.this.getRandom();
				double dir_x = StoryTagomaEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryTagomaEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryTagomaEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryTagomaEntity.this.getX();
				double y = StoryTagomaEntity.this.getY();
				double z = StoryTagomaEntity.this.getZ();
				Entity entity = StoryTagomaEntity.this;
				Level world = StoryTagomaEntity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		TagomaDefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ATTACK_DAMAGE, 2000);
