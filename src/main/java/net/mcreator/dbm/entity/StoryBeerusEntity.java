...
import net.mcreator.dbm.procedures.BeerusDefeatedProcedure;
import net.mcreator.dbm.procedures.BeerusAttackPatternProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StoryBeerusEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryBeerusEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryBeerusEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryBeerusEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryBeerusEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryBeerusEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryBeerusEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryBeerusEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryBeerusEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryBeerusEntity.class, EntityDataSerializers.STRING);

	public StoryBeerusEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_BEERUS.get(), world);
	}

	public StoryBeerusEntity(EntityType<StoryBeerusEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryBeerusEntity.this.getRandom();
				double dir_x = StoryBeerusEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryBeerusEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryBeerusEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryBeerusEntity.this.getX();
				double y = StoryBeerusEntity.this.getY();
				double z = StoryBeerusEntity.this.getZ();
				Entity entity = StoryBeerusEntity.this;
				Level world = StoryBeerusEntity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		BeerusDefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public void baseTick() {
		super.baseTick();
		BeerusAttackPatternProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
