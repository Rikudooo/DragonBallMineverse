...
public class NamekDragonBallE4Entity extends PathfinderMob {
	public NamekDragonBallE4Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.NAMEK_DRAGON_BALL_E_4.get(), world);
	}

	public NamekDragonBallE4Entity(EntityType<NamekDragonBallE4Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		DragonBallSpawnProcedure.execute();
		return retval;
	}
