...
public class DragonBallE2Entity extends PathfinderMob {
	public DragonBallE2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.DRAGON_BALL_E_2.get(), world);
	}

	public DragonBallE2Entity(EntityType<DragonBallE2Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
