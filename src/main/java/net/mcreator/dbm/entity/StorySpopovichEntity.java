...
import net.mcreator.dbm.procedures.SpopovichDefeatedProcedure;
import net.mcreator.dbm.procedures.BasicAttackPatternProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StorySpopovichEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StorySpopovichEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StorySpopovichEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StorySpopovichEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StorySpopovichEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StorySpopovichEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StorySpopovichEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StorySpopovichEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StorySpopovichEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StorySpopovichEntity.class, EntityDataSerializers.STRING);

	public StorySpopovichEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_SPOPOVICH.get(), world);
	}

	public StorySpopovichEntity(EntityType<StorySpopovichEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StorySpopovichEntity.this.getRandom();
				double dir_x = StorySpopovichEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StorySpopovichEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StorySpopovichEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StorySpopovichEntity.this.getX();
				double y = StorySpopovichEntity.this.getY();
				double z = StorySpopovichEntity.this.getZ();
				Entity entity = StorySpopovichEntity.this;
				Level world = StorySpopovichEntity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		SpopovichDefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ATTACK_DAMAGE, 760);
