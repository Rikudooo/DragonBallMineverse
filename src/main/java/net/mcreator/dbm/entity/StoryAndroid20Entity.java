...
import net.mcreator.dbm.procedures.Android20DefeatedProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StoryAndroid20Entity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryAndroid20Entity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryAndroid20Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryAndroid20Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryAndroid20Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryAndroid20Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryAndroid20Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryAndroid20Entity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryAndroid20Entity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryAndroid20Entity.class, EntityDataSerializers.STRING);

	public StoryAndroid20Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_ANDROID_20.get(), world);
	}

	public StoryAndroid20Entity(EntityType<StoryAndroid20Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryAndroid20Entity.this.getRandom();
				double dir_x = StoryAndroid20Entity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryAndroid20Entity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryAndroid20Entity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryAndroid20Entity.this.getX();
				double y = StoryAndroid20Entity.this.getY();
				double z = StoryAndroid20Entity.this.getZ();
				Entity entity = StoryAndroid20Entity.this;
				Level world = StoryAndroid20Entity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		Android20DefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ATTACK_DAMAGE, 550);
