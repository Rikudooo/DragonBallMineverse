...
import net.mcreator.dbm.procedures.CellJrDefeatedProcedure;
import net.mcreator.dbm.procedures.CellJrAttackPatternProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StoryCellJrEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryCellJrEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryCellJrEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryCellJrEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryCellJrEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryCellJrEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryCellJrEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryCellJrEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryCellJrEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryCellJrEntity.class, EntityDataSerializers.STRING);

	public StoryCellJrEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_CELL_JR.get(), world);
	}

	public StoryCellJrEntity(EntityType<StoryCellJrEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryCellJrEntity.this.getRandom();
				double dir_x = StoryCellJrEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryCellJrEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryCellJrEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryCellJrEntity.this.getX();
				double y = StoryCellJrEntity.this.getY();
				double z = StoryCellJrEntity.this.getZ();
				Entity entity = StoryCellJrEntity.this;
				Level world = StoryCellJrEntity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		CellJrDefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public void baseTick() {
		super.baseTick();
		CellJrAttackPatternProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
