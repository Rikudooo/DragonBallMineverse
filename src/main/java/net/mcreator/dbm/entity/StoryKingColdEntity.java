...
import net.mcreator.dbm.procedures.KingColdDefeatedProcedure;
import net.mcreator.dbm.procedures.BasicAttackPatternProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StoryKingColdEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryKingColdEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryKingColdEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryKingColdEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryKingColdEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryKingColdEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryKingColdEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryKingColdEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryKingColdEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryKingColdEntity.class, EntityDataSerializers.STRING);

	public StoryKingColdEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_KING_COLD.get(), world);
	}

	public StoryKingColdEntity(EntityType<StoryKingColdEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryKingColdEntity.this.getRandom();
				double dir_x = StoryKingColdEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryKingColdEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryKingColdEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryKingColdEntity.this.getX();
				double y = StoryKingColdEntity.this.getY();
				double z = StoryKingColdEntity.this.getZ();
				Entity entity = StoryKingColdEntity.this;
				Level world = StoryKingColdEntity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		KingColdDefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
