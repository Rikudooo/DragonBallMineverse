...
import net.mcreator.dbm.procedures.PuipuiDefeatedProcedure;
import net.mcreator.dbm.procedures.BasicAttackPatternProcedure;
import net.mcreator.dbm.init.DbmModEntities;

public class StoryPuipuiEntity extends Monster {
	public static final EntityDataAccessor<String> DATA_SelectedKiAttack = SynchedEntityData.defineId(StoryPuipuiEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_KiAttackSize = SynchedEntityData.defineId(StoryPuipuiEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldYAW = SynchedEntityData.defineId(StoryPuipuiEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_OldPITCH = SynchedEntityData.defineId(StoryPuipuiEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_KiAttackHits = SynchedEntityData.defineId(StoryPuipuiEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Scale = SynchedEntityData.defineId(StoryPuipuiEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> DATA_Ki = SynchedEntityData.defineId(StoryPuipuiEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_KiCharging = SynchedEntityData.defineId(StoryPuipuiEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> DATA_Form = SynchedEntityData.defineId(StoryPuipuiEntity.class, EntityDataSerializers.STRING);

	public StoryPuipuiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DbmModEntities.STORY_PUIPUI.get(), world);
	}

	public StoryPuipuiEntity(EntityType<StoryPuipuiEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1.2, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = StoryPuipuiEntity.this.getRandom();
				double dir_x = StoryPuipuiEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = StoryPuipuiEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = StoryPuipuiEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = StoryPuipuiEntity.this.getX();
				double y = StoryPuipuiEntity.this.getY();
				double z = StoryPuipuiEntity.this.getZ();
				Entity entity = StoryPuipuiEntity.this;
				Level world = StoryPuipuiEntity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		PuipuiDefeatedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
