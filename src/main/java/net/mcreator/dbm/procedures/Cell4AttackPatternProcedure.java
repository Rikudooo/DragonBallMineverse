...
public class Cell4AttackPatternProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof StoryCell4Entity _datEntS ? _datEntS.getEntityData().get(StoryCell4Entity.DATA_Form) : "").equals("Base")) {
			if ((entity instanceof LivingEntity _livingEntity1 && _livingEntity1.getAttributes().hasAttribute(Attributes.MAX_HEALTH) ? _livingEntity1.getAttribute(Attributes.MAX_HEALTH).getBaseValue() : 0) != 70000) {
				if (entity instanceof LivingEntity _livingEntity2 && _livingEntity2.getAttributes().hasAttribute(Attributes.MAX_HEALTH))
					_livingEntity2.getAttribute(Attributes.MAX_HEALTH).setBaseValue(70000);
			}
			...
			if ((entity instanceof LivingEntity _livingEntity4 && _livingEntity4.getAttributes().hasAttribute(Attributes.MAX_HEALTH) ? _livingEntity4.getAttribute(Attributes.MAX_HEALTH).getBaseValue() : 0) != 65000) {
				if (entity instanceof LivingEntity _livingEntity5 && _livingEntity5.getAttributes().hasAttribute(Attributes.MAX_HEALTH))
					_livingEntity5.getAttribute(Attributes.MAX_HEALTH).setBaseValue(65000);
			}
			if ((entity instanceof LivingEntity _livingEntity6 && _livingEntity6.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE) ? _livingEntity6.getAttribute(Attributes.ATTACK_DAMAGE).getBaseValue() : 0) != 1000) {
				if (entity instanceof LivingEntity _livingEntity7 && _livingEntity7.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE))
					_livingEntity7.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue(1000);
			}
		} else if ((entity instanceof StoryCell4Entity _datEntS ? _datEntS.getEntityData().get(StoryCell4Entity.DATA_Form) : "").equals("Super Perfect")) {
			if ((entity instanceof LivingEntity _livingEntity9 && _livingEntity9.getAttributes().hasAttribute(Attributes.MAX_HEALTH) ? _livingEntity9.getAttribute(Attributes.MAX_HEALTH).getBaseValue() : 0) != 80000) {
				if (entity instanceof LivingEntity _livingEntity10 && _livingEntity10.getAttributes().hasAttribute(Attributes.MAX_HEALTH))
					_livingEntity10.getAttribute(Attributes.MAX_HEALTH).setBaseValue(80000);
			}
			if ((entity instanceof LivingEntity _livingEntity11 && _livingEntity11.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE) ? _livingEntity11.getAttribute(Attributes.ATTACK_DAMAGE).getBaseValue() : 0) != 1700) {
				if (entity instanceof LivingEntity _livingEntity12 && _livingEntity12.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE))
					_livingEntity12.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue(1700);
			}
		}
			...
			if (!(null == (entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null))) {
				if (entity.getPersistentData().getBoolean("UsingKiAttack") == false) {
						...
						if (((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) != null ? entity.distanceTo((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null)) : -1) > 10
							...
							if (entity.getPersistentData().getBoolean("YawNPitch") == false) {
								entity.lookAt(EntityAnchorArgument.Anchor.EYES, new Vec3(((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getX()), ((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getY()),
										((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getZ())));
								if (entity instanceof StoryCell4Entity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryCell4Entity.DATA_OldYAW, (int) entity.getYRot());
								if (entity instanceof StoryCell4Entity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryCell4Entity.DATA_OldPITCH, (int) entity.getXRot());
								if (entity instanceof StoryCell4Entity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryCell4Entity.DATA_KiAttackSize, 70);
								if (entity instanceof StoryCell4Entity _datEntSetS)
									_datEntSetS.getEntityData().set(StoryCell4Entity.DATA_SelectedKiAttack, "Kamehameha");
					...
					if (entity.getPersistentData().getDouble("KiAttackDuration") < 80) {
						{
							Entity _ent = entity;
							_ent.setYRot((float) (entity instanceof StoryCell4Entity _datEntI ? _datEntI.getEntityData().get(StoryCell4Entity.DATA_OldYAW) : 0));
							_ent.setXRot((float) (entity instanceof StoryCell4Entity _datEntI ? _datEntI.getEntityData().get(StoryCell4Entity.DATA_OldPITCH) : 0));
						...
						for (int index0 = 0; index0 < 70; index0++) {
							{
								final Vec3 _center = new Vec3((entity.getX() + entity.getLookAngle().x * (entity instanceof StoryCell4Entity _datEntI ? _datEntI.getEntityData().get(StoryCell4Entity.DATA_KiAttackHits) : 0)),
										(entity.getY() + entity.getLookAngle().y * (entity instanceof StoryCell4Entity _datEntI ? _datEntI.getEntityData().get(StoryCell4Entity.DATA_KiAttackHits) : 0)),
										(entity.getZ() + entity.getLookAngle().z * (entity instanceof StoryCell4Entity _datEntI ? _datEntI.getEntityData().get(StoryCell4Entity.DATA_KiAttackHits) : 0)));
								...
								for (Entity entityiterator : _entfound) {
									if (!(entity == entityiterator)) {
										entityiterator.hurt(new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation("dbm:kikoha")))),
												(float) ((entity instanceof LivingEntity _livingEntity94 && _livingEntity94.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE)
														? _livingEntity94.getAttribute(Attributes.ATTACK_DAMAGE).getBaseValue()
														: 0) * 3));
							...
							if (entity instanceof StoryCell4Entity _datEntSetI)
								_datEntSetI.getEntityData().set(StoryCell4Entity.DATA_KiAttackHits, (int) ((entity instanceof StoryCell4Entity _datEntI ? _datEntI.getEntityData().get(StoryCell4Entity.DATA_KiAttackHits) : 0) + 2));
						}
						if (entity instanceof StoryCell4Entity _datEntSetI)
							_datEntSetI.getEntityData().set(StoryCell4Entity.DATA_KiAttackHits, 0);
