...
public class FusedBuuAttackPatternProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof StoryFusedBuuEntity _datEntS ? _datEntS.getEntityData().get(StoryFusedBuuEntity.DATA_Form) : "").equals("Base")) {
			if ((entity instanceof LivingEntity _livingEntity1 && _livingEntity1.getAttributes().hasAttribute(Attributes.MAX_HEALTH) ? _livingEntity1.getAttribute(Attributes.MAX_HEALTH).getBaseValue() : 0) != 85000) {
				if (entity instanceof LivingEntity _livingEntity2 && _livingEntity2.getAttributes().hasAttribute(Attributes.MAX_HEALTH))
					_livingEntity2.getAttribute(Attributes.MAX_HEALTH).setBaseValue(85000);
			}
			...
			if ((entity instanceof LivingEntity _livingEntity4 && _livingEntity4.getAttributes().hasAttribute(Attributes.MAX_HEALTH) ? _livingEntity4.getAttribute(Attributes.MAX_HEALTH).getBaseValue() : 0) != 87000) {
				if (entity instanceof LivingEntity _livingEntity5 && _livingEntity5.getAttributes().hasAttribute(Attributes.MAX_HEALTH))
					_livingEntity5.getAttribute(Attributes.MAX_HEALTH).setBaseValue(87000);
			}
			if ((entity instanceof LivingEntity _livingEntity6 && _livingEntity6.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE) ? _livingEntity6.getAttribute(Attributes.ATTACK_DAMAGE).getBaseValue() : 0) != 2600) {
				if (entity instanceof LivingEntity _livingEntity7 && _livingEntity7.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE))
					_livingEntity7.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue(2600);
			}
			...
			if ((entity instanceof LivingEntity _livingEntity9 && _livingEntity9.getAttributes().hasAttribute(Attributes.MAX_HEALTH) ? _livingEntity9.getAttribute(Attributes.MAX_HEALTH).getBaseValue() : 0) != 85500) {
				if (entity instanceof LivingEntity _livingEntity10 && _livingEntity10.getAttributes().hasAttribute(Attributes.MAX_HEALTH))
					_livingEntity10.getAttribute(Attributes.MAX_HEALTH).setBaseValue(85500);
			}
			if ((entity instanceof LivingEntity _livingEntity11 && _livingEntity11.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE) ? _livingEntity11.getAttribute(Attributes.ATTACK_DAMAGE).getBaseValue() : 0) != 2550) {
				if (entity instanceof LivingEntity _livingEntity12 && _livingEntity12.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE))
					_livingEntity12.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue(2550);
			}
		} else if ((entity instanceof StoryFusedBuuEntity _datEntS ? _datEntS.getEntityData().get(StoryFusedBuuEntity.DATA_Form) : "").equals("Gohan")) {
			if ((entity instanceof LivingEntity _livingEntity14 && _livingEntity14.getAttributes().hasAttribute(Attributes.MAX_HEALTH) ? _livingEntity14.getAttribute(Attributes.MAX_HEALTH).getBaseValue() : 0) != 94500) {
				if (entity instanceof LivingEntity _livingEntity15 && _livingEntity15.getAttributes().hasAttribute(Attributes.MAX_HEALTH))
					_livingEntity15.getAttribute(Attributes.MAX_HEALTH).setBaseValue(94500);
			}
			if ((entity instanceof LivingEntity _livingEntity16 && _livingEntity16.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE) ? _livingEntity16.getAttribute(Attributes.ATTACK_DAMAGE).getBaseValue() : 0) != 2750) {
				if (entity instanceof LivingEntity _livingEntity17 && _livingEntity17.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE))
					_livingEntity17.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue(2750);
			}
		}
				...
				if (entity.getPersistentData().getBoolean("UsingKiAttack") == false) {
					if (Math.random() < 0.3) {
						...
						if (entity instanceof StoryFusedBuuEntity _datEntSetS)
							_datEntSetS.getEntityData().set(StoryFusedBuuEntity.DATA_SelectedKiAttack, "None");
						...
						if (((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) != null ? entity.distanceTo((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null)) : -1) > 10
								...
								if (!projectileLevel.isClientSide()) {
									Projectile _entityToSpawn = new Object() {
										public Projectile getArrow(Level level, Entity shooter, float damage, int knockback, byte piercing) {
											AbstractArrow entityToSpawn = new KiBlastEntity(DbmModEntities.KI_BLAST.get(), level);
											...
											(float) ((entity instanceof LivingEntity _livingEntity50 && _livingEntity50.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE)
													? _livingEntity50.getAttribute(Attributes.ATTACK_DAMAGE).getBaseValue()
													: 0) * 3.5),
											1, (byte) 1);
							...
							if (entity.getPersistentData().getBoolean("YawNPitch") == false) {
								entity.lookAt(EntityAnchorArgument.Anchor.EYES, new Vec3(((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getX()), ((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getY()),
										((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getZ())));
								if (entity instanceof StoryFusedBuuEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryFusedBuuEntity.DATA_OldYAW, (int) entity.getYRot());
								if (entity instanceof StoryFusedBuuEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryFusedBuuEntity.DATA_OldPITCH, (int) entity.getXRot());
								if (entity instanceof StoryFusedBuuEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryFusedBuuEntity.DATA_KiAttackSize, 70);
								if (entity instanceof StoryFusedBuuEntity _datEntSetS)
									_datEntSetS.getEntityData().set(StoryFusedBuuEntity.DATA_SelectedKiAttack, "Kamehameha");
					...
					if (entity.getPersistentData().getDouble("KiAttackDuration") < 80) {
						{
							Entity _ent = entity;
							_ent.setYRot((float) (entity instanceof StoryFusedBuuEntity _datEntI ? _datEntI.getEntityData().get(StoryFusedBuuEntity.DATA_OldYAW) : 0));
							_ent.setXRot((float) (entity instanceof StoryFusedBuuEntity _datEntI ? _datEntI.getEntityData().get(StoryFusedBuuEntity.DATA_OldPITCH) : 0));
						...
						for (int index0 = 0; index0 < 70; index0++) {
							{
								final Vec3 _center = new Vec3((entity.getX() + entity.getLookAngle().x * (entity instanceof StoryFusedBuuEntity _datEntI ? _datEntI.getEntityData().get(StoryFusedBuuEntity.DATA_KiAttackHits) : 0)),
										(entity.getY() + entity.getLookAngle().y * (entity instanceof StoryFusedBuuEntity _datEntI ? _datEntI.getEntityData().get(StoryFusedBuuEntity.DATA_KiAttackHits) : 0)),
										(entity.getZ() + entity.getLookAngle().z * (entity instanceof StoryFusedBuuEntity _datEntI ? _datEntI.getEntityData().get(StoryFusedBuuEntity.DATA_KiAttackHits) : 0)));
								...
								for (Entity entityiterator : _entfound) {
									if (!(entity == entityiterator)) {
										entityiterator.hurt(new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation("dbm:kikoha")))),
												(float) ((entity instanceof LivingEntity _livingEntity99 && _livingEntity99.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE)
														? _livingEntity99.getAttribute(Attributes.ATTACK_DAMAGE).getBaseValue()
														: 0) * 3));
							...
							if (entity instanceof StoryFusedBuuEntity _datEntSetI)
								_datEntSetI.getEntityData().set(StoryFusedBuuEntity.DATA_KiAttackHits, (int) ((entity instanceof StoryFusedBuuEntity _datEntI ? _datEntI.getEntityData().get(StoryFusedBuuEntity.DATA_KiAttackHits) : 0) + 2));
						}
						if (entity instanceof StoryFusedBuuEntity _datEntSetI)
							_datEntSetI.getEntityData().set(StoryFusedBuuEntity.DATA_KiAttackHits, 0);
					...
					if (entity.getPersistentData().getDouble("KiAttackDuration") >= 40) {
						if (entity instanceof StoryCell4Entity _datEntSetS)
							_datEntSetS.getEntityData().set(StoryCell4Entity.DATA_SelectedKiAttack, "None");
						entity.getPersistentData().putBoolean("UsingKiAttack", false);
						entity.getPersistentData().putDouble("KiAttackDuration", 0);
