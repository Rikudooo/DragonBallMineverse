...
public class DestroyerAngerRenderProcedure {
	...
	private static boolean begin(VertexFormat.Mode mode, VertexFormat format, boolean update) {
		if (DestroyerAngerRenderProcedure.bufferBuilder == null || !DestroyerAngerRenderProcedure.bufferBuilder.building()) {
			if (update)
				clear();
			if (DestroyerAngerRenderProcedure.vertexBuffer == null) {
				if (format == DefaultVertexFormat.POSITION_COLOR) {
					DestroyerAngerRenderProcedure.mode = mode;
					DestroyerAngerRenderProcedure.format = format;
					DestroyerAngerRenderProcedure.bufferBuilder = Tesselator.getInstance().getBuilder();
					DestroyerAngerRenderProcedure.bufferBuilder.begin(mode, DefaultVertexFormat.POSITION_COLOR);
					return true;
				} else if (format == DefaultVertexFormat.POSITION_TEX_COLOR) {
					DestroyerAngerRenderProcedure.mode = mode;
					DestroyerAngerRenderProcedure.format = format;
					DestroyerAngerRenderProcedure.bufferBuilder = Tesselator.getInstance().getBuilder();
					DestroyerAngerRenderProcedure.bufferBuilder.begin(mode, DefaultVertexFormat.POSITION_TEX_COLOR);
					return true;
				}
			}
		}
	...
	private static void system(boolean worldCoordinate) {
		DestroyerAngerRenderProcedure.worldCoordinate = worldCoordinate;
	}

	private static boolean target(int targetStage) {
		if (targetStage == currentStage) {
			DestroyerAngerRenderProcedure.targetStage = targetStage;
			return true;
		}
		return false;
	}
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, double partialTick, double ticks) {
		...
		double speed = 0;
		{
			...
			for (Entity entityiterator : _entfound) {
				if ((entityiterator instanceof StoryBeerusEntity _datEntS ? _datEntS.getEntityData().get(StoryBeerusEntity.DATA_SelectedKiAttack) : "").equals("Destroyer Anger")) {
					if (target(2)) {
						speed = 0.4;
						width = 0.5;
						length = entityiterator instanceof StoryBeerusEntity _datEntI ? _datEntI.getEntityData().get(StoryBeerusEntity.DATA_KiAttackSize) : 0;
						RenderSystem.setShaderTexture(0, new ResourceLocation(("dbm" + ":textures/" + "kiattacks/destroyeranger" + ".png")));
						...
						renderShape(shape(), (entityiterator.getX() - Math.sin(Math.toRadians(entityiterator instanceof StoryBeerusEntity _datEntI ? _datEntI.getEntityData().get(StoryBeerusEntity.DATA_OldYAW) : 0)) * 1.5),
								(entityiterator.getY() + entityiterator.getEyeHeight() * 0.9),
								(entityiterator.getZ() + Math.cos(Math.toRadians(entityiterator instanceof StoryBeerusEntity _datEntI ? _datEntI.getEntityData().get(StoryBeerusEntity.DATA_OldYAW) : 0)) * 1.5),
								(float) (entityiterator instanceof StoryBeerusEntity _datEntI ? _datEntI.getEntityData().get(StoryBeerusEntity.DATA_OldYAW) : 0),
								(float) (entityiterator instanceof StoryBeerusEntity _datEntI ? _datEntI.getEntityData().get(StoryBeerusEntity.DATA_OldPITCH) : 0), 0, (float) (-0.4), (float) 0.4, 1, 255 << 24 | 255 << 16 | 255 << 8 | 255);
						renderShape(shape(), (entityiterator.getX() - Math.sin(Math.toRadians(entityiterator instanceof StoryBeerusEntity _datEntI ? _datEntI.getEntityData().get(StoryBeerusEntity.DATA_OldYAW) : 0)) * 1.5),
								(entityiterator.getY() + entityiterator.getEyeHeight() * 0.9),
								(entityiterator.getZ() + Math.cos(Math.toRadians(entityiterator instanceof StoryBeerusEntity _datEntI ? _datEntI.getEntityData().get(StoryBeerusEntity.DATA_OldYAW) : 0)) * 1.5),
								(float) (entityiterator instanceof StoryBeerusEntity _datEntI ? _datEntI.getEntityData().get(StoryBeerusEntity.DATA_OldYAW) : 0),
								(float) (entityiterator instanceof StoryBeerusEntity _datEntI ? _datEntI.getEntityData().get(StoryBeerusEntity.DATA_OldPITCH) : 0), 0, (float) 0.3, (float) 0.3, 1, 255 << 24 | 255 << 16 | 255 << 8 | 255);
				...
				if ((entityiterator instanceof StoryBeerus2Entity _datEntS ? _datEntS.getEntityData().get(StoryBeerus2Entity.DATA_SelectedKiAttack) : "").equals("Destroyer Anger")) {
					if (target(2)) {
						speed = 0.4;
						width = 0.5;
						length = entityiterator instanceof StoryBeerus2Entity _datEntI ? _datEntI.getEntityData().get(StoryBeerus2Entity.DATA_KiAttackSize) : 0;
						RenderSystem.setShaderTexture(0, new ResourceLocation(("dbm" + ":textures/" + "kiattacks/destroyeranger" + ".png")));
						if (begin(VertexFormat.Mode.QUADS, DefaultVertexFormat.POSITION_TEX_COLOR, (!Minecraft.getInstance().isPaused()))) {
							i = width / (-2);
							j = width / 2;
						...
						renderShape(shape(), (entityiterator.getX() - Math.sin(Math.toRadians(entityiterator instanceof StoryBeerus2Entity _datEntI ? _datEntI.getEntityData().get(StoryBeerus2Entity.DATA_OldYAW) : 0)) * 1.5),
								...
								(entityiterator.getZ() + Math.cos(Math.toRadians(entityiterator instanceof StoryBeerus2Entity _datEntI ? _datEntI.getEntityData().get(StoryBeerus2Entity.DATA_OldYAW) : 0)) * 1.5),
								(float) (entityiterator instanceof StoryBeerus2Entity _datEntI ? _datEntI.getEntityData().get(StoryBeerus2Entity.DATA_OldYAW) : 0),
								(float) (entityiterator instanceof StoryBeerus2Entity _datEntI ? _datEntI.getEntityData().get(StoryBeerus2Entity.DATA_OldPITCH) : 0), 0, (float) 0.3, (float) 0.3, 1, 255 << 24 | 255 << 16 | 255 << 8 | 255);
						RenderSystem.disableCull();
						renderShape(shape(), (entityiterator.getX() - Math.sin(Math.toRadians(entityiterator instanceof StoryBeerus2Entity _datEntI ? _datEntI.getEntityData().get(StoryBeerus2Entity.DATA_OldYAW) : 0)) * 1.5),
								(entityiterator.getY() + entityiterator.getEyeHeight() * 0.9),
								(entityiterator.getZ() + Math.cos(Math.toRadians(entityiterator instanceof StoryBeerus2Entity _datEntI ? _datEntI.getEntityData().get(StoryBeerus2Entity.DATA_OldYAW) : 0)) * 1.5),
