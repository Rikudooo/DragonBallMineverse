...
public class FriezaAttackPatternProcedure {
				...
				if (entity.getPersistentData().getBoolean("UsingKiAttack") == false) {
					if (Math.random() < 0.3) {
						...
						if (entity instanceof StoryFriezaEntity _datEntSetS)
							_datEntSetS.getEntityData().set(StoryFriezaEntity.DATA_SelectedKiAttack, "None");
						...
						if (((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) != null ? entity.distanceTo((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null)) : -1) > 10
							...
							if (entity.getPersistentData().getBoolean("YawNPitch") == false) {
								entity.lookAt(EntityAnchorArgument.Anchor.EYES, new Vec3(((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getX()), ((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getY()),
										((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getZ())));
								if (entity instanceof StoryFriezaEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryFriezaEntity.DATA_OldYAW, (int) entity.getYRot());
								if (entity instanceof StoryFriezaEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryFriezaEntity.DATA_OldPITCH, (int) entity.getXRot());
								if (entity instanceof StoryFriezaEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryFriezaEntity.DATA_KiAttackSize, 80);
								if (entity instanceof StoryFriezaEntity _datEntSetS)
									_datEntSetS.getEntityData().set(StoryFriezaEntity.DATA_SelectedKiAttack, "Death Beam");
					...
					if (entity.getPersistentData().getDouble("KiAttackDuration") < 40) {
						{
							Entity _ent = entity;
							_ent.setYRot((float) (entity instanceof StoryFriezaEntity _datEntI ? _datEntI.getEntityData().get(StoryFriezaEntity.DATA_OldYAW) : 0));
							_ent.setXRot((float) (entity instanceof StoryFriezaEntity _datEntI ? _datEntI.getEntityData().get(StoryFriezaEntity.DATA_OldPITCH) : 0));
						...
						for (int index0 = 0; index0 < 70; index0++) {
							{
								final Vec3 _center = new Vec3((entity.getX() + entity.getLookAngle().x * (entity instanceof StoryFriezaEntity _datEntI ? _datEntI.getEntityData().get(StoryFriezaEntity.DATA_KiAttackHits) : 0)),
										(entity.getY() + entity.getLookAngle().y * (entity instanceof StoryFriezaEntity _datEntI ? _datEntI.getEntityData().get(StoryFriezaEntity.DATA_KiAttackHits) : 0)),
										(entity.getZ() + entity.getLookAngle().z * (entity instanceof StoryFriezaEntity _datEntI ? _datEntI.getEntityData().get(StoryFriezaEntity.DATA_KiAttackHits) : 0)));
							...
							if (entity instanceof StoryFriezaEntity _datEntSetI)
								_datEntSetI.getEntityData().set(StoryFriezaEntity.DATA_KiAttackHits, (int) ((entity instanceof StoryFriezaEntity _datEntI ? _datEntI.getEntityData().get(StoryFriezaEntity.DATA_KiAttackHits) : 0) + 2));
						}
						if (entity instanceof StoryFriezaEntity _datEntSetI)
							_datEntSetI.getEntityData().set(StoryFriezaEntity.DATA_KiAttackHits, 0);
