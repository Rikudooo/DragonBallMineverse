...
public class CellAttackPatternProcedure {
			...
			if (!(null == (entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null))) {
				if (entity.getPersistentData().getBoolean("UsingKiAttack") == false) {
					if (Math.random() < 0.3) {
						...
						if (world instanceof ServerLevel _level)
							_level.sendParticles((SimpleParticleType) (DbmModParticleTypes.TELEPORTATION_PARTICLE.get()), (entity.getX()), (entity.getY() + 1), (entity.getZ()), 5, 0, 0, 0, 0);
						if (entity instanceof StoryCellEntity _datEntSetS)
							_datEntSetS.getEntityData().set(StoryCellEntity.DATA_SelectedKiAttack, "None");
						...
						if (((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) != null ? entity.distanceTo((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null)) : -1) > 10
							...
							if (entity.getPersistentData().getBoolean("YawNPitch") == false) {
								...
								if (entity instanceof StoryCellEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryCellEntity.DATA_OldYAW, (int) entity.getYRot());
								if (entity instanceof StoryCellEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryCellEntity.DATA_OldPITCH, (int) entity.getXRot());
								if (entity instanceof StoryCellEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryCellEntity.DATA_KiAttackSize, 70);
								if (entity instanceof StoryCellEntity _datEntSetS)
									_datEntSetS.getEntityData().set(StoryCellEntity.DATA_SelectedKiAttack, "Kamehameha");
					...
					if (entity.getPersistentData().getDouble("KiAttackDuration") < 80) {
						{
							Entity _ent = entity;
							_ent.setYRot((float) (entity instanceof StoryCellEntity _datEntI ? _datEntI.getEntityData().get(StoryCellEntity.DATA_OldYAW) : 0));
							_ent.setXRot((float) (entity instanceof StoryCellEntity _datEntI ? _datEntI.getEntityData().get(StoryCellEntity.DATA_OldPITCH) : 0));
						...
						for (int index0 = 0; index0 < 70; index0++) {
							{
								final Vec3 _center = new Vec3((entity.getX() + entity.getLookAngle().x * (entity instanceof StoryCellEntity _datEntI ? _datEntI.getEntityData().get(StoryCellEntity.DATA_KiAttackHits) : 0)),
										(entity.getY() + entity.getLookAngle().y * (entity instanceof StoryCellEntity _datEntI ? _datEntI.getEntityData().get(StoryCellEntity.DATA_KiAttackHits) : 0)),
										(entity.getZ() + entity.getLookAngle().z * (entity instanceof StoryCellEntity _datEntI ? _datEntI.getEntityData().get(StoryCellEntity.DATA_KiAttackHits) : 0)));
							...
							if (entity instanceof StoryCellEntity _datEntSetI)
								_datEntSetI.getEntityData().set(StoryCellEntity.DATA_KiAttackHits, (int) ((entity instanceof StoryCellEntity _datEntI ? _datEntI.getEntityData().get(StoryCellEntity.DATA_KiAttackHits) : 0) + 2));
						}
						if (entity instanceof StoryCellEntity _datEntSetI)
