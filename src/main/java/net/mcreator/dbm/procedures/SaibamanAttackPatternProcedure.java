...
public class SaibamanAttackPatternProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof SaibamanEntity _datEntI ? _datEntI.getEntityData().get(SaibamanEntity.DATA_Ki) : 0) > 100) {
			if (entity instanceof SaibamanEntity _datEntSetL)
				_datEntSetL.getEntityData().set(SaibamanEntity.DATA_KiCharging, false);
			if (entity instanceof SaibamanEntity _datEntSetI)
				_datEntSetI.getEntityData().set(SaibamanEntity.DATA_Ki, 100);
			entity.setDeltaMovement(new Vec3(0, 0, 0));
		}
		if ((entity instanceof SaibamanEntity _datEntI ? _datEntI.getEntityData().get(SaibamanEntity.DATA_Ki) : 0) < 0) {
			if (entity instanceof SaibamanEntity _datEntSetI)
				_datEntSetI.getEntityData().set(SaibamanEntity.DATA_Ki, 0);
		}
		if ((entity instanceof SaibamanEntity _datEntL6 && _datEntL6.getEntityData().get(SaibamanEntity.DATA_KiCharging)) == true) {
			if (entity instanceof SaibamanEntity _datEntSetI)
				_datEntSetI.getEntityData().set(SaibamanEntity.DATA_Ki, (int) ((entity instanceof SaibamanEntity _datEntI ? _datEntI.getEntityData().get(SaibamanEntity.DATA_Ki) : 0) + 0.5));
		}
		if (entity.getPersistentData().getDouble("attackInterval") < 90) {
			...
			if (!(null == (entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null))) {
				if (entity.getPersistentData().getBoolean("UsingKiAttack") == false) {
					if ((entity instanceof SaibamanEntity _datEntI ? _datEntI.getEntityData().get(SaibamanEntity.DATA_Ki) : 0) >= 10) {
						if (Math.random() < 0.3) {
							...
							if (entity instanceof SaibamanEntity _datEntSetI)
								_datEntSetI.getEntityData().set(SaibamanEntity.DATA_Ki, (int) ((entity instanceof StoryPiccoloEntity _datEntI ? _datEntI.getEntityData().get(StoryPiccoloEntity.DATA_Ki) : 0) - 10));
						} else {
							if (((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) != null ? entity.distanceTo((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null)) : -1) > 10
								...
								if ((entity instanceof SaibamanEntity _datEntI ? _datEntI.getEntityData().get(SaibamanEntity.DATA_Ki) : 0) >= 40) {
									entity.getPersistentData().putDouble("attackInterval", 0);
									{
										...
										if (!projectileLevel.isClientSide()) {
											Projectile _entityToSpawn = new Object() {
												public Projectile getArrow(Level level, Entity shooter, float damage, int knockback, byte piercing) {
													...
													(float) ((entity instanceof LivingEntity _livingEntity44 && _livingEntity44.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE)
									...
									entity.getPersistentData().putBoolean("UsingKiAttack", false);
									if (entity instanceof SaibamanEntity _datEntSetI)
										_datEntSetI.getEntityData().set(SaibamanEntity.DATA_Ki, (int) ((entity instanceof SaibamanEntity _datEntI ? _datEntI.getEntityData().get(SaibamanEntity.DATA_Ki) : 0) - 40));
								}
								...
								if ((entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) < (entity instanceof LivingEntity _livEnt ? _livEnt.getMaxHealth() : -1) * 0.4) {
									...
									if (world instanceof Level _level && !_level.isClientSide())
										_level.explode(entity, new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation("dbm:kikoha")))), null, x,
												y, z, 6, false, Level.ExplosionInteraction.MOB);
								}
							}
						}
					} else if ((entity instanceof SaibamanEntity _datEntI ? _datEntI.getEntityData().get(SaibamanEntity.DATA_Ki) : 0) < 10) {
						if (entity instanceof SaibamanEntity _datEntSetL)
							_datEntSetL.getEntityData().set(SaibamanEntity.DATA_KiCharging, true);
					}
				}
			}
		}
