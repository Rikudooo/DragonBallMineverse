...
public class DodoriaAttackPatternProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof StoryPiccoloEntity _datEntI ? _datEntI.getEntityData().get(StoryPiccoloEntity.DATA_Ki) : 0) > 100) {
			if (entity instanceof StoryPiccoloEntity _datEntSetL)
				_datEntSetL.getEntityData().set(StoryPiccoloEntity.DATA_KiCharging, false);
			if (entity instanceof StoryPiccoloEntity _datEntSetI)
				_datEntSetI.getEntityData().set(StoryPiccoloEntity.DATA_Ki, 100);
			entity.setDeltaMovement(new Vec3(0, 0, 0));
		}
		if ((entity instanceof StoryPiccoloEntity _datEntI ? _datEntI.getEntityData().get(StoryPiccoloEntity.DATA_Ki) : 0) < 0) {
			if (entity instanceof StoryPiccoloEntity _datEntSetI)
				_datEntSetI.getEntityData().set(StoryPiccoloEntity.DATA_Ki, 0);
		}
		if ((entity instanceof StoryPiccoloEntity _datEntL6 && _datEntL6.getEntityData().get(StoryPiccoloEntity.DATA_KiCharging)) == true) {
			if (entity instanceof StoryPiccoloEntity _datEntSetI)
				_datEntSetI.getEntityData().set(StoryPiccoloEntity.DATA_Ki, (int) ((entity instanceof StoryPiccoloEntity _datEntI ? _datEntI.getEntityData().get(StoryPiccoloEntity.DATA_Ki) : 0) + 0.5));
		}
		if (entity.getPersistentData().getDouble("attackInterval") < 90) {
			...
			if (!(null == (entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null))) {
				if (entity.getPersistentData().getBoolean("UsingKiAttack") == false) {
					if ((entity instanceof StoryPiccoloEntity _datEntI ? _datEntI.getEntityData().get(StoryPiccoloEntity.DATA_Ki) : 0) >= 10) {
						if (Math.random() < 0.3) {
							...
							if (entity instanceof StoryPiccoloEntity _datEntSetI)
								_datEntSetI.getEntityData().set(StoryPiccoloEntity.DATA_Ki, (int) ((entity instanceof StoryPiccoloEntity _datEntI ? _datEntI.getEntityData().get(StoryPiccoloEntity.DATA_Ki) : 0) - 10));
						} else {
							if (((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) != null ? entity.distanceTo((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null)) : -1) > 10) {
								if ((entity instanceof StoryPiccoloEntity _datEntI ? _datEntI.getEntityData().get(StoryPiccoloEntity.DATA_Ki) : 0) >= 40) {
									entity.getPersistentData().putDouble("attackInterval", 0);
									{
									...
									entity.getPersistentData().putBoolean("UsingKiAttack", false);
									if (entity instanceof StoryPiccoloEntity _datEntSetI)
										_datEntSetI.getEntityData().set(StoryPiccoloEntity.DATA_Ki, (int) ((entity instanceof StoryPiccoloEntity _datEntI ? _datEntI.getEntityData().get(StoryPiccoloEntity.DATA_Ki) : 0) - 40));
								}
							}
						}
					} else if ((entity instanceof StoryPiccoloEntity _datEntI ? _datEntI.getEntityData().get(StoryPiccoloEntity.DATA_Ki) : 0) < 10) {
						if (entity instanceof StoryPiccoloEntity _datEntSetL)
							_datEntSetL.getEntityData().set(StoryPiccoloEntity.DATA_KiCharging, true);
					}
				}
			}
		}
