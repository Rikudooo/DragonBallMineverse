...
public class TienshinhanAttackPatternProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof StoryTienshinhanEntity _datEntI ? _datEntI.getEntityData().get(StoryTienshinhanEntity.DATA_Ki) : 0) > 100) {
			if (entity instanceof StoryTienshinhanEntity _datEntSetL)
				_datEntSetL.getEntityData().set(StoryTienshinhanEntity.DATA_KiCharging, false);
			if (entity instanceof StoryTienshinhanEntity _datEntSetI)
				_datEntSetI.getEntityData().set(StoryTienshinhanEntity.DATA_Ki, 100);
			entity.setDeltaMovement(new Vec3(0, 0, 0));
		}
		if ((entity instanceof StoryTienshinhanEntity _datEntI ? _datEntI.getEntityData().get(StoryTienshinhanEntity.DATA_Ki) : 0) < 0) {
			if (entity instanceof StoryTienshinhanEntity _datEntSetI)
				_datEntSetI.getEntityData().set(StoryTienshinhanEntity.DATA_Ki, 0);
		}
		if ((entity instanceof StoryTienshinhanEntity _datEntL6 && _datEntL6.getEntityData().get(StoryTienshinhanEntity.DATA_KiCharging)) == true) {
			if (entity instanceof StoryTienshinhanEntity _datEntSetI)
				_datEntSetI.getEntityData().set(StoryTienshinhanEntity.DATA_Ki, (int) ((entity instanceof StoryTienshinhanEntity _datEntI ? _datEntI.getEntityData().get(StoryTienshinhanEntity.DATA_Ki) : 0) + 0.5));
		}
		if (entity.getPersistentData().getDouble("attackInterval") < 90) {
			...
			if (!(null == (entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null))) {
				if (entity.getPersistentData().getBoolean("UsingKiAttack") == false) {
					if ((entity instanceof StoryTienshinhanEntity _datEntI ? _datEntI.getEntityData().get(StoryTienshinhanEntity.DATA_Ki) : 0) >= 10) {
						if (Math.random() < 0.3) {
							...
							if (entity instanceof StoryTienshinhanEntity _datEntSetI)
								_datEntSetI.getEntityData().set(StoryTienshinhanEntity.DATA_Ki, (int) ((entity instanceof StoryTienshinhanEntity _datEntI ? _datEntI.getEntityData().get(StoryTienshinhanEntity.DATA_Ki) : 0) - 10));
						} else {
							if (((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) != null ? entity.distanceTo((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null)) : -1) > 10
								...
								if ((entity instanceof StoryTienshinhanEntity _datEntI ? _datEntI.getEntityData().get(StoryTienshinhanEntity.DATA_Ki) : 0) >= 40) {
									entity.getPersistentData().putDouble("attackInterval", 0);
									{
									...
									entity.getPersistentData().putBoolean("UsingKiAttack", false);
									if (entity instanceof StoryTienshinhanEntity _datEntSetI)
										_datEntSetI.getEntityData().set(StoryTienshinhanEntity.DATA_Ki, (int) ((entity instanceof StoryTienshinhanEntity _datEntI ? _datEntI.getEntityData().get(StoryTienshinhanEntity.DATA_Ki) : 0) - 40));
								}
								...
								if ((entity instanceof StoryTienshinhanEntity _datEntI ? _datEntI.getEntityData().get(StoryTienshinhanEntity.DATA_Ki) : 0) >= 50) {
									entity.getPersistentData().putDouble("attackInterval", 0);
									...
									if (entity.getPersistentData().getBoolean("YawNPitch") == false) {
										...
										if (entity instanceof StoryTienshinhanEntity _datEntSetI)
											_datEntSetI.getEntityData().set(StoryTienshinhanEntity.DATA_Ki, (int) ((entity instanceof StoryTienshinhanEntity _datEntI ? _datEntI.getEntityData().get(StoryTienshinhanEntity.DATA_Ki) : 0) - 50));
									}
									if (entity.getPersistentData().getBoolean("UsingKiAttack") == true) {
										...
										entity.setDeltaMovement(new Vec3(0, 0, 0));
										if (entity instanceof StoryTienshinhanEntity _datEntSetI)
											_datEntSetI.getEntityData().set(StoryTienshinhanEntity.DATA_KiAttackSize, 50);
										for (int index0 = 0; index0 < 50; index0++) {
											{
												...
												for (Entity entityiterator : _entfound) {
													...
													if (world instanceof Level _level && !_level.isClientSide())
														_level.explode(null, (entity.getX() + entity.getLookAngle().x * (entity instanceof StoryTienshinhanEntity _datEntI ? _datEntI.getEntityData().get(StoryTienshinhanEntity.DATA_KiAttackHits) : 0)),
																(entity.getY() + entity.getLookAngle().y * (entity instanceof StoryTienshinhanEntity _datEntI ? _datEntI.getEntityData().get(StoryTienshinhanEntity.DATA_KiAttackHits) : 0)),
																(entity.getZ() + entity.getLookAngle().z * (entity instanceof StoryTienshinhanEntity _datEntI ? _datEntI.getEntityData().get(StoryTienshinhanEntity.DATA_KiAttackHits) : 0)), 4,
																Level.ExplosionInteraction.NONE);
												}
											}
											if (entity instanceof StoryTienshinhanEntity _datEntSetI)
												_datEntSetI.getEntityData().set(StoryTienshinhanEntity.DATA_KiAttackHits,
														(int) ((entity instanceof StoryTienshinhanEntity _datEntI ? _datEntI.getEntityData().get(StoryTienshinhanEntity.DATA_KiAttackHits) : 0) + 2));
										}
										if (entity instanceof StoryTienshinhanEntity _datEntSetI)
											_datEntSetI.getEntityData().set(StoryTienshinhanEntity.DATA_KiAttackHits, 0);
										if (entity.getPersistentData().getDouble("KiAttackDuration") <= 30) {
					...
					} else if ((entity instanceof StoryTienshinhanEntity _datEntI ? _datEntI.getEntityData().get(StoryTienshinhanEntity.DATA_Ki) : 0) < 10) {
						if (entity instanceof StoryTienshinhanEntity _datEntSetL)
							_datEntSetL.getEntityData().set(StoryTienshinhanEntity.DATA_KiCharging, true);
					}
				}
			}
		}
