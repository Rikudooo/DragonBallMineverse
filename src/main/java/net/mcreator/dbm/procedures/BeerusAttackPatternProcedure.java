...
public class BeerusAttackPatternProcedure {
			...
			if (!(null == (entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null))) {
				if (entity.getPersistentData().getBoolean("UsingKiAttack") == false) {
					if (Math.random() < 0.3) {
						...
						if (world instanceof ServerLevel _level)
							_level.sendParticles((SimpleParticleType) (DbmModParticleTypes.TELEPORTATION_PARTICLE.get()), (entity.getX()), (entity.getY() + 1), (entity.getZ()), 5, 0, 0, 0, 0);
						if (entity instanceof StoryBeerusEntity _datEntSetS)
							_datEntSetS.getEntityData().set(StoryBeerusEntity.DATA_SelectedKiAttack, "None");
						...
						if (((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) != null ? entity.distanceTo((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null)) : -1) > 10
							...
							if (entity.getPersistentData().getBoolean("YawNPitch") == false) {
								entity.lookAt(EntityAnchorArgument.Anchor.EYES, new Vec3(((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getX()), ((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getY()),
										((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getZ())));
								if (entity instanceof StoryBeerusEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryBeerusEntity.DATA_OldYAW, (int) entity.getYRot());
								if (entity instanceof StoryBeerusEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryBeerusEntity.DATA_OldPITCH, (int) entity.getXRot());
								if (entity instanceof StoryBeerusEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryBeerusEntity.DATA_KiAttackSize, 80);
								if (entity instanceof StoryBeerusEntity _datEntSetS)
									_datEntSetS.getEntityData().set(StoryBeerusEntity.DATA_SelectedKiAttack, "Destroyer Anger");
					...
					if (entity.getPersistentData().getDouble("KiAttackDuration") < 40) {
						{
							Entity _ent = entity;
							_ent.setYRot((float) (entity instanceof StoryBeerusEntity _datEntI ? _datEntI.getEntityData().get(StoryBeerusEntity.DATA_OldYAW) : 0));
							_ent.setXRot((float) (entity instanceof StoryBeerusEntity _datEntI ? _datEntI.getEntityData().get(StoryBeerusEntity.DATA_OldPITCH) : 0));
						...
						for (int index0 = 0; index0 < 70; index0++) {
							{
								final Vec3 _center = new Vec3((entity.getX() + entity.getLookAngle().x * (entity instanceof StoryBeerusEntity _datEntI ? _datEntI.getEntityData().get(StoryBeerusEntity.DATA_KiAttackHits) : 0)),
										(entity.getY() + entity.getLookAngle().y * (entity instanceof StoryBeerusEntity _datEntI ? _datEntI.getEntityData().get(StoryBeerusEntity.DATA_KiAttackHits) : 0)),
										(entity.getZ() + entity.getLookAngle().z * (entity instanceof StoryBeerusEntity _datEntI ? _datEntI.getEntityData().get(StoryBeerusEntity.DATA_KiAttackHits) : 0)));
							...
							if (entity instanceof StoryBeerusEntity _datEntSetI)
								_datEntSetI.getEntityData().set(StoryBeerusEntity.DATA_KiAttackHits, (int) ((entity instanceof StoryBeerusEntity _datEntI ? _datEntI.getEntityData().get(StoryBeerusEntity.DATA_KiAttackHits) : 0) + 2));
						}
						if (entity instanceof StoryBeerusEntity _datEntSetI)
							_datEntSetI.getEntityData().set(StoryBeerusEntity.DATA_KiAttackHits, 0);
