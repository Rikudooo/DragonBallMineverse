...
public class OverlayKiAttackSelectedSlotProcedure {
	...
	private static boolean target(int targetStage) {
		if (targetStage == currentStage) {
			OverlayKiAttackSelectedSlotProcedure.targetStage = targetStage;
			return true;
		} else if (targetStage == 1) {
			if (currentStage != 0) {
				OverlayKiAttackSelectedSlotProcedure.targetStage = currentStage;
				return true;
			}
		}
		return false;
	...
	private static void execute(@Nullable Event event) {
		...
		if (target(2)) {
			...
			SelectedSlot = (player.getCapability(DbmModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new DbmModVariables.PlayerVariables())).SelectedKiSlot;
			RenderSystem.setShaderTexture(0, new ResourceLocation(("dbm" + ":textures/" + "selectedkislot" + ".png")));
			if (SelectedSlot == 1) {
				renderTexture((float) (Minecraft.getInstance().getWindow().getGuiScaledWidth() - 149.5), (float) (Minecraft.getInstance().getWindow().getGuiScaledHeight() - 12.5), 0, 0, (float) 0.5, 255 << 24 | 255 << 16 | 255 << 8 | 255, 8);
			} else if (SelectedSlot == 2) {
				renderTexture((float) (Minecraft.getInstance().getWindow().getGuiScaledWidth() - 130.5), (float) (Minecraft.getInstance().getWindow().getGuiScaledHeight() - 12.5), 0, 0, (float) 0.5, 255 << 24 | 255 << 16 | 255 << 8 | 255, 8);
			} else if (SelectedSlot == 3) {
				renderTexture((float) (Minecraft.getInstance().getWindow().getGuiScaledWidth() - 111.5), (float) (Minecraft.getInstance().getWindow().getGuiScaledHeight() - 12.5), 0, 0, (float) 0.5, 255 << 24 | 255 << 16 | 255 << 8 | 255, 8);
			} else if (SelectedSlot == 4) {
				renderTexture((float) (Minecraft.getInstance().getWindow().getGuiScaledWidth() - 92.5), (float) (Minecraft.getInstance().getWindow().getGuiScaledHeight() - 12.5), 0, 0, (float) 0.5, 255 << 24 | 255 << 16 | 255 << 8 | 255, 8);
			} else if (SelectedSlot == 5) {
				renderTexture((float) (Minecraft.getInstance().getWindow().getGuiScaledWidth() - 73.5), (float) (Minecraft.getInstance().getWindow().getGuiScaledHeight() - 12.5), 0, 0, (float) 0.5, 255 << 24 | 255 << 16 | 255 << 8 | 255, 8);
			} else if (SelectedSlot == 6) {
				renderTexture((float) (Minecraft.getInstance().getWindow().getGuiScaledWidth() - 54.5), (float) (Minecraft.getInstance().getWindow().getGuiScaledHeight() - 12.5), 0, 0, (float) 0.5, 255 << 24 | 255 << 16 | 255 << 8 | 255, 8);
			} else if (SelectedSlot == 7) {
				renderTexture((float) (Minecraft.getInstance().getWindow().getGuiScaledWidth() - 35.5), (float) (Minecraft.getInstance().getWindow().getGuiScaledHeight() - 12.5), 0, 0, (float) 0.5, 255 << 24 | 255 << 16 | 255 << 8 | 255, 8);
			} else if (SelectedSlot == 8) {
				renderTexture((float) (Minecraft.getInstance().getWindow().getGuiScaledWidth() - 16.5), (float) (Minecraft.getInstance().getWindow().getGuiScaledHeight() - 12.5), 0, 0, (float) 0.5, 255 << 24 | 255 << 16 | 255 << 8 | 255, 8);
			}
			release();
		}
	}
