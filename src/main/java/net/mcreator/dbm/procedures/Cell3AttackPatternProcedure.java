...
public class Cell3AttackPatternProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof StoryCell3Entity _datEntS ? _datEntS.getEntityData().get(StoryCell3Entity.DATA_Form) : "").equals("Base")) {
			...
			if (!(null == (entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null))) {
				if (entity.getPersistentData().getBoolean("UsingKiAttack") == false) {
					if (Math.random() < 0.3) {
						...
						if (world instanceof ServerLevel _level)
							_level.sendParticles((SimpleParticleType) (DbmModParticleTypes.TELEPORTATION_PARTICLE.get()), (entity.getX()), (entity.getY() + 1), (entity.getZ()), 5, 0, 0, 0, 0);
						if (entity instanceof StoryCell3Entity _datEntSetS)
							_datEntSetS.getEntityData().set(StoryCell3Entity.DATA_SelectedKiAttack, "None");
						...
						if (((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) != null ? entity.distanceTo((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null)) : -1) > 10
								...
								if (!projectileLevel.isClientSide()) {
									Projectile _entityToSpawn = new Object() {
										public Projectile getArrow(Level level, Entity shooter, float damage, int knockback, byte piercing) {
											...
											(float) ((entity instanceof LivingEntity _livingEntity35 && _livingEntity35.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE)
													? _livingEntity35.getAttribute(Attributes.ATTACK_DAMAGE).getBaseValue()
													: 0) * 3.5),
											1, (byte) 1);
							...
							if (entity.getPersistentData().getBoolean("YawNPitch") == false) {
								entity.lookAt(EntityAnchorArgument.Anchor.EYES, new Vec3(((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getX()), ((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getY()),
										((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getZ())));
								if (entity instanceof StoryCell3Entity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryCell3Entity.DATA_OldYAW, (int) entity.getYRot());
								if (entity instanceof StoryCell3Entity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryCell3Entity.DATA_OldPITCH, (int) entity.getXRot());
								if (entity instanceof StoryCell3Entity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryCell3Entity.DATA_KiAttackSize, 70);
								if (entity instanceof StoryCell3Entity _datEntSetS)
									_datEntSetS.getEntityData().set(StoryCell3Entity.DATA_SelectedKiAttack, "Kamehameha");
					...
					if (entity.getPersistentData().getDouble("KiAttackDuration") < 80) {
						{
							Entity _ent = entity;
							_ent.setYRot((float) (entity instanceof StoryCell3Entity _datEntI ? _datEntI.getEntityData().get(StoryCell3Entity.DATA_OldYAW) : 0));
							_ent.setXRot((float) (entity instanceof StoryCell3Entity _datEntI ? _datEntI.getEntityData().get(StoryCell3Entity.DATA_OldPITCH) : 0));
						...
						for (int index0 = 0; index0 < 70; index0++) {
							{
								final Vec3 _center = new Vec3((entity.getX() + entity.getLookAngle().x * (entity instanceof StoryCell3Entity _datEntI ? _datEntI.getEntityData().get(StoryCell3Entity.DATA_KiAttackHits) : 0)),
										(entity.getY() + entity.getLookAngle().y * (entity instanceof StoryCell3Entity _datEntI ? _datEntI.getEntityData().get(StoryCell3Entity.DATA_KiAttackHits) : 0)),
										(entity.getZ() + entity.getLookAngle().z * (entity instanceof StoryCell3Entity _datEntI ? _datEntI.getEntityData().get(StoryCell3Entity.DATA_KiAttackHits) : 0)));
								...
								for (Entity entityiterator : _entfound) {
									if (!(entity == entityiterator)) {
										entityiterator.hurt(new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation("dbm:kikoha")))),
												(float) ((entity instanceof LivingEntity _livingEntity84 && _livingEntity84.getAttributes().hasAttribute(Attributes.ATTACK_DAMAGE)
														? _livingEntity84.getAttribute(Attributes.ATTACK_DAMAGE).getBaseValue()
														: 0) * 3));
							...
							if (entity instanceof StoryCell3Entity _datEntSetI)
								_datEntSetI.getEntityData().set(StoryCell3Entity.DATA_KiAttackHits, (int) ((entity instanceof StoryCell3Entity _datEntI ? _datEntI.getEntityData().get(StoryCell3Entity.DATA_KiAttackHits) : 0) + 2));
						}
						if (entity instanceof StoryCell3Entity _datEntSetI)
							_datEntSetI.getEntityData().set(StoryCell3Entity.DATA_KiAttackHits, 0);
