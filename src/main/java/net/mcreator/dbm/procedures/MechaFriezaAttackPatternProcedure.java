...
public class MechaFriezaAttackPatternProcedure {
			...
			if (!(null == (entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null))) {
				if (entity.getPersistentData().getBoolean("UsingKiAttack") == false) {
					if (Math.random() < 0.3) {
						...
						if (world instanceof ServerLevel _level)
							_level.sendParticles((SimpleParticleType) (DbmModParticleTypes.TELEPORTATION_PARTICLE.get()), (entity.getX()), (entity.getY() + 1), (entity.getZ()), 5, 0, 0, 0, 0);
						if (entity instanceof StoryMechaFriezaEntity _datEntSetS)
							_datEntSetS.getEntityData().set(StoryMechaFriezaEntity.DATA_SelectedKiAttack, "None");
						...
						if (((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) != null ? entity.distanceTo((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null)) : -1) > 10
							...
							if (entity.getPersistentData().getBoolean("YawNPitch") == false) {
								entity.lookAt(EntityAnchorArgument.Anchor.EYES, new Vec3(((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getX()), ((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getY()),
										((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getZ())));
								if (entity instanceof StoryMechaFriezaEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryMechaFriezaEntity.DATA_OldYAW, (int) entity.getYRot());
								if (entity instanceof StoryMechaFriezaEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryMechaFriezaEntity.DATA_OldPITCH, (int) entity.getXRot());
								if (entity instanceof StoryMechaFriezaEntity _datEntSetS)
									_datEntSetS.getEntityData().set(StoryMechaFriezaEntity.DATA_SelectedKiAttack, "Death Beam");
							...
							if (entity.getPersistentData().getBoolean("UsingKiAttack") == true) {
								{
									Entity _ent = entity;
									_ent.setYRot((float) (entity instanceof StoryMechaFriezaEntity _datEntI ? _datEntI.getEntityData().get(StoryMechaFriezaEntity.DATA_OldYAW) : 0));
									_ent.setXRot((float) (entity instanceof StoryMechaFriezaEntity _datEntI ? _datEntI.getEntityData().get(StoryMechaFriezaEntity.DATA_OldPITCH) : 0));
								...
								if (entity instanceof StoryMechaFriezaEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryMechaFriezaEntity.DATA_KiAttackSize, 80);
								for (int index0 = 0; index0 < 70; index0++) {
									{
										final Vec3 _center = new Vec3((entity.getX() + entity.getLookAngle().x * (entity instanceof StoryMechaFriezaEntity _datEntI ? _datEntI.getEntityData().get(StoryMechaFriezaEntity.DATA_KiAttackHits) : 0)),
												(entity.getY() + entity.getLookAngle().y * (entity instanceof StoryMechaFriezaEntity _datEntI ? _datEntI.getEntityData().get(StoryMechaFriezaEntity.DATA_KiAttackHits) : 0)),
												(entity.getZ() + entity.getLookAngle().z * (entity instanceof StoryMechaFriezaEntity _datEntI ? _datEntI.getEntityData().get(StoryMechaFriezaEntity.DATA_KiAttackHits) : 0)));
									...
									if (entity instanceof StoryMechaFriezaEntity _datEntSetI)
										_datEntSetI.getEntityData().set(StoryMechaFriezaEntity.DATA_KiAttackHits,
												(int) ((entity instanceof StoryMechaFriezaEntity _datEntI ? _datEntI.getEntityData().get(StoryMechaFriezaEntity.DATA_KiAttackHits) : 0) + 2));
								}
								if (entity instanceof StoryMechaFriezaEntity _datEntSetI)
									_datEntSetI.getEntityData().set(StoryMechaFriezaEntity.DATA_KiAttackHits, 0);
								...
								if (entity.getPersistentData().getDouble("KiAttackDuration") >= 40) {
									if (entity instanceof StoryMechaFriezaEntity _datEntSetS)
										_datEntSetS.getEntityData().set(StoryMechaFriezaEntity.DATA_SelectedKiAttack, "None");
									if (entity instanceof StoryMechaFriezaEntity _datEntSetI)
										_datEntSetI.getEntityData().set(StoryMechaFriezaEntity.DATA_KiAttackSize, 0);
									entity.getPersistentData().putBoolean("UsingKiAttack", false);
									entity.getPersistentData().putDouble("KiAttackDuration", 0);
