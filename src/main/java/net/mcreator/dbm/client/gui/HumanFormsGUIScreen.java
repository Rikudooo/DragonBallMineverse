...
import net.mcreator.dbm.network.HumanFormsGUIButtonMessage;
...
public class HumanFormsGUIScreen extends AbstractContainerScreen<HumanFormsGUIMenu> {
	private final static HashMap<String, Object> guistate = HumanFormsGUIMenu.guistate;
	...
	public HumanFormsGUIScreen(HumanFormsGUIMenu container, Inventory inventory, Component text) {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + -163 && mouseX < leftPos + -145 && mouseY > topPos + -85 && mouseY < topPos + -67)
			guiGraphics.renderTooltip(font, Component.translatable("gui.dbm.human_forms_gui.tooltip_jump_allows_you_to_jump_higher"), mouseX, mouseY);
		if (RacialForm1Procedure.execute(entity))
			if (mouseX > leftPos + -163 && mouseX < leftPos + -145 && mouseY > topPos + -49 && mouseY < topPos + -31)
				guiGraphics.renderTooltip(font, Component.translatable("gui.dbm.human_forms_gui.tooltip_super_saiyan_2_upgrade_your_rac"), mouseX, mouseY);
		if (ReturnKaiokenOwnedProcedure.execute(entity))
			if (mouseX > leftPos + 16 && mouseX < leftPos + 34 && mouseY > topPos + -85 && mouseY < topPos + -67)
				guiGraphics.renderTooltip(font, Component.translatable("gui.dbm.human_forms_gui.tooltip_kaioken_a_technique_that_gives"), mouseX, mouseY);
		if (mouseX > leftPos + -119 && mouseX < leftPos + -101 && mouseY > topPos + -85 && mouseY < topPos + -67)
			guiGraphics.renderTooltip(font, Component.translatable("gui.dbm.human_forms_gui.tooltip_regeneration_press_the_transfor"), mouseX, mouseY);
	}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.human_forms_gui.label_player_stats"), -173, -101, -16777063, false);
	...
	public void init() {
		...
		imagebutton_quit = new ImageButton(this.leftPos + 37, this.topPos + -102, 9, 9, 0, 0, 9, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_quit.png"), 9, 18, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(0, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_statsicon = new ImageButton(this.leftPos + -171, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_statsicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(1, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_skillicon = new ImageButton(this.leftPos + -146, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_skillicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(2, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_kiattackicon = new ImageButton(this.leftPos + -121, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_kiattackicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(3, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_storyiconhovered = new ImageButton(this.leftPos + -46, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_storyiconhovered.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(4, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
		...
		imagebutton_formicon = new ImageButton(this.leftPos + -96, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_formicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(5, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		});
		...
		imagebutton_ultimateformicon = new ImageButton(this.leftPos + -71, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_ultimateformicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(6, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		});
		...
		imagebutton_groupicon = new ImageButton(this.leftPos + -21, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_groupicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(7, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		});
		...
		imagebutton_icon8 = new ImageButton(this.leftPos + 4, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon8.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(8, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 8, x, y, z);
			}
		});
		...
		imagebutton_icon9 = new ImageButton(this.leftPos + 29, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon9.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(9, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 9, x, y, z);
			}
		});
		...
		imagebutton_icon10 = new ImageButton(this.leftPos + 54, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon10.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(10, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 10, x, y, z);
			}
		});
		...
		imagebutton_icon11 = new ImageButton(this.leftPos + 79, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon11.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(11, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 11, x, y, z);
			}
		});
		...
		imagebutton_icon12 = new ImageButton(this.leftPos + 104, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon12.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(12, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 12, x, y, z);
			}
		});
		...
		imagebutton_icon13 = new ImageButton(this.leftPos + 129, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon13.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(13, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 13, x, y, z);
			}
		});
		...
		imagebutton_icon14 = new ImageButton(this.leftPos + 154, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon14.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(14, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 14, x, y, z);
			}
		});
		...
		imagebutton_upgradeicon = new ImageButton(this.leftPos + 98, this.topPos + 32, 48, 16, 0, 0, 16, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_upgradeicon.png"), 48, 32, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(15, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 15, x, y, z);
			}
		});
		...
		imagebutton_kaiokenicon = new ImageButton(this.leftPos + 16, this.topPos + -85, 18, 18, 0, 0, 18, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_kaiokenicon.png"), 18, 36, e -> {
			if (ReturnKaiokenOwnedProcedure.execute(entity)) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(16, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 16, x, y, z);
			}
		}) {
			@Override
		...
		imagebutton_babidiicon = new ImageButton(this.leftPos + 16, this.topPos + -58, 18, 18, 0, 0, 18, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_babidiicon.png"), 18, 36, e -> {
			if (ReturnBabidiMagicOwnedProcedure.execute(entity)) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(17, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 17, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
		...
		imagebutton_giantnamekianicon = new ImageButton(this.leftPos + -163, this.topPos + -85, 18, 18, 0, 0, 18, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_giantnamekianicon.png"), 18, 36, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(18, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 18, x, y, z);
			}
		});
		...
		imagebutton_fullpowericon = new ImageButton(this.leftPos + -163, this.topPos + -49, 18, 18, 0, 0, 18, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_fullpowericon.png"), 18, 36, e -> {
			if (RacialForm1Procedure.execute(entity)) {
				DbmMod.PACKET_HANDLER.sendToServer(new HumanFormsGUIButtonMessage(19, x, y, z));
				HumanFormsGUIButtonMessage.handleButtonAction(entity, 19, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
