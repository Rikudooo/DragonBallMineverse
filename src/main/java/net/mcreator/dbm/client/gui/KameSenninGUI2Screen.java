...
public class KameSenninGUI2Screen extends AbstractContainerScreen<KameSenninGUI2Menu> {
	private final static HashMap<String, Object> guistate = KameSenninGUI2Menu.guistate;
	...
	public KameSenninGUI2Screen(KameSenninGUI2Menu container, Inventory inventory, Component text) {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("dbm:textures/screens/kamesenninface.png"), this.leftPos + -173, this.topPos + -17, 0, 0, 32, 32, 32, 32);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.kame_sennin_gui_2.label_king_enma"), -133, 7, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.kame_sennin_gui_2.label_kaioken_15000_tp"), -127, 38, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.kame_sennin_gui_2.label_spirit_bomb_cost_8000_tp"), -127, 57, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.kame_sennin_gui_2.label_giant_ki_blast_560_tp"), -127, 72, -1, false);
	}
	...
	public void init() {
		...
		imagebutton_dialogexit = new ImageButton(this.leftPos + 168, this.topPos + 22, 9, 9, 0, 0, 9, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_dialogexit.png"), 9, 18, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new KameSenninGUI2ButtonMessage(0, x, y, z));
				KameSenninGUI2ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_learnbutton = new ImageButton(this.leftPos + -169, this.topPos + 36, 26, 13, 0, 0, 13, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_learnbutton.png"), 26, 26, e -> {
			if (KiWaveNotOwnedProcedure.execute(entity)) {
				DbmMod.PACKET_HANDLER.sendToServer(new KameSenninGUI2ButtonMessage(1, x, y, z));
				KameSenninGUI2ButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}) {
			@Override
		...
		imagebutton_learnbutton1 = new ImageButton(this.leftPos + -169, this.topPos + 54, 26, 13, 0, 0, 13, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_learnbutton1.png"), 26, 26, e -> {
			if (KamehamehaNotOwnedProcedure.execute(entity)) {
				DbmMod.PACKET_HANDLER.sendToServer(new KameSenninGUI2ButtonMessage(2, x, y, z));
				KameSenninGUI2ButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
				this.visible = KamehamehaNotOwnedProcedure.execute(entity);
				super.renderWidget(guiGraphics, gx, gy, ticks);
			}
		};
		...
		imagebutton_learnbutton2 = new ImageButton(this.leftPos + -169, this.topPos + 71, 26, 13, 0, 0, 13, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_learnbutton2.png"), 26, 26, e -> {
			if (GiantKiBlastNotEarnedProcedure.execute(entity)) {
				DbmMod.PACKET_HANDLER.sendToServer(new KameSenninGUI2ButtonMessage(3, x, y, z));
				KameSenninGUI2ButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
