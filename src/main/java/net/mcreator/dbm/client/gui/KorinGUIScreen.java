...
import net.mcreator.dbm.procedures.WaterNotDrankProcedure;
import net.mcreator.dbm.procedures.SenzuTimedOutProcedure;
import net.mcreator.dbm.procedures.NotHasFlyingNimbusProcedure;
import net.mcreator.dbm.network.KorinGUIButtonMessage;
...
public class KorinGUIScreen extends AbstractContainerScreen<KorinGUIMenu> {
	private final static HashMap<String, Object> guistate = KorinGUIMenu.guistate;
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.korin_gui.label_king_enma"), -154, 11, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.korin_gui.label_hello_there_so_youre_dead_hu"), -181, 32, -1, false);
	}
	...
	public void init() {
		...
		imagebutton_dialogexit = new ImageButton(this.leftPos + 179, this.topPos + 25, 9, 9, 0, 0, 9, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_dialogexit.png"), 9, 18, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new KorinGUIButtonMessage(0, x, y, z));
				KorinGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
