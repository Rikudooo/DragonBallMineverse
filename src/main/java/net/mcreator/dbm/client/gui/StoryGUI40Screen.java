...
import net.mcreator.dbm.network.StoryGUI40ButtonMessage;
...
public class StoryGUI40Screen extends AbstractContainerScreen<StoryGUI40Menu> {
	private final static HashMap<String, Object> guistate = StoryGUI40Menu.guistate;
	...
	public StoryGUI40Screen(StoryGUI40Menu container, Inventory inventory, Component text) {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("dbm:textures/screens/4stardbgui2.png"), this.leftPos + -176, this.topPos + -103, 0, 0, 350, 200, 350, 200);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_40.label_player_stats"), -172, -101, -16777063, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_40.label_hey_looking_for_an_adventure_w"), -163, -76, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_40.label_be_on_planet_earth"), -154, 5, -256, false);
		if (ReturnOnEarthProcedure.execute(entity))
			guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_40.label_be_on_planet_earth_done"), -154, 5, -256, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_40.label_on_par_with_vegetas_he_was_sen"), -163, -67, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_40.label_cell_decide_to_organize_a_tourna"), -163, -58, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_40.label_fighter_can_participate_there_w"), -163, -49, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_40.label_cell_himself_the_tournament_wil"), -163, -40, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_40.label_to_get_stronger"), -163, -31, -16777216, false);
	}
	...
	public void init() {
		...
		imagebutton_quit = new ImageButton(this.leftPos + 163, this.topPos + -102, 9, 9, 0, 0, 9, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_quit.png"), 9, 18, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(0, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_statsicon = new ImageButton(this.leftPos + -171, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_statsicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(1, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_skillicon = new ImageButton(this.leftPos + -146, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_skillicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(2, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_kiattackicon = new ImageButton(this.leftPos + -121, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_kiattackicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(3, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_storyiconhovered = new ImageButton(this.leftPos + -46, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_storyiconhovered.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(4, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
		...
		imagebutton_formicon = new ImageButton(this.leftPos + -96, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_formicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(5, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		});
		...
		imagebutton_ultimateformicon = new ImageButton(this.leftPos + -71, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_ultimateformicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(6, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		});
		...
		imagebutton_groupicon = new ImageButton(this.leftPos + -21, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_groupicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(7, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		});
		...
		imagebutton_icon8 = new ImageButton(this.leftPos + 4, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon8.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(8, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 8, x, y, z);
			}
		});
		...
		imagebutton_icon9 = new ImageButton(this.leftPos + 29, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon9.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(9, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 9, x, y, z);
			}
		});
		...
		imagebutton_icon10 = new ImageButton(this.leftPos + 54, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon10.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(10, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 10, x, y, z);
			}
		});
		...
		imagebutton_icon11 = new ImageButton(this.leftPos + 79, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon11.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(11, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 11, x, y, z);
			}
		});
		...
		imagebutton_icon12 = new ImageButton(this.leftPos + 104, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon12.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(12, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 12, x, y, z);
			}
		});
		...
		imagebutton_icon13 = new ImageButton(this.leftPos + 129, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon13.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(13, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 13, x, y, z);
			}
		});
		...
		imagebutton_icon14 = new ImageButton(this.leftPos + 154, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon14.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(14, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 14, x, y, z);
			}
		});
		...
		imagebutton_next2 = new ImageButton(this.leftPos + 135, this.topPos + 77, 36, 16, 0, 0, 16, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_next2.png"), 36, 32, e -> {
			if (ReturnOnEarthProcedure.execute(entity)) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI40ButtonMessage(15, x, y, z));
				StoryGUI40ButtonMessage.handleButtonAction(entity, 15, x, y, z);
			}
		}) {
			@Override
