...
import net.mcreator.dbm.procedures.ReturnRaditzDefeatedProcedure;
import net.mcreator.dbm.procedures.ReturnOnEarthProcedure;
import net.mcreator.dbm.network.StoryGUI6ButtonMessage;
...
public class StoryGUI6Screen extends AbstractContainerScreen<StoryGUI6Menu> {
	private final static HashMap<String, Object> guistate = StoryGUI6Menu.guistate;
	...
	public StoryGUI6Screen(StoryGUI6Menu container, Inventory inventory, Component text) {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_6.label_player_stats"), -172, -101, -16777063, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_6.label_hey_looking_for_an_adventure_w"), -163, -76, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_6.label_are_you_ready_to_take_on_the_inc"), -163, -67, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_6.label_be_on_planet_earth"), -154, 5, -256, false);
		if (ReturnOnEarthProcedure.execute(entity))
			guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_6.label_be_on_planet_earth_done"), -154, 5, -256, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_6.label_known_as_the_saiyan_race"), -163, -58, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_6.label_defeat_raditz"), -154, 23, -256, false);
		if (ReturnRaditzDefeatedProcedure.execute(entity))
			guiGraphics.drawString(this.font, Component.translatable("gui.dbm.story_gui_6.label_defeat_raditz_done"), -154, 23, -256, false);
	}
	...
	public void init() {
		...
		imagebutton_quit = new ImageButton(this.leftPos + 163, this.topPos + -102, 9, 9, 0, 0, 9, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_quit.png"), 9, 18, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(0, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_statsicon = new ImageButton(this.leftPos + -171, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_statsicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(1, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_skillicon = new ImageButton(this.leftPos + -146, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_skillicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(2, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_kiattackicon = new ImageButton(this.leftPos + -121, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_kiattackicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(3, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_storyiconhovered = new ImageButton(this.leftPos + -46, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_storyiconhovered.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(4, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
		...
		imagebutton_formicon = new ImageButton(this.leftPos + -96, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_formicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(5, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		});
		...
		imagebutton_ultimateformicon = new ImageButton(this.leftPos + -71, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_ultimateformicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(6, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		});
		...
		imagebutton_groupicon = new ImageButton(this.leftPos + -21, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_groupicon.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(7, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		});
		...
		imagebutton_icon8 = new ImageButton(this.leftPos + 4, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon8.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(8, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 8, x, y, z);
			}
		});
		...
		imagebutton_icon9 = new ImageButton(this.leftPos + 29, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon9.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(9, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 9, x, y, z);
			}
		});
		...
		imagebutton_icon10 = new ImageButton(this.leftPos + 54, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon10.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(10, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 10, x, y, z);
			}
		});
		...
		imagebutton_icon11 = new ImageButton(this.leftPos + 79, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon11.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(11, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 11, x, y, z);
			}
		});
		...
		imagebutton_icon12 = new ImageButton(this.leftPos + 104, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon12.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(12, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 12, x, y, z);
			}
		});
		...
		imagebutton_icon13 = new ImageButton(this.leftPos + 129, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon13.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(13, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 13, x, y, z);
			}
		});
		...
		imagebutton_icon14 = new ImageButton(this.leftPos + 154, this.topPos + 96, 20, 20, 0, 0, 20, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_icon14.png"), 20, 40, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(14, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 14, x, y, z);
			}
		});
		...
		imagebutton_next2 = new ImageButton(this.leftPos + 135, this.topPos + 77, 36, 16, 0, 0, 16, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_next2.png"), 36, 32, e -> {
			if (ReturnRaditzDefeatedProcedure.execute(entity)) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(15, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 15, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
				this.visible = ReturnRaditzDefeatedProcedure.execute(entity);
		...
		imagebutton_start = new ImageButton(this.leftPos + 98, this.topPos + 77, 36, 16, 0, 0, 16, new ResourceLocation("dbm:textures/screens/atlas/imagebutton_start.png"), 36, 32, e -> {
			if (true) {
				DbmMod.PACKET_HANDLER.sendToServer(new StoryGUI6ButtonMessage(16, x, y, z));
				StoryGUI6ButtonMessage.handleButtonAction(entity, 16, x, y, z);
			}
		});
