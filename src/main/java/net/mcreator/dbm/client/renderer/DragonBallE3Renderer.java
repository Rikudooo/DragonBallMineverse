...
public class DragonBallE3Renderer extends MobRenderer<DragonBallE3Entity, ModelDragonBall<DragonBallE3Entity>> {
	public DragonBallE3Renderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<DragonBallE3Entity, ModelDragonBall<DragonBallE3Entity>>(this) {
			final ResourceLocation LAYER_TEXTURE = new ResourceLocation("dbm:textures/entities/stone.png");

			@Override
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, DragonBallE3Entity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
