...
public class DragonBallE4Renderer extends MobRenderer<DragonBallE4Entity, ModelDragonBall<DragonBallE4Entity>> {
	public DragonBallE4Renderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<DragonBallE4Entity, ModelDragonBall<DragonBallE4Entity>>(this) {
			final ResourceLocation LAYER_TEXTURE = new ResourceLocation("dbm:textures/entities/stone.png");

			@Override
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, DragonBallE4Entity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
