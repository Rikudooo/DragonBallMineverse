...
public class DragonBallE1Renderer extends MobRenderer<DragonBallE1Entity, ModelDragonBall<DragonBallE1Entity>> {
	public DragonBallE1Renderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<DragonBallE1Entity, ModelDragonBall<DragonBallE1Entity>>(this) {
			final ResourceLocation LAYER_TEXTURE = new ResourceLocation("dbm:textures/entities/stone.png");

			@Override
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, DragonBallE1Entity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
