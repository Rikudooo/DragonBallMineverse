...
public class DragonBallE2Renderer extends MobRenderer<DragonBallE2Entity, ModelDragonBall<DragonBallE2Entity>> {
	public DragonBallE2Renderer(EntityRendererProvider.Context context) {
		super(context, new ModelDragonBall(context.bakeLayer(ModelDragonBall.LAYER_LOCATION)), 0.2f);
		this.addLayer(new RenderLayer<DragonBallE2Entity, ModelDragonBall<DragonBallE2Entity>>(this) {
			final ResourceLocation LAYER_TEXTURE = new ResourceLocation("dbm:textures/entities/stone.png");

			@Override
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, DragonBallE2Entity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	@Override
	public ResourceLocation getTextureLocation(DragonBallE2Entity entity) {
