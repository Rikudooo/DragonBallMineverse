...
public class DragonBallE6Renderer extends MobRenderer<DragonBallE6Entity, ModelDragonBall<DragonBallE6Entity>> {
	public DragonBallE6Renderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<DragonBallE6Entity, ModelDragonBall<DragonBallE6Entity>>(this) {
			final ResourceLocation LAYER_TEXTURE = new ResourceLocation("dbm:textures/entities/stone.png");

			@Override
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, DragonBallE6Entity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
