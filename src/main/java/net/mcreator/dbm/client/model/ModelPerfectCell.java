...
public class ModelPerfectCell<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("dbm", "model_perfect_cell"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 33).addBox(0.0F, -4.0F, -4.5F, 1.0F, 8.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -12.0F, 0.0F, 0.0F, 0.0F, 0.1222F));
		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 33).addBox(-1.0F, -4.0F, -4.5F, 1.0F, 8.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = Wings.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(50, 42).addBox(-2.5F, -5.5F, -1.0F, 5.0F, 13.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.1201F, -19.2381F, 5.1614F, 0.7459F, -0.274F, 0.2849F));
		PartDefinition cube_r4 = Wings.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(56, 40).addBox(6.75F, -15.25F, 6.0F, 5.0F, 13.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, -5.5F, 9.0F, 0.7459F, 0.274F, -0.2849F));
		PartDefinition cube_r5 = Wings.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(35, 37).addBox(-0.5F, -15.5F, 8.25F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 37).addBox(-1.0F, -16.5F, 8.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
