...
public class ModelScouterScreen<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("dbm", "model_scouter_screen"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Scouter.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(30, 0).addBox(1.175F, -0.85F, -3.225F, 0.05F, 2.1F, 2.975F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.1684F, -28.0F, -1.9816F, 0.0F, 1.5708F, 0.0F));
		PartDefinition bone = Scouter.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition bone2 = bone.addOrReplaceChild("bone2", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, -0.6F));
