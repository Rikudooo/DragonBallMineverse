...
public class Modelbuutenks<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("dbm", "modelbuutenks"), "main");
	...
	public Modelbuutenks(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(24, 10).addBox(-0.5F, -2.75F, 0.875F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -11.5686F, 10.0891F, -2.7925F, 0.0F, 0.0F));
		PartDefinition cube_r2 = bone.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(27, 9).addBox(-0.5625F, -1.375F, 1.75F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0625F, -14.4052F, 8.1963F, -1.8326F, 0.0F, 0.0F));
		PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(23, 8).addBox(-1.125F, -1.5F, 0.25F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1875F, -12.7413F, 4.1553F, -0.8901F, 0.0F, 0.0F));
		PartDefinition cube_r4 = bone.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(9, 0).addBox(-1.5F, -2.5625F, -1.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
