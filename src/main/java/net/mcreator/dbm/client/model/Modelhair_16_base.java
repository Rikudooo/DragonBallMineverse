...
public class Modelhair_16_base<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("dbm", "modelhair_16_base"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r2 = hair.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(50, 58).addBox(-1.025F, -1.2615F, -1.0053F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.4695F, -31.0089F, -4.7707F, -0.6694F, 0.6512F, -0.4756F));
		PartDefinition cube_r3 = hair.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(50, 58).addBox(-0.385F, -1.1709F, -2.8002F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.4695F, -31.0089F, -4.7707F, -0.0411F, 0.6512F, -0.4756F));
		PartDefinition cube_r4 = hair.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(51, 59).addBox(2.0937F, -1.0F, -0.75F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.052F, -32.677F, 0.2535F, -1.9373F, 1.5272F, 0.0F));
		PartDefinition cube_r5 = hair.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(48, 56).addBox(-0.0938F, -1.0F, -3.75F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(50, 58)
		...
		PartDefinition cube_r6 = hair.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(51, 59).addBox(-0.3594F, -2.3558F, -1.2347F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.7599F, -25.7645F, 4.5305F, 0.0F, 0.0F, 0.0F));
		PartDefinition cube_r7 = hair.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(50, 58).addBox(-2.0938F, -1.0F, -5.25F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.052F, -25.6145F, 8.0035F, 0.0F, 0.0F, 0.0F));
		PartDefinition cube_r8 = hair.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(50, 58).addBox(-2.0938F, -1.0F, -5.25F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.052F, -28.802F, 8.0035F, 0.0F, 0.0F, 0.0F));
		PartDefinition cube_r9 = hair.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(51, 59).addBox(-0.3594F, -2.3558F, -1.1097F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = hair.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(50, 58).addBox(-0.6719F, -1.1546F, -2.6564F, 1.3125F, 1.5625F, 3.5F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.3651F, -30.7645F, -4.9695F, 0.6632F, -0.192F, 0.0F));
		PartDefinition cube_r13 = hair.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(49, 57).addBox(-0.8185F, -1.2022F, -1.877F, 1.3125F, 1.5625F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1605F, -29.9392F, -5.959F, 0.6632F, 0.0F, 0.0F));
		PartDefinition cube_r14 = hair.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(50, 58).addBox(-0.9844F, -1.2308F, -1.0472F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
