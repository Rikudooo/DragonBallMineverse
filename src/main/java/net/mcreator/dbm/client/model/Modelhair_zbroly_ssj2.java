...
public class Modelhair_zbroly_ssj2<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("dbm", "modelhair_zbroly_ssj_2"), "main");
	...
	public Modelhair_zbroly_ssj2(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bunch5_r3 = Bottom2.addOrReplaceChild("bunch5_r3",
				CubeListBuilder.create().texOffs(51, 58).addBox(0.2545F, -0.6074F, -0.7436F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).texOffs(51, 58).addBox(0.7545F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch6_r1 = Bottom17.addOrReplaceChild("bunch6_r1", CubeListBuilder.create().texOffs(56, 60).mirror().addBox(-0.5726F, -0.4426F, -0.6215F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(1.8068F, -30.1974F, 0.3136F, 2.5868F, 0.7856F, -2.0333F));
		PartDefinition bunch5_r4 = Bottom17.addOrReplaceChild("bunch5_r4", CubeListBuilder.create().texOffs(56, 60).mirror().addBox(0.3413F, -0.8374F, -0.6959F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(2.6614F, -31.0456F, -1.1421F, -2.3422F, -0.4864F, 0.7071F));
		...
		PartDefinition bunch6_r2 = Bottom18.addOrReplaceChild("bunch6_r2", CubeListBuilder.create().texOffs(51, 58).mirror().addBox(-1.0282F, -1.5467F, -0.5592F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-5.0934F, 1.3321F, 6.4826F, -2.8058F, 0.7973F, -1.9545F));
		PartDefinition bunch5_r5 = Bottom18.addOrReplaceChild("bunch5_r5", CubeListBuilder.create().texOffs(51, 58).mirror().addBox(-2.0563F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.4025F, 0.8696F, 4.1343F, -1.4268F, -0.4483F, 0.686F));
		PartDefinition bunch4_r2 = Bottom18.addOrReplaceChild("bunch4_r2", CubeListBuilder.create().texOffs(51, 58).mirror().addBox(-1.6684F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition bunch5_r6 = Top19.addOrReplaceChild("bunch5_r6", CubeListBuilder.create().texOffs(57, 60).mirror().addBox(-0.4089F, -1.0713F, -1.358F, 1.4414F, 1.44F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition bunch6_r3 = Top20.addOrReplaceChild("bunch6_r3", CubeListBuilder.create().texOffs(56, 60).mirror().addBox(-0.9502F, -0.0085F, -1.4957F, 1.4414F, 1.44F, 2.1622F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition bunch7_r1 = Bottom21.addOrReplaceChild("bunch7_r1", CubeListBuilder.create().texOffs(56, 60).addBox(-0.4274F, -0.4426F, -0.6215F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.8068F, -30.1974F, 0.3136F, 2.5868F, -0.7856F, 2.0333F));
		PartDefinition bunch6_r4 = Bottom21.addOrReplaceChild("bunch6_r4", CubeListBuilder.create().texOffs(56, 60).addBox(-1.3413F, -0.8374F, -0.6959F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.6614F, -31.0456F, -1.1421F, -2.3422F, 0.4864F, -0.7071F));
		...
		PartDefinition bunch7_r2 = Bottom22.addOrReplaceChild("bunch7_r2", CubeListBuilder.create().texOffs(51, 58).addBox(-0.7736F, -1.5467F, -0.5592F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0934F, 1.3321F, 6.4826F, -2.8058F, -0.7973F, 1.9545F));
		PartDefinition bunch6_r5 = Bottom22.addOrReplaceChild("bunch6_r5", CubeListBuilder.create().texOffs(51, 58).addBox(0.2545F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4025F, 0.8696F, 4.1343F, -1.4268F, 0.4483F, -0.686F));
		PartDefinition bunch5_r7 = Bottom22.addOrReplaceChild("bunch5_r7", CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1001F, 1.2323F, 0.4004F, -0.1745F, 0.2182F, 0.0F));
		...
		PartDefinition Bottom24 = Bang23.addOrReplaceChild("Bottom24", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition bunch6_r6 = Bottom13.addOrReplaceChild("bunch6_r6", CubeListBuilder.create().texOffs(56, 60).addBox(-0.4274F, -0.4426F, -0.6215F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.8068F, -30.1974F, 0.3136F, 2.5868F, -0.7856F, 2.0333F));
		PartDefinition bunch5_r8 = Bottom13.addOrReplaceChild("bunch5_r8", CubeListBuilder.create().texOffs(56, 60).addBox(-1.3413F, -0.8374F, -0.6959F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.6614F, -31.0456F, -1.1421F, -2.3422F, 0.4864F, -0.7071F));
		...
		PartDefinition bunch6_r7 = Bottom14.addOrReplaceChild("bunch6_r7", CubeListBuilder.create().texOffs(51, 58).addBox(-0.7736F, -1.5467F, -0.5592F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0934F, 1.3321F, 6.4826F, -2.8058F, -0.7973F, 1.9545F));
		PartDefinition bunch5_r9 = Bottom14.addOrReplaceChild("bunch5_r9", CubeListBuilder.create().texOffs(51, 58).addBox(0.2545F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4025F, 0.8696F, 4.1343F, -1.4268F, 0.4483F, -0.686F));
		PartDefinition Top14 = Bang13.addOrReplaceChild("Top14", CubeListBuilder.create(), PartPose.offset(-0.1001F, -1.2012F, -2.002F));
		PartDefinition bunch5_r10 = Top14.addOrReplaceChild("bunch5_r10", CubeListBuilder.create().texOffs(54, 59).addBox(0.3952F, -1.4682F, -2.9576F, 1.6216F, 1.62F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Bottom16 = Bang15.addOrReplaceChild("Bottom16", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition bunch6_r8 = Bottom5.addOrReplaceChild("bunch6_r8", CubeListBuilder.create().texOffs(56, 60).addBox(-0.4274F, -0.4426F, -0.6215F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.8068F, -30.1974F, 0.3136F, 2.5868F, -0.7856F, 2.0333F));
		PartDefinition bunch5_r11 = Bottom5.addOrReplaceChild("bunch5_r11", CubeListBuilder.create().texOffs(56, 60).addBox(-1.3413F, -0.8374F, -0.6959F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.6614F, -31.0456F, -1.1421F, -2.3422F, 0.4864F, -0.7071F));
		PartDefinition bunch4_r3 = Bottom5.addOrReplaceChild("bunch4_r3", CubeListBuilder.create().texOffs(56, 60).addBox(1.2235F, -1.6532F, 0.708F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch6_r9 = Bottom6.addOrReplaceChild("bunch6_r9", CubeListBuilder.create().texOffs(51, 58).addBox(-0.7736F, -1.5467F, -0.5592F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0934F, 1.3321F, 6.4826F, -2.8058F, -0.7973F, 1.9545F));
		PartDefinition bunch5_r12 = Bottom6.addOrReplaceChild("bunch5_r12", CubeListBuilder.create().texOffs(51, 58).addBox(0.2545F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4025F, 0.8696F, 4.1343F, -1.4268F, 0.4483F, -0.686F));
		PartDefinition bunch4_r4 = Bottom6.addOrReplaceChild("bunch4_r4", CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1001F, 1.2323F, 0.4004F, -0.1745F, 0.2182F, 0.0F));
		PartDefinition Top6 = Bang5.addOrReplaceChild("Top6", CubeListBuilder.create(), PartPose.offset(-0.1001F, -1.2012F, -2.002F));
		PartDefinition bunch5_r13 = Top6.addOrReplaceChild("bunch5_r13", CubeListBuilder.create().texOffs(54, 59).addBox(0.3952F, -1.4682F, -2.9576F, 1.6216F, 1.62F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0025F, 1.1696F, 4.4343F, -0.5716F, 0.4483F, -0.686F));
		...
		PartDefinition bunch5_r14 = Bottom7.addOrReplaceChild("bunch5_r14", CubeListBuilder.create().texOffs(55, 59).addBox(-1.1126F, -1.2629F, -0.3133F, 1.6016F, 1.6F, 2.4024F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch5_r15 = Top7.addOrReplaceChild("bunch5_r15", CubeListBuilder.create().texOffs(57, 60).addBox(-1.0325F, -1.0713F, -1.358F, 1.4414F, 1.44F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5963F, 0.7266F, 0.5984F, 0.4978F, 0.6959F, -0.3871F));
		...
		PartDefinition bunch7_r3 = Bottom9.addOrReplaceChild("bunch7_r3", CubeListBuilder.create().texOffs(56, 60).mirror().addBox(-0.5726F, -0.4426F, -0.6215F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(1.8068F, -30.1974F, 0.3136F, 2.5868F, 0.7856F, -2.0333F));
		PartDefinition bunch6_r10 = Bottom9.addOrReplaceChild("bunch6_r10", CubeListBuilder.create().texOffs(56, 60).mirror().addBox(0.3413F, -0.8374F, -0.6959F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(2.6614F, -31.0456F, -1.1421F, -2.3422F, -0.4864F, 0.7071F));
		...
		PartDefinition bunch7_r4 = Bang9.addOrReplaceChild("bunch7_r4", CubeListBuilder.create().texOffs(51, 58).mirror().addBox(-1.0282F, -1.5467F, -0.5592F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-4.9933F, 0.1309F, 4.4806F, -2.8058F, 0.7973F, -1.9545F));
		PartDefinition bunch7_r5 = Bang9.addOrReplaceChild("bunch7_r5", CubeListBuilder.create().texOffs(51, 58).mirror().addBox(-2.0563F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).mirror(false).texOffs(51, 58).mirror()
				.addBox(-2.5563F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.5026F, -0.3316F, 2.1323F, -1.4268F, -0.4483F, 0.686F));
		PartDefinition Bottom25 = Bang9.addOrReplaceChild("Bottom25", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.8104F, -0.1916F, 0.5081F, 1.789F, 0.0F, 2.9671F));
		...
		PartDefinition cube_r468 = Back12.addOrReplaceChild("cube_r468", CubeListBuilder.create().texOffs(51, 53).addBox(-1.5627F, -1.06F, -1.8881F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1167F, 2.0621F, -0.087F, 0.8158F, -0.1816F, -0.1896F));
		PartDefinition SuperBang = Hair.addOrReplaceChild("SuperBang", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.9433F, -31.3109F, -2.8784F, 0.829F, -0.9599F, 3.098F));
		PartDefinition bunch6_r11 = SuperBang.addOrReplaceChild("bunch6_r11", CubeListBuilder.create().texOffs(55, 60).addBox(-0.0323F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9105F, -1.9773F, -3.5101F, 0.1745F, 0.2182F, 0.0F));
		PartDefinition bunch6_r12 = SuperBang.addOrReplaceChild("bunch6_r12", CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.8104F, -0.7773F, -3.1097F, -0.1745F, 0.2182F, 0.0F));
		PartDefinition SuperBang8 = Hair.addOrReplaceChild("SuperBang8", CubeListBuilder.create(), PartPose.offsetAndRotation(0.9433F, -32.0609F, -2.8784F, 0.3874F, 0.1131F, -3.0241F));
		PartDefinition bunch8_r1 = SuperBang8.addOrReplaceChild("bunch8_r1", CubeListBuilder.create().texOffs(55, 60).mirror().addBox(-1.5894F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9105F, -1.9773F, -3.5101F, 0.1745F, -0.2182F, 0.0F));
		PartDefinition bunch8_r2 = SuperBang8.addOrReplaceChild("bunch8_r2", CubeListBuilder.create().texOffs(51, 58).mirror().addBox(-1.6684F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.8104F, -0.7773F, -3.1097F, -0.1745F, -0.2182F, 0.0F));
		PartDefinition SuperBang7 = Hair.addOrReplaceChild("SuperBang7", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.9433F, -32.0609F, -2.8784F, 0.3874F, -0.1131F, 3.0241F));
		PartDefinition bunch9_r1 = SuperBang7.addOrReplaceChild("bunch9_r1", CubeListBuilder.create().texOffs(55, 60).addBox(-0.0323F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9105F, -1.9773F, -3.5101F, 0.1745F, 0.2182F, 0.0F));
		PartDefinition bunch9_r2 = SuperBang7.addOrReplaceChild("bunch9_r2", CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.8104F, -0.7773F, -3.1097F, -0.1745F, 0.2182F, 0.0F));
		PartDefinition SuperBang9 = Hair.addOrReplaceChild("SuperBang9", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.9433F, -33.0609F, -2.8784F, 1.2164F, -0.1131F, 3.0241F));
		PartDefinition bunch10_r1 = SuperBang9.addOrReplaceChild("bunch10_r1", CubeListBuilder.create().texOffs(55, 60).addBox(-0.0323F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9105F, -1.9773F, -3.5101F, 0.1745F, 0.2182F, 0.0F));
		PartDefinition bunch10_r2 = SuperBang9.addOrReplaceChild("bunch10_r2", CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.8104F, -0.7773F, -3.1097F, -0.1745F, 0.2182F, 0.0F));
		PartDefinition SuperBang10 = Hair.addOrReplaceChild("SuperBang10", CubeListBuilder.create(), PartPose.offsetAndRotation(0.9433F, -33.0609F, -2.8784F, 1.2164F, 0.1131F, -3.0241F));
		PartDefinition bunch11_r1 = SuperBang10.addOrReplaceChild("bunch11_r1", CubeListBuilder.create().texOffs(55, 60).mirror().addBox(-1.5894F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9105F, -1.9773F, -3.5101F, 0.1745F, -0.2182F, 0.0F));
		PartDefinition bunch11_r2 = SuperBang10.addOrReplaceChild("bunch11_r2", CubeListBuilder.create().texOffs(51, 58).mirror().addBox(-1.6684F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.8104F, -0.7773F, -3.1097F, -0.1745F, -0.2182F, 0.0F));
		PartDefinition SuperBang11 = Hair.addOrReplaceChild("SuperBang11", CubeListBuilder.create(), PartPose.offsetAndRotation(0.9433F, -35.0609F, -0.8784F, 1.2164F, 0.1131F, -3.0241F));
		PartDefinition bunch12_r1 = SuperBang11.addOrReplaceChild("bunch12_r1", CubeListBuilder.create().texOffs(55, 60).mirror().addBox(-1.5894F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9105F, -1.9773F, -3.5101F, 0.1745F, -0.2182F, 0.0F));
		PartDefinition bunch12_r2 = SuperBang11.addOrReplaceChild("bunch12_r2", CubeListBuilder.create().texOffs(51, 58).mirror().addBox(-1.6684F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.8104F, -0.7773F, -3.1097F, -0.1745F, -0.2182F, 0.0F));
		PartDefinition SuperBang12 = Hair.addOrReplaceChild("SuperBang12", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.9433F, -35.0609F, -0.8784F, 1.2164F, -0.1131F, 3.0241F));
		PartDefinition bunch13_r1 = SuperBang12.addOrReplaceChild("bunch13_r1", CubeListBuilder.create().texOffs(55, 60).addBox(-0.0323F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9105F, -1.9773F, -3.5101F, 0.1745F, 0.2182F, 0.0F));
		PartDefinition bunch13_r2 = SuperBang12.addOrReplaceChild("bunch13_r2", CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.8104F, -0.7773F, -3.1097F, -0.1745F, 0.2182F, 0.0F));
		PartDefinition SuperBang13 = Hair.addOrReplaceChild("SuperBang13", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.9433F, -35.0609F, -0.8784F, 2.2636F, -0.1131F, 3.0241F));
		PartDefinition bunch14_r1 = SuperBang13.addOrReplaceChild("bunch14_r1", CubeListBuilder.create().texOffs(55, 60).addBox(-0.0323F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9105F, -1.9773F, -3.5101F, 0.1745F, 0.2182F, 0.0F));
		PartDefinition bunch14_r2 = SuperBang13.addOrReplaceChild("bunch14_r2", CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.8104F, -0.7773F, -3.1097F, -0.1745F, 0.2182F, 0.0F));
		PartDefinition SuperBang14 = Hair.addOrReplaceChild("SuperBang14", CubeListBuilder.create(), PartPose.offsetAndRotation(0.9433F, -35.0609F, -0.8784F, 2.2636F, 0.1131F, -3.0241F));
		PartDefinition bunch15_r1 = SuperBang14.addOrReplaceChild("bunch15_r1", CubeListBuilder.create().texOffs(55, 60).mirror().addBox(-1.5894F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9105F, -1.9773F, -3.5101F, 0.1745F, -0.2182F, 0.0F));
		PartDefinition bunch15_r2 = SuperBang14.addOrReplaceChild("bunch15_r2", CubeListBuilder.create().texOffs(51, 58).mirror().addBox(-1.6684F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.8104F, -0.7773F, -3.1097F, -0.1745F, -0.2182F, 0.0F));
		PartDefinition SuperBang2 = Hair.addOrReplaceChild("SuperBang2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.9433F, -31.3109F, -2.8784F, 0.829F, 0.9599F, -3.098F));
		PartDefinition bunch7_r6 = SuperBang2.addOrReplaceChild("bunch7_r6", CubeListBuilder.create().texOffs(55, 60).mirror().addBox(-1.5894F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9105F, -1.9773F, -3.5101F, 0.1745F, -0.2182F, 0.0F));
		PartDefinition bunch7_r7 = SuperBang2.addOrReplaceChild("bunch7_r7", CubeListBuilder.create().texOffs(51, 58).mirror().addBox(-1.6684F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.8104F, -0.7773F, -3.1097F, -0.1745F, -0.2182F, 0.0F));
		PartDefinition SuperBang3 = Hair.addOrReplaceChild("SuperBang3", CubeListBuilder.create(), PartPose.offsetAndRotation(1.9433F, -34.3109F, -1.8784F, 0.829F, 0.9599F, -3.098F));
		PartDefinition bunch8_r3 = SuperBang3.addOrReplaceChild("bunch8_r3", CubeListBuilder.create().texOffs(55, 60).mirror().addBox(-1.5894F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9105F, -1.9773F, -3.5101F, 0.1745F, -0.2182F, 0.0F));
		PartDefinition bunch8_r4 = SuperBang3.addOrReplaceChild("bunch8_r4", CubeListBuilder.create().texOffs(51, 58).mirror().addBox(-1.6684F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.8104F, -0.7773F, -3.1097F, -0.1745F, -0.2182F, 0.0F));
		PartDefinition SuperBang4 = Hair.addOrReplaceChild("SuperBang4", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.9433F, -34.3109F, -1.8784F, 0.829F, -0.9599F, 3.098F));
		PartDefinition bunch9_r3 = SuperBang4.addOrReplaceChild("bunch9_r3", CubeListBuilder.create().texOffs(55, 60).addBox(-0.0323F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9105F, -1.9773F, -3.5101F, 0.1745F, 0.2182F, 0.0F));
		PartDefinition bunch9_r4 = SuperBang4.addOrReplaceChild("bunch9_r4", CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.8104F, -0.7773F, -3.1097F, -0.1745F, 0.2182F, 0.0F));
		PartDefinition SuperBang5 = Hair.addOrReplaceChild("SuperBang5", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.9433F, -34.3109F, 1.1216F, 0.829F, -0.9599F, 3.098F));
		PartDefinition bunch10_r3 = SuperBang5.addOrReplaceChild("bunch10_r3", CubeListBuilder.create().texOffs(55, 60).addBox(-0.0323F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9105F, -1.9773F, -3.5101F, 0.1745F, 0.2182F, 0.0F));
		PartDefinition bunch10_r4 = SuperBang5.addOrReplaceChild("bunch10_r4", CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.8104F, -0.7773F, -3.1097F, -0.1745F, 0.2182F, 0.0F));
		PartDefinition SuperBang6 = Hair.addOrReplaceChild("SuperBang6", CubeListBuilder.create(), PartPose.offsetAndRotation(1.9433F, -34.3109F, 1.1216F, 0.829F, 0.9599F, -3.098F));
		PartDefinition bunch11_r3 = SuperBang6.addOrReplaceChild("bunch11_r3", CubeListBuilder.create().texOffs(55, 60).mirror().addBox(-1.5894F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9105F, -1.9773F, -3.5101F, 0.1745F, -0.2182F, 0.0F));
		PartDefinition bunch11_r4 = SuperBang6.addOrReplaceChild("bunch11_r4", CubeListBuilder.create().texOffs(51, 58).mirror().addBox(-1.6684F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.8104F, -0.7773F, -3.1097F, -0.1745F, -0.2182F, 0.0F));
