...
public class ModelPiccolo<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("dbm", "model_piccolo"), "main");
	...
	public final ModelPart antenna3;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(16, 48).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
		...
		PartDefinition head_r4 = Ears2.addOrReplaceChild("head_r4", CubeListBuilder.create().texOffs(53, 43).mirror().addBox(-0.75F, -0.7F, -1.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-4.0F, -4.0F, 0.5F, 0.8702F, -0.3897F, -0.4233F));
		PartDefinition antenna3 = Head.addOrReplaceChild("antenna3", CubeListBuilder.create(), PartPose.offsetAndRotation(0.1134F, -7.9647F, -5.0879F, -0.7854F, 0.0F, 0.0F));
		PartDefinition cube_r1 = antenna3.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(20, 10).addBox(-0.5F, -0.125F, -1.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.2003F, -0.1054F, -1.5836F, 0.2967F, -0.3927F, 0.0F));
		PartDefinition cube_r2 = antenna3.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(20, 10).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.8866F, -0.2853F, 1.5879F, 0.0524F, -0.3927F, 0.0F));
		PartDefinition cube_r3 = antenna3.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(20, 10).addBox(-0.5F, -0.125F, -1.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.9581F, -0.0412F, -1.7999F, 0.2967F, 0.2443F, 0.0F));
		PartDefinition cube_r4 = antenna3.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(20, 10).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
