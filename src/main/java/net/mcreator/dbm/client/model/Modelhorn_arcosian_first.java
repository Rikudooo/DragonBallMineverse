...
public class Modelhorn_arcosian_first<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("dbm", "modelhorn_arcosian_first"), "main");
	...
	public Modelhorn_arcosian_first(ModelPart root) {
