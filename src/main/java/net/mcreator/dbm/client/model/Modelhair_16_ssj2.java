...
public class Modelhair_16_ssj2<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("dbm", "modelhair_16_ssj_2"), "main");
	...
	public Modelhair_16_ssj2(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = hair.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(51, 59).addBox(2.0937F, -1.0F, -0.75F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.052F, -32.677F, 0.2535F, -1.9373F, 1.5272F, 0.0F));
		PartDefinition cube_r2 = hair.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(48, 56).addBox(-0.0938F, -1.0F, -3.75F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(50, 58)
		...
		PartDefinition cube_r3 = hair.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(51, 59).addBox(-0.3594F, -2.3558F, -0.4097F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.7599F, -25.7645F, 4.5305F, 0.3491F, 0.0F, 0.0F));
		PartDefinition cube_r4 = hair.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(50, 58).addBox(-2.0938F, -2.45F, -5.9F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.052F, -25.6145F, 8.0035F, 0.3054F, 0.0F, 0.0F));
		PartDefinition cube_r5 = hair.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(50, 58).addBox(-2.0938F, -2.5F, -5.25F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.052F, -28.802F, 8.0035F, 0.5236F, 0.0F, 0.0F));
		PartDefinition cube_r6 = hair.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(51, 59).addBox(-0.3594F, -2.3558F, -1.1097F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = bone2.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(50, 58).addBox(-0.6719F, -1.1546F, -2.6564F, 1.3125F, 1.5625F, 3.5F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.6632F, -0.192F, 0.0F));
		PartDefinition cube_r10 = bone2.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(50, 58).addBox(-0.9844F, -1.2308F, -1.0472F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0349F, -0.192F, 0.0F));
		PartDefinition bone3 = hair.addOrReplaceChild("bone3", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.1605F, -30.8642F, -3.259F, 0.5236F, 0.0F, 3.098F));
		PartDefinition cube_r11 = bone3.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(49, 57).addBox(-0.8185F, -1.0772F, -2.077F, 1.3125F, 1.5625F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.75F, -2.5F, 0.6632F, 0.0F, 0.0F));
		PartDefinition cube_r12 = bone3.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(50, 58).addBox(-1.131F, -2.0213F, -0.0401F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.75F, -2.5F, 0.0349F, 0.0F, 0.0F));
