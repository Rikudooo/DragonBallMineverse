...
public class Modelhair_zbroly_ssj<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("dbm", "modelhair_zbroly_ssj"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition SuperBang7 = Hair.addOrReplaceChild("SuperBang7", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.9433F, -31.3109F, -2.8784F, 0.5029F, 0.735F, -0.2021F));
		PartDefinition bunch7_r6 = SuperBang7.addOrReplaceChild("bunch7_r6", CubeListBuilder.create().texOffs(55, 60).addBox(-0.0323F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9105F, -1.9773F, -3.5101F, 0.1745F, 0.2182F, 0.0F));
		PartDefinition bunch7_r7 = SuperBang7.addOrReplaceChild("bunch7_r7", CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.8104F, -0.7773F, -3.1097F, -0.1745F, 0.2182F, 0.0F));
		PartDefinition SuperBang8 = Hair.addOrReplaceChild("SuperBang8", CubeListBuilder.create(), PartPose.offsetAndRotation(0.9433F, -31.3109F, -2.8784F, 0.5029F, -0.735F, 0.2021F));
		...
		PartDefinition bunch7_r8 = SuperBang2.addOrReplaceChild("bunch7_r8", CubeListBuilder.create().texOffs(55, 60).mirror().addBox(-1.5894F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9105F, -1.9773F, -3.5101F, 0.1745F, -0.2182F, 0.0F));
		PartDefinition bunch7_r9 = SuperBang2.addOrReplaceChild("bunch7_r9", CubeListBuilder.create().texOffs(51, 58).mirror().addBox(-1.6684F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.8104F, -0.7773F, -3.1097F, -0.1745F, -0.2182F, 0.0F));
		...
		PartDefinition bunch9_r1 = SuperBang4.addOrReplaceChild("bunch9_r1", CubeListBuilder.create().texOffs(55, 60).addBox(-0.0323F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9105F, -1.9773F, -3.5101F, 0.1745F, 0.2182F, 0.0F));
		PartDefinition bunch9_r2 = SuperBang4.addOrReplaceChild("bunch9_r2", CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.8104F, -0.7773F, -3.1097F, -0.1745F, 0.2182F, 0.0F));
		...
		PartDefinition bunch10_r1 = SuperBang5.addOrReplaceChild("bunch10_r1", CubeListBuilder.create().texOffs(55, 60).addBox(-0.0323F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9105F, -1.9773F, -3.5101F, 0.1745F, 0.2182F, 0.0F));
		PartDefinition bunch10_r2 = SuperBang5.addOrReplaceChild("bunch10_r2", CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.8104F, -0.7773F, -3.1097F, -0.1745F, 0.2182F, 0.0F));
		...
		PartDefinition bunch11_r1 = SuperBang6.addOrReplaceChild("bunch11_r1", CubeListBuilder.create().texOffs(55, 60).mirror().addBox(-1.5894F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.9105F, -1.9773F, -3.5101F, 0.1745F, -0.2182F, 0.0F));
		PartDefinition bunch11_r2 = SuperBang6.addOrReplaceChild("bunch11_r2", CubeListBuilder.create().texOffs(51, 58).mirror().addBox(-1.6684F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.8104F, -0.7773F, -3.1097F, -0.1745F, -0.2182F, 0.0F));
