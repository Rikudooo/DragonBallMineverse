...
public class ModelTrunksDBZ<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("dbm", "model_trunks_dbz"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Hair = Head.addOrReplaceChild("Hair",
				CubeListBuilder.create().texOffs(44, 0).addBox(-1.0F, -10.0F, -4.0F, 3.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(44, 0).addBox(-1.5F, -9.5F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(44, 0)
						.addBox(2.0F, -9.0F, -4.0F, 2.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(44, 0).addBox(1.75F, -9.5F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(44, 0)
						.addBox(3.25F, -9.5F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(44, 0).addBox(4.0F, -10.0F, -4.0F, 3.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(44, 0)
						.addBox(5.0F, -9.25F, -4.25F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 0).addBox(0.0F, -9.25F, -4.25F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 0)
		...
		PartDefinition bone = Hair.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(44, 0).addBox(-2.0F, -10.0F, -4.0F, 1.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 0).addBox(-2.0F, -10.0F, -2.0F, 1.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 0)
						.addBox(-2.0F, -10.0F, 0.0F, 1.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 0).addBox(-2.0F, -10.0F, 2.0F, 1.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 1.0F, 0.0F));
		PartDefinition bone2 = bone.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(44, 0).addBox(-1.0F, 0.0F, -1.0F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -10.0F, -3.25F, 0.0F, -0.7854F, 0.0F));
		PartDefinition bone3 = Hair.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(44, 0).addBox(-2.0F, -10.0F, -4.0F, 1.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 0).addBox(-2.0F, -10.0F, -2.0F, 1.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 0)
						.addBox(-2.0F, -10.0F, 0.0F, 1.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 0).addBox(-2.0F, -10.0F, 2.0F, 1.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(9.0F, 1.0F, 0.0F));
		PartDefinition bone4 = bone3.addOrReplaceChild("bone4", CubeListBuilder.create().texOffs(44, 0).addBox(-1.0F, 0.0F, -1.0F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.75F, -10.0F, -4.0F, 0.0F, 0.7854F, 0.0F));
		PartDefinition bone5 = Hair.addOrReplaceChild("bone5", CubeListBuilder.create().texOffs(44, 0).addBox(-0.25F, -0.25F, -3.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.5F, -9.0F, -4.0F, 1.2053F, -0.147F, -0.3655F));
		PartDefinition bone6 = Hair.addOrReplaceChild("bone6", CubeListBuilder.create().texOffs(44, 0).addBox(-0.25F, -0.25F, -3.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
