...
public class Modelssj4_eyeliner<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Eyebrow = Head.addOrReplaceChild("Eyebrow",
				CubeListBuilder.create().texOffs(58, 62).addBox(-3.0F, -29.3F, -4.005F, 2.0F, 0.2F, 1.0F, new CubeDeformation(0.0F)).texOffs(58, 62).mirror().addBox(1.0F, -29.3F, -4.005F, 2.0F, 0.2F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
