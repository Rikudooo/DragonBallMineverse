...
@Mod("dbm")
public class DbmMod {
	public static final Logger LOGGER = LogManager.getLogger(DbmMod.class);
	...
	public DbmMod() {
		...
		DbmModSounds.REGISTRY.register(bus);
		DbmModBlocks.REGISTRY.register(bus);

		DbmModItems.REGISTRY.register(bus);
