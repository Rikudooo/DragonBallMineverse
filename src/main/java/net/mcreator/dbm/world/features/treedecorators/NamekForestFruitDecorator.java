...
package net.mcreator.dbm.world.features.treedecorators;
...
public class NamekForestFruitDecorator extends CocoaDecorator {
	public static Codec<NamekForestFruitDecorator> CODEC = Codec.unit(NamekForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("namek_forest_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public NamekForestFruitDecorator() {
		super(0.2f);
	}
