...
public class StoryGUI89ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI89ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI89ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI89ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI89ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI89Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI89ButtonMessage.class, StoryGUI89ButtonMessage::buffer, StoryGUI89ButtonMessage::new, StoryGUI89ButtonMessage::handler);
	}
}
