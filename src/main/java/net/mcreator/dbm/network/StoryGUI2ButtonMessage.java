...
import net.mcreator.dbm.procedures.SpawnPiccoloProcedure;
import net.mcreator.dbm.procedures.SetStory3Procedure;
...
public class StoryGUI2ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI2ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI2ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI2ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI2ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI2Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SpawnPiccoloProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SetStory3Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI2ButtonMessage.class, StoryGUI2ButtonMessage::buffer, StoryGUI2ButtonMessage::new, StoryGUI2ButtonMessage::handler);
	}
}
