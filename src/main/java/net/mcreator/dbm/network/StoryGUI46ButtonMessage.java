...
import net.mcreator.dbm.procedures.SetStory47Procedure;
...
public class StoryGUI46ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI46ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI46ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI46ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI46ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI46Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory47Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI46ButtonMessage.class, StoryGUI46ButtonMessage::buffer, StoryGUI46ButtonMessage::new, StoryGUI46ButtonMessage::handler);
	}
}
