...
import net.mcreator.dbm.procedures.SpawnGoldenFriezaProcedure;
import net.mcreator.dbm.procedures.SetStory88Procedure;
...
public class StoryGUI87ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI87ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI87ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI87ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI87ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI87Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory88Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnGoldenFriezaProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI87ButtonMessage.class, StoryGUI87ButtonMessage::buffer, StoryGUI87ButtonMessage::new, StoryGUI87ButtonMessage::handler);
	}
}
