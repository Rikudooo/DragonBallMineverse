...
import net.mcreator.dbm.procedures.SpwanAndroid17Procedure;
import net.mcreator.dbm.procedures.SetStory38Procedure;
...
public class StoryGUI37ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI37ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI37ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI37ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI37ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI37Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory38Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpwanAndroid17Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI37ButtonMessage.class, StoryGUI37ButtonMessage::buffer, StoryGUI37ButtonMessage::new, StoryGUI37ButtonMessage::handler);
	}
}
