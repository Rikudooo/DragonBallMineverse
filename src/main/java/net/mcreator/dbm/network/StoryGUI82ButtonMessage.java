...
import net.mcreator.dbm.procedures.SetStory83Procedure;
...
public class StoryGUI82ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI82ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI82ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI82ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI82ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI82Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory83Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI82ButtonMessage.class, StoryGUI82ButtonMessage::buffer, StoryGUI82ButtonMessage::new, StoryGUI82ButtonMessage::handler);
	}
}
