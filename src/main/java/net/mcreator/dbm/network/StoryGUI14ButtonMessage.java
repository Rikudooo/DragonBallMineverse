...
import net.mcreator.dbm.procedures.SetSTory15Procedure;
...
public class StoryGUI14ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI14ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI14ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI14ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI14ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI14Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetSTory15Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnCuiProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI14ButtonMessage.class, StoryGUI14ButtonMessage::buffer, StoryGUI14ButtonMessage::new, StoryGUI14ButtonMessage::handler);
	}
}
