...
import net.mcreator.dbm.procedures.SpawnZarbonProcedure;
import net.mcreator.dbm.procedures.SetStory17Procedure;
...
public class StoryGUI16ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI16ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI16ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI16ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI16ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI16Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory17Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnZarbonProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI16ButtonMessage.class, StoryGUI16ButtonMessage::buffer, StoryGUI16ButtonMessage::new, StoryGUI16ButtonMessage::handler);
	}
}
