...
import net.mcreator.dbm.procedures.SpawnMYMProcedure;
import net.mcreator.dbm.procedures.SetStory26Procedure;
...
public class StoryGUI25ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI25ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI25ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI25ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI25ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI25Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory26Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnMYMProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI25ButtonMessage.class, StoryGUI25ButtonMessage::buffer, StoryGUI25ButtonMessage::new, StoryGUI25ButtonMessage::handler);
	}
}
