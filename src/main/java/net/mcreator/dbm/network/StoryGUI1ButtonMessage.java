...
import net.mcreator.dbm.procedures.SpawnTienShinhanProcedure;
import net.mcreator.dbm.procedures.SetStory2Procedure;
...
public class StoryGUI1ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI1ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI1ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI1ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI1ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI1Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SpawnTienShinhanProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SetStory2Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI1ButtonMessage.class, StoryGUI1ButtonMessage::buffer, StoryGUI1ButtonMessage::new, StoryGUI1ButtonMessage::handler);
	}
}
