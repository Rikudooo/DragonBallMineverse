...
public class StoryGUI51ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI51ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI51ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI51ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI51ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI51Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI51ButtonMessage.class, StoryGUI51ButtonMessage::buffer, StoryGUI51ButtonMessage::new, StoryGUI51ButtonMessage::handler);
	}
}
