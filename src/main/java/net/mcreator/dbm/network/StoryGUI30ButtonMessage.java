...
import net.mcreator.dbm.procedures.SetStory31Procedure;
...
public class StoryGUI30ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI30ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI30ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI30ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI30ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI30Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory31Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI30ButtonMessage.class, StoryGUI30ButtonMessage::buffer, StoryGUI30ButtonMessage::new, StoryGUI30ButtonMessage::handler);
	}
}
