...
public class StoryGUI67ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI67ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI67ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI67ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI67ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI67Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory68Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI67ButtonMessage.class, StoryGUI67ButtonMessage::buffer, StoryGUI67ButtonMessage::new, StoryGUI67ButtonMessage::handler);
	}
}
