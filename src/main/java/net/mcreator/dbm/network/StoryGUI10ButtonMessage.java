...
import net.mcreator.dbm.procedures.SetStory11Procedure;
...
public class StoryGUI10ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI10ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI10ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI10ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI10ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI10Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory11Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI10ButtonMessage.class, StoryGUI10ButtonMessage::buffer, StoryGUI10ButtonMessage::new, StoryGUI10ButtonMessage::handler);
	}
}
