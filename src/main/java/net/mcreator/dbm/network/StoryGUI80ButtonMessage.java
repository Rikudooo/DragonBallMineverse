...
public class StoryGUI80ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI80ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI80ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI80ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI80ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI80Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI80ButtonMessage.class, StoryGUI80ButtonMessage::buffer, StoryGUI80ButtonMessage::new, StoryGUI80ButtonMessage::handler);
	}
}
