...
import net.mcreator.dbm.procedures.SetStory63Procedure;
...
public class StoryGUI62ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI62ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI62ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI62ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI62ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI62Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory63Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI62ButtonMessage.class, StoryGUI62ButtonMessage::buffer, StoryGUI62ButtonMessage::new, StoryGUI62ButtonMessage::handler);
	}
}
