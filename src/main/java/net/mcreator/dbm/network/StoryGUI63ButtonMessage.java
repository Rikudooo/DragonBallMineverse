...
import net.mcreator.dbm.procedures.SetStory64Procedure;
...
public class StoryGUI63ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI63ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI63ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI63ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI63ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI63Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory64Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI63ButtonMessage.class, StoryGUI63ButtonMessage::buffer, StoryGUI63ButtonMessage::new, StoryGUI63ButtonMessage::handler);
	}
}
