...
public class SaiyanFormsGUIButtonMessage {
	private final int buttonID, x, y, z;

	public SaiyanFormsGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public SaiyanFormsGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(SaiyanFormsGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(SaiyanFormsGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = SaiyanFormsGUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(SaiyanFormsGUIButtonMessage.class, SaiyanFormsGUIButtonMessage::buffer, SaiyanFormsGUIButtonMessage::new, SaiyanFormsGUIButtonMessage::handler);
	}
}
