...
import net.mcreator.dbm.procedures.SpawnAndroid2019Procedure;
import net.mcreator.dbm.procedures.SetStory29Procedure;
...
public class StoryGUI28ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI28ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI28ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI28ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI28ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI28Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory29Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnAndroid2019Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI28ButtonMessage.class, StoryGUI28ButtonMessage::buffer, StoryGUI28ButtonMessage::new, StoryGUI28ButtonMessage::handler);
	}
}
