...
import net.mcreator.dbm.procedures.SetStory36Procedure;
...
public class StoryGUI35ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI35ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI35ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI35ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI35ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI35Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory36Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI35ButtonMessage.class, StoryGUI35ButtonMessage::buffer, StoryGUI35ButtonMessage::new, StoryGUI35ButtonMessage::handler);
	}
}
