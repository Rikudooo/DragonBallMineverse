...
import net.mcreator.dbm.procedures.SetStory41Procedure;
...
public class StoryGUI40ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI40ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI40ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI40ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI40ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI40Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory41Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI40ButtonMessage.class, StoryGUI40ButtonMessage::buffer, StoryGUI40ButtonMessage::new, StoryGUI40ButtonMessage::handler);
	}
}
