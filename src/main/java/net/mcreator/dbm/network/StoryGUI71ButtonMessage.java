...
import net.mcreator.dbm.procedures.TeleportKaioshinkaiProcedure;
import net.mcreator.dbm.procedures.SpawnKidBuuProcedure;
import net.mcreator.dbm.procedures.SetStory72Procedure;
...
public class StoryGUI71ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI71ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI71ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI71ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI71ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI71Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory72Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnKidBuuProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 17) {

			TeleportKaioshinkaiProcedure.execute(world, x, y, z);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI71ButtonMessage.class, StoryGUI71ButtonMessage::buffer, StoryGUI71ButtonMessage::new, StoryGUI71ButtonMessage::handler);
	}
}
