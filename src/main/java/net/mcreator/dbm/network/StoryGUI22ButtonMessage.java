...
import net.mcreator.dbm.procedures.SpawnFriezaSoldier2Procedure;
import net.mcreator.dbm.procedures.SetStory23Procedure;
...
public class StoryGUI22ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI22ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI22ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI22ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI22ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI22Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory23Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnFriezaSoldier2Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI22ButtonMessage.class, StoryGUI22ButtonMessage::buffer, StoryGUI22ButtonMessage::new, StoryGUI22ButtonMessage::handler);
	}
}
