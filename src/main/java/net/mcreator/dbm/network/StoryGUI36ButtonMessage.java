...
import net.mcreator.dbm.procedures.SetStory37Procedure;
...
public class StoryGUI36ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI36ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI36ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI36ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI36ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI36Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory37Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI36ButtonMessage.class, StoryGUI36ButtonMessage::buffer, StoryGUI36ButtonMessage::new, StoryGUI36ButtonMessage::handler);
	}
}
