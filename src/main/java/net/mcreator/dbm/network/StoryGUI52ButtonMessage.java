...
import net.mcreator.dbm.procedures.SpawnKibitoProcedure;
import net.mcreator.dbm.procedures.SetSTory53Procedure;
...
public class StoryGUI52ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI52ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI52ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI52ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI52ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI52Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetSTory53Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnKibitoProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI52ButtonMessage.class, StoryGUI52ButtonMessage::buffer, StoryGUI52ButtonMessage::new, StoryGUI52ButtonMessage::handler);
	}
}
