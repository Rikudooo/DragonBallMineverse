...
import net.mcreator.dbm.procedures.SpawnGinyuForceProcedure;
import net.mcreator.dbm.procedures.SetStory18Procedure;
...
public class StoryGUI17ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI17ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI17ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI17ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI17ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI17Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory18Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnGinyuForceProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI17ButtonMessage.class, StoryGUI17ButtonMessage::buffer, StoryGUI17ButtonMessage::new, StoryGUI17ButtonMessage::handler);
	}
}
