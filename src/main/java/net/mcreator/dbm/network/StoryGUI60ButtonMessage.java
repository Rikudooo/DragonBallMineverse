...
import net.mcreator.dbm.procedures.SpawnMajinBuuProcedure;
import net.mcreator.dbm.procedures.SetStory61Procedure;
...
public class StoryGUI60ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI60ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI60ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI60ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI60ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI60Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory61Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnMajinBuuProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI60ButtonMessage.class, StoryGUI60ButtonMessage::buffer, StoryGUI60ButtonMessage::new, StoryGUI60ButtonMessage::handler);
	}
}
