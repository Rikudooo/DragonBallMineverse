...
import net.mcreator.dbm.procedures.SpawnAndroid18Procedure;
import net.mcreator.dbm.procedures.SetStory32Procedure;
...
public class StoryGUI31ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI31ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI31ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI31ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI31ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI31Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory32Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnAndroid18Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI31ButtonMessage.class, StoryGUI31ButtonMessage::buffer, StoryGUI31ButtonMessage::new, StoryGUI31ButtonMessage::handler);
	}
}
