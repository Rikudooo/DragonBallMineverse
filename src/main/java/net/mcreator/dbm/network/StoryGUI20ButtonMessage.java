...
import net.mcreator.dbm.procedures.SetStory21Procedure;
...
public class StoryGUI20ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI20ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI20ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI20ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI20ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI20Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory21Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI20ButtonMessage.class, StoryGUI20ButtonMessage::buffer, StoryGUI20ButtonMessage::new, StoryGUI20ButtonMessage::handler);
	}
}
