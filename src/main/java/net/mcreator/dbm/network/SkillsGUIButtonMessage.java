...
import net.mcreator.dbm.procedures.UpgradeSkillsProcedure;
import net.mcreator.dbm.procedures.SetSkillPotentialReleaseProcedure;
import net.mcreator.dbm.procedures.SetSkillKiSenseProcedure;
import net.mcreator.dbm.procedures.SetSkillJumpProcedure;
import net.mcreator.dbm.procedures.SetSkillFlyProcedure;
...
public class SkillsGUIButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 15) {
			...
			SetSkillJumpProcedure.execute(entity);
		}
		if (buttonID == 16) {

			SetSkillFlyProcedure.execute(entity);
		}
		if (buttonID == 17) {

			SetSkillPotentialReleaseProcedure.execute(entity);
		}
		if (buttonID == 18) {

			UpgradeSkillsProcedure.execute(entity);
		}
		if (buttonID == 19) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(SkillsGUIButtonMessage.class, SkillsGUIButtonMessage::buffer, SkillsGUIButtonMessage::new, SkillsGUIButtonMessage::handler);
	}
}
