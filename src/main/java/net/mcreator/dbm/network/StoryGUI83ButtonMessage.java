...
import net.mcreator.dbm.procedures.SpawnFriezaSoldier3Procedure;
import net.mcreator.dbm.procedures.SetStory84Procedure;
...
public class StoryGUI83ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI83ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI83ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI83ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI83ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI83Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory84Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnFriezaSoldier3Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI83ButtonMessage.class, StoryGUI83ButtonMessage::buffer, StoryGUI83ButtonMessage::new, StoryGUI83ButtonMessage::handler);
	}
}
