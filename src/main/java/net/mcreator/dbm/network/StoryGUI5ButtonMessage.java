...
import net.mcreator.dbm.procedures.SetStory6Procedure;
...
public class StoryGUI5ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI5ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI5ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI5ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI5ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI5Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory6Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI5ButtonMessage.class, StoryGUI5ButtonMessage::buffer, StoryGUI5ButtonMessage::new, StoryGUI5ButtonMessage::handler);
	}
}
