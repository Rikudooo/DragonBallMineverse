...
import net.mcreator.dbm.procedures.SetStory28Procedure;
...
public class StoryGUI27ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI27ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI27ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI27ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI27ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI27Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory28Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI27ButtonMessage.class, StoryGUI27ButtonMessage::buffer, StoryGUI27ButtonMessage::new, StoryGUI27ButtonMessage::handler);
	}
}
