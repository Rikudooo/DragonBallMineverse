...
import net.mcreator.dbm.procedures.SpawnShisamiProcedure;
import net.mcreator.dbm.procedures.SetStory85Procedure;
...
public class StoryGUI84ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI84ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI84ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI84ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI84ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI84Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory85Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnShisamiProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI84ButtonMessage.class, StoryGUI84ButtonMessage::buffer, StoryGUI84ButtonMessage::new, StoryGUI84ButtonMessage::handler);
	}
}
