...
import net.mcreator.dbm.procedures.SetStory56Procedure;
...
public class StoryGUI55ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI55ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI55ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI55ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI55ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI55Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory56Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI55ButtonMessage.class, StoryGUI55ButtonMessage::buffer, StoryGUI55ButtonMessage::new, StoryGUI55ButtonMessage::handler);
	}
}
