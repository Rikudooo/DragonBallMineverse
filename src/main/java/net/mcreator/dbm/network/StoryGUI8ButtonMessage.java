...
import net.mcreator.dbm.procedures.SpawnSaibamansProcedure;
import net.mcreator.dbm.procedures.SetStory9Procedure;
...
public class StoryGUI8ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI8ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI8ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI8ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI8ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI8Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory9Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnSaibamansProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI8ButtonMessage.class, StoryGUI8ButtonMessage::buffer, StoryGUI8ButtonMessage::new, StoryGUI8ButtonMessage::handler);
	}
}
