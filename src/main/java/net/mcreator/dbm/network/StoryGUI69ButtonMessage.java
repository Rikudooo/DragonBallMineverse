...
import net.mcreator.dbm.procedures.SetStory70Procedure;
...
public class StoryGUI69ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI69ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI69ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI69ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI69ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI69Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory70Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI69ButtonMessage.class, StoryGUI69ButtonMessage::buffer, StoryGUI69ButtonMessage::new, StoryGUI69ButtonMessage::handler);
	}
}
