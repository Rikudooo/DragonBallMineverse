...
import net.mcreator.dbm.procedures.SetStory65Procedure;
...
public class StoryGUI64ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI64ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI64ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI64ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI64ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI64Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory65Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI64ButtonMessage.class, StoryGUI64ButtonMessage::buffer, StoryGUI64ButtonMessage::new, StoryGUI64ButtonMessage::handler);
	}
}
