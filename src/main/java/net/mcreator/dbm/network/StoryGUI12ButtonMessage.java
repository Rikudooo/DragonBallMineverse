...
import net.mcreator.dbm.procedures.SetStory13Procedure;
...
public class StoryGUI12ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI12ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI12ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI12ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI12ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI12Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory13Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI12ButtonMessage.class, StoryGUI12ButtonMessage::buffer, StoryGUI12ButtonMessage::new, StoryGUI12ButtonMessage::handler);
	}
}
