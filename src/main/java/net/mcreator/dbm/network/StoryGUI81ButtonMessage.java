...
public class StoryGUI81ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI81ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI81ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI81ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI81ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI81Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI81ButtonMessage.class, StoryGUI81ButtonMessage::buffer, StoryGUI81ButtonMessage::new, StoryGUI81ButtonMessage::handler);
	}
}
