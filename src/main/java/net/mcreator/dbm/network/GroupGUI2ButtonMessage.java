...
public class GroupGUI2ButtonMessage {
	private final int buttonID, x, y, z;

	public GroupGUI2ButtonMessage(FriendlyByteBuf buffer) {
	...
	public GroupGUI2ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(GroupGUI2ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(GroupGUI2ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = GroupGUI2Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(GroupGUI2ButtonMessage.class, GroupGUI2ButtonMessage::buffer, GroupGUI2ButtonMessage::new, GroupGUI2ButtonMessage::handler);
	}
}
