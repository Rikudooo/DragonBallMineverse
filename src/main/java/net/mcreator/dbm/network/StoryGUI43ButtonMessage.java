...
import net.mcreator.dbm.procedures.SpawnPerfectCellProcedure;
import net.mcreator.dbm.procedures.SetStory44Procedure;
...
public class StoryGUI43ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI43ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI43ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI43ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI43ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI43Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory44Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnPerfectCellProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI43ButtonMessage.class, StoryGUI43ButtonMessage::buffer, StoryGUI43ButtonMessage::new, StoryGUI43ButtonMessage::handler);
	}
}
