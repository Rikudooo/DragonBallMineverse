...
import net.mcreator.dbm.procedures.SetStory50Procedure;
...
public class StoryGUI49ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI49ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI49ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI49ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI49ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI49Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory50Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI49ButtonMessage.class, StoryGUI49ButtonMessage::buffer, StoryGUI49ButtonMessage::new, StoryGUI49ButtonMessage::handler);
	}
}
