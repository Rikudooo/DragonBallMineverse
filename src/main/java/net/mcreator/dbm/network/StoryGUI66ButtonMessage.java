...
import net.mcreator.dbm.procedures.SetStory67Procedure;
...
public class StoryGUI66ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI66ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI66ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI66ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI66ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI66Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory67Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI66ButtonMessage.class, StoryGUI66ButtonMessage::buffer, StoryGUI66ButtonMessage::new, StoryGUI66ButtonMessage::handler);
	}
}
