...
import net.mcreator.dbm.procedures.SetStory22Procedure;
...
public class StoryGUI21ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI21ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI21ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI21ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI21ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI21Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory22Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI21ButtonMessage.class, StoryGUI21ButtonMessage::buffer, StoryGUI21ButtonMessage::new, StoryGUI21ButtonMessage::handler);
	}
}
