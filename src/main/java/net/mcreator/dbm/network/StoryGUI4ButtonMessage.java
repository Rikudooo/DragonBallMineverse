...
import net.mcreator.dbm.procedures.SetStory5Procedure;
...
public class StoryGUI4ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI4ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI4ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI4ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI4ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI4Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory5Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI4ButtonMessage.class, StoryGUI4ButtonMessage::buffer, StoryGUI4ButtonMessage::new, StoryGUI4ButtonMessage::handler);
	}
}
