...
import net.mcreator.dbm.procedures.SetStory74Procedure;
...
public class StoryGUI73ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI73ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI73ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI73ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI73ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI73Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory74Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI73ButtonMessage.class, StoryGUI73ButtonMessage::buffer, StoryGUI73ButtonMessage::new, StoryGUI73ButtonMessage::handler);
	}
}
