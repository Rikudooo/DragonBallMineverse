...
import net.mcreator.dbm.procedures.SetStory89Procedure;
...
public class StoryGUI88ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI88ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI88ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI88ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI88ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI88Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory89Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI88ButtonMessage.class, StoryGUI88ButtonMessage::buffer, StoryGUI88ButtonMessage::new, StoryGUI88ButtonMessage::handler);
	}
}
