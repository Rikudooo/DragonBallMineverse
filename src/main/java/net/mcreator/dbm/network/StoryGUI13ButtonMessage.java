...
import net.mcreator.dbm.procedures.SpawnFriezaSoldierProcedure;
import net.mcreator.dbm.procedures.SetStory14Procedure;
...
public class StoryGUI13ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI13ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI13ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI13ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI13ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI13Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory14Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnFriezaSoldierProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI13ButtonMessage.class, StoryGUI13ButtonMessage::buffer, StoryGUI13ButtonMessage::new, StoryGUI13ButtonMessage::handler);
	}
}
