...
import net.mcreator.dbm.procedures.SpawnSpopovichProcedure;
import net.mcreator.dbm.procedures.SetStory54Procedure;
...
public class StoryGUI53ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI53ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI53ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI53ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI53ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI53Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory54Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnSpopovichProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI53ButtonMessage.class, StoryGUI53ButtonMessage::buffer, StoryGUI53ButtonMessage::new, StoryGUI53ButtonMessage::handler);
	}
}
