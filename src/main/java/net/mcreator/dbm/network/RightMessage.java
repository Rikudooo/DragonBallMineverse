...
import net.mcreator.dbm.procedures.RightOnKeyReleasedProcedure;
...
public class RightMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 1) {
			...
			RightOnKeyReleasedProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(RightMessage.class, RightMessage::buffer, RightMessage::new, RightMessage::handler);
	}
}
