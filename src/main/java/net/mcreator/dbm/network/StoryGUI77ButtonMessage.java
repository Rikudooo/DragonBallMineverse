...
import net.mcreator.dbm.procedures.SpawnBeerus2Procedure;
import net.mcreator.dbm.procedures.SetStory78Procedure;
...
public class StoryGUI77ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI77ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI77ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI77ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI77ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI77Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory78Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnBeerus2Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI77ButtonMessage.class, StoryGUI77ButtonMessage::buffer, StoryGUI77ButtonMessage::new, StoryGUI77ButtonMessage::handler);
	}
}
