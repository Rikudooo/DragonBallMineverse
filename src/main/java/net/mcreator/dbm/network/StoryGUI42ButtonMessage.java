...
import net.mcreator.dbm.procedures.SetStory43Procedure;
...
public class StoryGUI42ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI42ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI42ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI42ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI42ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI42Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory43Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI42ButtonMessage.class, StoryGUI42ButtonMessage::buffer, StoryGUI42ButtonMessage::new, StoryGUI42ButtonMessage::handler);
	}
}
