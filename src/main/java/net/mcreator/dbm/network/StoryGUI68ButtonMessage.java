...
import net.mcreator.dbm.procedures.SetStory69Procedure;
...
public class StoryGUI68ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI68ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI68ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI68ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI68ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI68Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory69Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI68ButtonMessage.class, StoryGUI68ButtonMessage::buffer, StoryGUI68ButtonMessage::new, StoryGUI68ButtonMessage::handler);
	}
}
