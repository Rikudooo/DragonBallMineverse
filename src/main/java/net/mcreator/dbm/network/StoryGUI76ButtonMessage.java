...
import net.mcreator.dbm.procedures.SetStory77Procedure;
...
public class StoryGUI76ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI76ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI76ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI76ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI76ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI76Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory77Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI76ButtonMessage.class, StoryGUI76ButtonMessage::buffer, StoryGUI76ButtonMessage::new, StoryGUI76ButtonMessage::handler);
	}
}
