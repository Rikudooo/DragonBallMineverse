...
import net.mcreator.dbm.procedures.SetStory12Procedure;
...
public class StoryGUI11ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI11ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI11ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI11ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI11ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI11Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory12Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI11ButtonMessage.class, StoryGUI11ButtonMessage::buffer, StoryGUI11ButtonMessage::new, StoryGUI11ButtonMessage::handler);
	}
}
