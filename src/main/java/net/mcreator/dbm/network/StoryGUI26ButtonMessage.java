...
import net.mcreator.dbm.procedures.SetStory27Procedure;
...
public class StoryGUI26ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI26ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI26ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI26ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI26ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI26Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory27Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI26ButtonMessage.class, StoryGUI26ButtonMessage::buffer, StoryGUI26ButtonMessage::new, StoryGUI26ButtonMessage::handler);
	}
}
