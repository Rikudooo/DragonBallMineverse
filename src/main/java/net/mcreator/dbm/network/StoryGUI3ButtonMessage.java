...
import net.mcreator.dbm.procedures.SetStory4Procedure;
...
public class StoryGUI3ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI3ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI3ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI3ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI3ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI3Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory4Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI3ButtonMessage.class, StoryGUI3ButtonMessage::buffer, StoryGUI3ButtonMessage::new, StoryGUI3ButtonMessage::handler);
	}
}
