...
import net.mcreator.dbm.procedures.CreateGroupProcedure;
...
public class GroupGUIButtonMessage {
	private final int buttonID, x, y, z;

	public GroupGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public GroupGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(GroupGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(GroupGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = GroupGUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(GroupGUIButtonMessage.class, GroupGUIButtonMessage::buffer, GroupGUIButtonMessage::new, GroupGUIButtonMessage::handler);
	}
}
