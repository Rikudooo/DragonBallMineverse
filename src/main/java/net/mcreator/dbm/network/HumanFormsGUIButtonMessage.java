...
import net.mcreator.dbm.procedures.SetFormUnleashedPowerProcedure;
import net.mcreator.dbm.procedures.SetFormSelflessnessStateProcedure;
...
public class HumanFormsGUIButtonMessage {
	private final int buttonID, x, y, z;

	public HumanFormsGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public HumanFormsGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(HumanFormsGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(HumanFormsGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = HumanFormsGUIMenu.guistate;
		...
		if (buttonID == 18) {
			...
			SetFormUnleashedPowerProcedure.execute(entity);
		}
		if (buttonID == 19) {

			SetFormSelflessnessStateProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(HumanFormsGUIButtonMessage.class, HumanFormsGUIButtonMessage::buffer, HumanFormsGUIButtonMessage::new, HumanFormsGUIButtonMessage::handler);
	}
}
