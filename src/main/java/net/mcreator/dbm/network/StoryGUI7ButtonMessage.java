...
import net.mcreator.dbm.procedures.SetStory8Procedure;
...
public class StoryGUI7ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI7ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI7ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI7ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI7ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI7Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory8Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI7ButtonMessage.class, StoryGUI7ButtonMessage::buffer, StoryGUI7ButtonMessage::new, StoryGUI7ButtonMessage::handler);
	}
}
