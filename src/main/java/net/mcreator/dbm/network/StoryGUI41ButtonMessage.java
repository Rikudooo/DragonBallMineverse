...
import net.mcreator.dbm.procedures.SetStory42Procedure;
...
public class StoryGUI41ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI41ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI41ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI41ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI41ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI41Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory42Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI41ButtonMessage.class, StoryGUI41ButtonMessage::buffer, StoryGUI41ButtonMessage::new, StoryGUI41ButtonMessage::handler);
	}
}
