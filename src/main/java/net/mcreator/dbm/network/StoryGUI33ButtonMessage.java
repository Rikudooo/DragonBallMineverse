...
import net.mcreator.dbm.procedures.SetStory34Procedure;
...
public class StoryGUI33ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI33ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI33ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI33ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI33ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI33Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory34Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI33ButtonMessage.class, StoryGUI33ButtonMessage::buffer, StoryGUI33ButtonMessage::new, StoryGUI33ButtonMessage::handler);
	}
}
