...
import net.mcreator.dbm.procedures.SetStory48Procedure;
...
public class StoryGUI47ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI47ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI47ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI47ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI47ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI47Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory48Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI47ButtonMessage.class, StoryGUI47ButtonMessage::buffer, StoryGUI47ButtonMessage::new, StoryGUI47ButtonMessage::handler);
	}
}
