...
import net.mcreator.dbm.procedures.SetStory49Procedure;
...
public class StoryGUI48ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI48ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI48ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI48ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI48ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI48Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory49Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI48ButtonMessage.class, StoryGUI48ButtonMessage::buffer, StoryGUI48ButtonMessage::new, StoryGUI48ButtonMessage::handler);
	}
}
