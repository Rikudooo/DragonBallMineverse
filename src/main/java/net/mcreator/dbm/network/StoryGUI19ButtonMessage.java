...
import net.mcreator.dbm.procedures.SetStory20Procedure;
...
public class StoryGUI19ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI19ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI19ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI19ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI19ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI19Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory20Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI19ButtonMessage.class, StoryGUI19ButtonMessage::buffer, StoryGUI19ButtonMessage::new, StoryGUI19ButtonMessage::handler);
	}
}
