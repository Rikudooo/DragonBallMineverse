...
public class StoryGUI34ButtonMessage {
	...
	public StoryGUI34ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI34ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI34ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI34ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI34Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory35Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnCellProcedure.execute(world, x, y, z, entity);
		}
	}
