...
import net.mcreator.dbm.procedures.SpawnPuipuiProcedure;
import net.mcreator.dbm.procedures.SetStory57Procedure;
...
public class StoryGUI56ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI56ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI56ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI56ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI56ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI56Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory57Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnPuipuiProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI56ButtonMessage.class, StoryGUI56ButtonMessage::buffer, StoryGUI56ButtonMessage::new, StoryGUI56ButtonMessage::handler);
	}
}
