...
import net.mcreator.dbm.procedures.SetStory40Procedure;
...
public class StoryGUI39ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI39ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI39ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI39ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI39ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI39Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory40Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI39ButtonMessage.class, StoryGUI39ButtonMessage::buffer, StoryGUI39ButtonMessage::new, StoryGUI39ButtonMessage::handler);
	}
}
