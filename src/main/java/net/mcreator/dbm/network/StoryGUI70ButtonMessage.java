...
import net.mcreator.dbm.procedures.SetSTory71Procedure;
...
public class StoryGUI70ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI70ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI70ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI70ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI70ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI70Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetSTory71Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI70ButtonMessage.class, StoryGUI70ButtonMessage::buffer, StoryGUI70ButtonMessage::new, StoryGUI70ButtonMessage::handler);
	}
}
