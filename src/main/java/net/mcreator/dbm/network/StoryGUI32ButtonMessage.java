...
import net.mcreator.dbm.procedures.SetStory33Procedure;
...
public class StoryGUI32ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI32ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI32ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI32ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI32ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI32Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory33Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI32ButtonMessage.class, StoryGUI32ButtonMessage::buffer, StoryGUI32ButtonMessage::new, StoryGUI32ButtonMessage::handler);
	}
}
