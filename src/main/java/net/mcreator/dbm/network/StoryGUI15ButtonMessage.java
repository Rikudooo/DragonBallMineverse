...
import net.mcreator.dbm.procedures.SpawnDodoriaProcedure;
import net.mcreator.dbm.procedures.SetStory16Procedure;
...
public class StoryGUI15ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI15ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI15ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI15ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI15ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI15Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory16Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnDodoriaProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI15ButtonMessage.class, StoryGUI15ButtonMessage::buffer, StoryGUI15ButtonMessage::new, StoryGUI15ButtonMessage::handler);
	}
}
