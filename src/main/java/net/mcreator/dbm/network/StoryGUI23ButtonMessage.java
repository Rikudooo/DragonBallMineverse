...
import net.mcreator.dbm.procedures.SpawnMechaFriezaKingColdProcedure;
import net.mcreator.dbm.procedures.SetStory24Procedure;
...
public class StoryGUI23ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI23ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI23ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI23ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI23ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI23Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory24Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnMechaFriezaKingColdProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI23ButtonMessage.class, StoryGUI23ButtonMessage::buffer, StoryGUI23ButtonMessage::new, StoryGUI23ButtonMessage::handler);
	}
}
