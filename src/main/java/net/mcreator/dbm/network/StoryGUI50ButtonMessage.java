...
import net.mcreator.dbm.procedures.SetStory51Procedure;
...
public class StoryGUI50ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI50ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI50ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI50ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI50ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI50Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory51Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI50ButtonMessage.class, StoryGUI50ButtonMessage::buffer, StoryGUI50ButtonMessage::new, StoryGUI50ButtonMessage::handler);
	}
}
