...
import net.mcreator.dbm.procedures.SpawnYakonProcedure;
import net.mcreator.dbm.procedures.SetStory58Procedure;
...
public class StoryGUI57ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI57ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI57ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI57ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI57ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI57Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory58Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnYakonProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI57ButtonMessage.class, StoryGUI57ButtonMessage::buffer, StoryGUI57ButtonMessage::new, StoryGUI57ButtonMessage::handler);
	}
}
