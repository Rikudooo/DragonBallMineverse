...
import net.mcreator.dbm.procedures.SpawnBeerusProcedure;
import net.mcreator.dbm.procedures.SetStory76Procedure;
...
public class StoryGUI75ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI75ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI75ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI75ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI75ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI75Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory76Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnBeerusProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI75ButtonMessage.class, StoryGUI75ButtonMessage::buffer, StoryGUI75ButtonMessage::new, StoryGUI75ButtonMessage::handler);
	}
}
