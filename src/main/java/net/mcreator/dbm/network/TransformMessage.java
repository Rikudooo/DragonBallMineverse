...
import net.mcreator.dbm.procedures.TransformOnKeyReleasedProcedure;
import net.mcreator.dbm.procedures.TransformOnKeyPressedProcedure;
...
public class TransformMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 1) {
			...
			TransformOnKeyReleasedProcedure.execute(world, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(TransformMessage.class, TransformMessage::buffer, TransformMessage::new, TransformMessage::handler);
	}
}
