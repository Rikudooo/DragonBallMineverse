...
import net.mcreator.dbm.procedures.SpawnCellJrProcedure;
import net.mcreator.dbm.procedures.SetStory45Procedure;
...
public class StoryGUI44ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI44ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI44ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI44ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI44ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI44Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory45Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnCellJrProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI44ButtonMessage.class, StoryGUI44ButtonMessage::buffer, StoryGUI44ButtonMessage::new, StoryGUI44ButtonMessage::handler);
	}
}
