...
import net.mcreator.dbm.procedures.SetStory75Procedure;
...
public class StoryGUI74ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI74ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI74ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI74ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI74ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI74Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory75Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI74ButtonMessage.class, StoryGUI74ButtonMessage::buffer, StoryGUI74ButtonMessage::new, StoryGUI74ButtonMessage::handler);
	}
}
