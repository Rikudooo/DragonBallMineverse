...
import net.mcreator.dbm.procedures.SpawnSemiPerfectCellProcedure;
import net.mcreator.dbm.procedures.SetStory39Procedure;
...
public class StoryGUI38ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI38ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI38ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI38ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI38ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI38Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory39Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnSemiPerfectCellProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI38ButtonMessage.class, StoryGUI38ButtonMessage::buffer, StoryGUI38ButtonMessage::new, StoryGUI38ButtonMessage::handler);
	}
}
