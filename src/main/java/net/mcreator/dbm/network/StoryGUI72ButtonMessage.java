...
import net.mcreator.dbm.procedures.TeleportEarthProcedure;
import net.mcreator.dbm.procedures.SetStory73Procedure;
...
public class StoryGUI72ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI72ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI72ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI72ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI72ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI72Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory73Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			TeleportEarthProcedure.execute(world, x, y, z);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI72ButtonMessage.class, StoryGUI72ButtonMessage::buffer, StoryGUI72ButtonMessage::new, StoryGUI72ButtonMessage::handler);
	}
}
