...
import net.mcreator.dbm.procedures.SetStory30Procedure;
...
public class StoryGUI29ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI29ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI29ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI29ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI29ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI29Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory30Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI29ButtonMessage.class, StoryGUI29ButtonMessage::buffer, StoryGUI29ButtonMessage::new, StoryGUI29ButtonMessage::handler);
	}
}
