...
public class StoryGUI6ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI6ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI6ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI6ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI6ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI6Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI6ButtonMessage.class, StoryGUI6ButtonMessage::buffer, StoryGUI6ButtonMessage::new, StoryGUI6ButtonMessage::handler);
	}
}
