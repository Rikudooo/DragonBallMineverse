...
import net.mcreator.dbm.procedures.SpawnTagomaProcedure;
import net.mcreator.dbm.procedures.SetStory86Procedure;
...
public class StoryGUI85ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI85ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI85ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI85ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI85ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI85Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory86Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnTagomaProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI85ButtonMessage.class, StoryGUI85ButtonMessage::buffer, StoryGUI85ButtonMessage::new, StoryGUI85ButtonMessage::handler);
	}
}
