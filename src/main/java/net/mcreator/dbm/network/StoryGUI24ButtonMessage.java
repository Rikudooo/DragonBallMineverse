...
import net.mcreator.dbm.procedures.SetStory25Procedure;
...
public class StoryGUI24ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI24ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI24ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI24ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI24ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI24Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory25Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI24ButtonMessage.class, StoryGUI24ButtonMessage::buffer, StoryGUI24ButtonMessage::new, StoryGUI24ButtonMessage::handler);
	}
}
