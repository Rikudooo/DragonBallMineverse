...
import net.mcreator.dbm.procedures.SetStory87Procedure;
...
public class StoryGUI86ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI86ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI86ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI86ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI86ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI86Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory87Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI86ButtonMessage.class, StoryGUI86ButtonMessage::buffer, StoryGUI86ButtonMessage::new, StoryGUI86ButtonMessage::handler);
	}
}
