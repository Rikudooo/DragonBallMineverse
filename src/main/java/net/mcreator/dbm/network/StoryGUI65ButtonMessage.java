...
import net.mcreator.dbm.procedures.SpawnSuperBuuProcedure;
import net.mcreator.dbm.procedures.SetStory66Procedure;
...
public class StoryGUI65ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI65ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI65ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI65ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI65ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI65Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory66Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnSuperBuuProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI65ButtonMessage.class, StoryGUI65ButtonMessage::buffer, StoryGUI65ButtonMessage::new, StoryGUI65ButtonMessage::handler);
	}
}
