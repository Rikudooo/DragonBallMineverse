...
public class StoryGUI9ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI9ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI9ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI9ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI9ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI9Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory10Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI9ButtonMessage.class, StoryGUI9ButtonMessage::buffer, StoryGUI9ButtonMessage::new, StoryGUI9ButtonMessage::handler);
	}
}
