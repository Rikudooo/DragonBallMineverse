...
import net.mcreator.dbm.procedures.SetStory60Procedure;
...
public class StoryGUI59ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI59ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI59ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI59ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI59ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI59Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory60Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI59ButtonMessage.class, StoryGUI59ButtonMessage::buffer, StoryGUI59ButtonMessage::new, StoryGUI59ButtonMessage::handler);
	}
}
