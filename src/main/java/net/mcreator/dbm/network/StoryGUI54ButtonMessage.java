...
import net.mcreator.dbm.procedures.SetStory55Procedure;
...
public class StoryGUI54ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI54ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI54ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI54ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI54ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI54Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory55Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI54ButtonMessage.class, StoryGUI54ButtonMessage::buffer, StoryGUI54ButtonMessage::new, StoryGUI54ButtonMessage::handler);
	}
}
