...
import net.mcreator.dbm.procedures.SpawnDaburaProcedure;
import net.mcreator.dbm.procedures.SetStory59Procedure;
...
public class StoryGUI58ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI58ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI58ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI58ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI58ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI58Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory59Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnDaburaProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI58ButtonMessage.class, StoryGUI58ButtonMessage::buffer, StoryGUI58ButtonMessage::new, StoryGUI58ButtonMessage::handler);
	}
}
