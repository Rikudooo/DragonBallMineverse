...
import net.mcreator.dbm.procedures.SetStory1Procedure;
...
public class StoryGUIButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUIMenu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory1Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUIButtonMessage.class, StoryGUIButtonMessage::buffer, StoryGUIButtonMessage::new, StoryGUIButtonMessage::handler);
	}
}
