...
import net.mcreator.dbm.procedures.SpawnFriezaProcedure;
...
public class StoryGUI18ButtonMessage {
	...
	public StoryGUI18ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI18ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI18ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI18ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI18Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory19Procedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			SpawnFriezaProcedure.execute(world, x, y, z, entity);
		}
	}
