...
public class NamekianFormsGUIButtonMessage {
	private final int buttonID, x, y, z;

	public NamekianFormsGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public NamekianFormsGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(NamekianFormsGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(NamekianFormsGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = NamekianFormsGUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(NamekianFormsGUIButtonMessage.class, NamekianFormsGUIButtonMessage::buffer, NamekianFormsGUIButtonMessage::new, NamekianFormsGUIButtonMessage::handler);
	}
}
