...
public class StoryGUI79ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI79ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI79ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI79ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI79ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI79Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI79ButtonMessage.class, StoryGUI79ButtonMessage::buffer, StoryGUI79ButtonMessage::new, StoryGUI79ButtonMessage::handler);
	}
}
