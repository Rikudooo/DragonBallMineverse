...
import net.mcreator.dbm.procedures.SetStory62Procedure;
...
public class StoryGUI61ButtonMessage {
	private final int buttonID, x, y, z;

	public StoryGUI61ButtonMessage(FriendlyByteBuf buffer) {
	...
	public StoryGUI61ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(StoryGUI61ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoryGUI61ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = StoryGUI61Menu.guistate;
		...
		if (buttonID == 15) {
			...
			SetStory62Procedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DbmMod.addNetworkMessage(StoryGUI61ButtonMessage.class, StoryGUI61ButtonMessage::buffer, StoryGUI61ButtonMessage::new, StoryGUI61ButtonMessage::handler);
	}
}
