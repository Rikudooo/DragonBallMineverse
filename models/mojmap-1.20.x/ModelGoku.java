...
public class ModelGoku<T extends Entity> extends EntityModel<T> {
	...
	private final ModelPart hairsmall_R2;
	private final ModelPart hairsmall_R1;
	private final ModelPart hairsmall_L2;
	private final ModelPart hairsmall_L1;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = hairsmall_R2.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(56, 56).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F,
		...
		PartDefinition cube_r3 = hairsmall_L2.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(56, 56).mirror()
		...
		PartDefinition cube_r5 = bone.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(52, 57).addBox(1.5314F, -31.738F, 2.2404F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -2.8449F, -1.501F, -3.1416F));

		PartDefinition cube_r6 = bone.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(51, 56).addBox(1.0512F, -31.5111F, -5.1664F, 3.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = bone6.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(51, 56).mirror()
		...
		PartDefinition cube_r9 = bone2.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(52, 57).addBox(1.6904F, -29.5163F, 1.3958F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = bone2.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(51, 56).addBox(1.0512F, -29.1186F, -5.4164F, 3.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = bone5.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(52, 57).mirror()
		...
		PartDefinition cube_r12 = bone5.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(51, 56).mirror()
		...
		PartDefinition cube_r13 = bone3.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(52, 57).addBox(1.6197F, -26.9151F, 1.8127F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, -2.8449F, -1.501F, -3.1416F));

		PartDefinition cube_r14 = bone3.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(51, 56).addBox(0.9806F, -26.7702F, -4.6374F, 3.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, -3.1067F, -1.501F, 3.1416F));
		...
		PartDefinition cube_r15 = bone4.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(52, 57).mirror()
		...
		PartDefinition cube_r16 = bone4.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(51, 56).mirror()
		...
		PartDefinition cube_r17 = bone9.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(52, 54)
				.addBox(1.0966F, -4.5788F, -33.979F, 2.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(52, 54)
		...
		PartDefinition bone12 = bone9.addOrReplaceChild("bone12", CubeListBuilder.create(),
				PartPose.offsetAndRotation(1.4097F, 1.1231F, 0.0209F, 0.0F, 0.0F, 0.384F));

		PartDefinition cube_r18 = bone12.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(56, 58)
				.addBox(0.5827F, -22.9593F, -24.3735F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(54, 57)
				.addBox(0.5827F, -22.9593F, -26.1735F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(54, 57)
				.addBox(0.5827F, -22.9593F, -28.1735F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = bone12.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(50, 57).addBox(-2.173F, -27.3937F, -24.5269F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone10 = Hair.addOrReplaceChild("bone10", CubeListBuilder.create(),
				PartPose.offset(-2.3488F, -9.874F, -1.3343F));

		PartDefinition cube_r20 = bone10.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(54, 54)
				.addBox(-0.9034F, -4.5788F, -33.979F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(52, 54)
				.addBox(0.0966F, -4.5788F, -33.979F, 2.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(52, 54)
				.addBox(2.0966F, -4.5788F, -33.979F, 2.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone11 = bone10.addOrReplaceChild("bone11", CubeListBuilder.create(),
				PartPose.offsetAndRotation(1.2097F, 0.7231F, 0.0209F, 0.0F, 0.0F, -0.3142F));
		...
		PartDefinition cube_r22 = bone11.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(54, 57)
						.addBox(-1.5F, -1.0F, 0.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(54, 57)
		...
		PartDefinition cube_r23 = bone7.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(52, 55).addBox(-2.5306F, -3.6672F, -34.7427F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r24 = bone8.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(50, 57).addBox(-5.4881F, -27.0602F, -24.5531F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r25 = bone8.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(52, 56).addBox(-2.5145F, -22.5211F, -28.8072F, 2.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r26 = bone13.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(53, 55)
				.addBox(-2.5534F, -6.4788F, -32.979F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(53, 55)
				.addBox(-1.9034F, -6.4788F, -32.979F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(53, 55)
				.addBox(0.0966F, -6.4788F, -32.979F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(53, 55)
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(40, 16)
				.addBox(-7.0F, -2.0608F, -2.6946F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.0F, 2.0F, 0.75F));
