...
public class ModelDende<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "dende"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body_r1 = Body
				.addOrReplaceChild("Body_r1",
						CubeListBuilder.create().texOffs(11, 35).addBox(-4.5F, -1.0F, -4.5F, 9.0F, 2.0F, 9.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.25F, 0.0F, 0.1309F, 0.0F, 0.0F));
