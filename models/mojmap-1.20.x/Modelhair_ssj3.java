...
public class Modelhair_ssj3<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r139 = Back.addOrReplaceChild("cube_r139", CubeListBuilder.create().texOffs(48, 55)
		...
		PartDefinition cube_r140 = Back.addOrReplaceChild("cube_r140", CubeListBuilder.create().texOffs(48, 55)
		...
		PartDefinition cube_r141 = Back.addOrReplaceChild("cube_r141", CubeListBuilder.create().texOffs(48, 55)
		...
		PartDefinition cube_r148 = Back.addOrReplaceChild("cube_r148", CubeListBuilder.create().texOffs(48, 55)
		...
		PartDefinition cube_r160 = Back.addOrReplaceChild("cube_r160", CubeListBuilder.create().texOffs(48, 55)
				.addBox(-3.1502F, -4.0942F, 4.0108F, 2.9F, 2.9F, 4.0F, new CubeDeformation(0.0F)).texOffs(48, 55)
				.addBox(-3.1502F, -4.0942F, 1.0108F, 2.9F, 2.9F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.9854F, 4.3626F, -6.8264F, -1.701F, -0.0246F, 0.223F));

		PartDefinition cube_r161 = Back.addOrReplaceChild("cube_r161", CubeListBuilder.create().texOffs(48, 55)
