...
public class ModelShenron119<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 25)
				.addBox(-3.9643F, -7.05F, -7.9643F, 8.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(33, 36)
				.addBox(-3.9643F, -0.05F, -6.9643F, 8.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(0, 40)
				.addBox(-2.9643F, -3.05F, -15.9643F, 6.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(17, 17)
				.addBox(-7.9643F, -3.05F, -14.9643F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(11, 15)
				.addBox(-15.9643F, -5.7F, -14.9643F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(13, 14)
				.addBox(3.0357F, -3.05F, -14.9643F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(16, 14)
		...
		PartDefinition cube_r1 = TopPart.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(12, 12)
				.addBox(-20.4674F, -5.9469F, 1.5633F, 8.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(12, 12)
				.addBox(-27.4674F, -6.6969F, 1.5633F, 8.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(81.0F, -191.0F, -2.0F, 0.3927F, -0.3491F, -0.5236F));

		PartDefinition cube_r2 = TopPart.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(12, 11)
				.addBox(17.0826F, -5.5719F, 2.7883F, 8.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(12, 11)
				.addBox(9.5826F, -5.5719F, 3.7883F, 8.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
