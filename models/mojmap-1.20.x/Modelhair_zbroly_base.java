...
public class Modelhair_zbroly_base<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "hair_zbroly_base"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Top_r3 = Top.addOrReplaceChild("Top_r3",
		...
		PartDefinition Back = Hair.addOrReplaceChild("Back", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.1167F, -23.9912F, 6.3554F, 0.4363F, 0.0F, 0.0F));
		...
		PartDefinition cube_r38 = Back.addOrReplaceChild("cube_r38",
				CubeListBuilder.create().texOffs(51, 53).addBox(-2.2385F, -1.6687F, 0.9341F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
