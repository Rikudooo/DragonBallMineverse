...
public class ModelVegetaSaiyanSaga<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "vegetasaiyansaga"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0).addBox(
				-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -4.0F, 0.0F));

		PartDefinition Hair = Head.addOrReplaceChild("Hair", CubeListBuilder.create().texOffs(0, 38)
				.addBox(-0.8596F, -4.706F, -2.0361F, 4.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(4, 45)
				.addBox(-1.9846F, -2.706F, -2.6611F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 45)
				.addBox(-1.9846F, -1.206F, 0.3389F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 45)
				.addBox(-0.9846F, -0.706F, -0.4111F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 45)
				.addBox(-0.4846F, 0.294F, 0.5889F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 45)
				.addBox(-1.2346F, 0.044F, 1.0889F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 45)
				.addBox(-1.2346F, -0.206F, 0.0889F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 45)
				.addBox(-2.8596F, -2.1435F, -1.5361F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 45)
				.addBox(-2.2346F, -1.456F, -0.6611F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 45)
				.addBox(-3.4846F, -0.8935F, -0.6611F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 45)
				.addBox(-2.9221F, -1.2685F, 0.0889F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 45)
				.addBox(-2.9221F, -0.7685F, 1.3389F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 45)
				.addBox(-3.9221F, -0.2685F, -0.4111F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 45)
				.addBox(-3.9221F, 0.2315F, 0.3389F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r1 = Hair.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(4, 45).addBox(-0.7123F, -2.5895F, -0.6722F, 3.0F, 5.0F, 2.0F,
		...
		PartDefinition cube_r2 = Hair.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 38).addBox(-0.4892F, -4.9037F, -0.4871F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = Hair.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 38)
						.addBox(1.3233F, -4.9037F, -0.4871F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 38)
		...
		PartDefinition cube_r18 = Hair.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(4, 45).addBox(-0.7123F, -3.4645F, -0.6722F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r22 = Hair.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(4, 45).addBox(-0.7123F, -4.3395F, -0.6722F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r26 = Hair.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(4, 45).addBox(-0.7123F, -2.5895F, -1.9847F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r27 = Hair.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(0, 38).addBox(-0.4892F, -4.9037F, -1.7996F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r36 = Hair.addOrReplaceChild("cube_r36",
				CubeListBuilder.create().texOffs(0, 38).addBox(-0.375F, -3.75F, -0.375F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r39 = Hair.addOrReplaceChild("cube_r39",
				CubeListBuilder.create().texOffs(0, 38).addBox(-0.1875F, -2.25F, 0.4375F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r40 = Hair.addOrReplaceChild("cube_r40",
				CubeListBuilder.create().texOffs(0, 38).addBox(-0.3611F, -3.422F, -0.3835F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r41 = Hair.addOrReplaceChild("cube_r41",
				CubeListBuilder.create().texOffs(4, 45).addBox(-1.75F, -2.5F, -0.4375F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r42 = Hair.addOrReplaceChild("cube_r42",
				CubeListBuilder.create().texOffs(0, 38).addBox(-1.6198F, -5.5851F, -2.5908F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r55 = Hair.addOrReplaceChild("cube_r55",
				CubeListBuilder.create().texOffs(0, 38).addBox(-0.4892F, -3.9037F, -1.7996F, 3.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r60 = Hair.addOrReplaceChild("cube_r60", CubeListBuilder.create().texOffs(0, 38)
				.addBox(-0.4892F, -4.9037F, -1.7996F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 38)
				.addBox(-0.4892F, -4.9037F, -0.4871F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.7277F, 1.321F, -0.7389F, -2.9004F, -0.2929F, -3.1062F));

		PartDefinition cube_r61 = Hair.addOrReplaceChild("cube_r61", CubeListBuilder.create().texOffs(4, 45)
				.addBox(-0.7123F, -2.5895F, -1.9847F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 45)
		...
		PartDefinition cube_r71 = Hair.addOrReplaceChild("cube_r71",
				CubeListBuilder.create().texOffs(4, 45).addBox(-0.7123F, -3.3395F, -0.6722F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r83 = Hair.addOrReplaceChild("cube_r83",
				CubeListBuilder.create().texOffs(4, 45).addBox(-0.8434F, -1.1078F, -0.772F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r86 = Hair.addOrReplaceChild("cube_r86",
				CubeListBuilder.create().texOffs(4, 45).addBox(1.2816F, -1.1078F, -0.772F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r97 = Hair.addOrReplaceChild("cube_r97",
				CubeListBuilder.create().texOffs(-3, 42).addBox(-2.1875F, -2.75F, -0.7188F, 5.0F, 7.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(16, 16)
						...
						.addBox(-4.0F, 7.875F, -2.0F, 8.0F, 1.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(40, 16)
						.addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(38, 37)
						.addBox(-7.25F, -2.0F, -2.0F, 8.0F, 2.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(-5.0F, 2.0F, 0.0F));

		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(32, 48)
						.addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(38, 37)
						.addBox(-0.75F, -2.0F, -2.0F, 8.0F, 2.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(5.0F, 2.0F, 0.0F));

		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(0, 16)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(46, 0)
