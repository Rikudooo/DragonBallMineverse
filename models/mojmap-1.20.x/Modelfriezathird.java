...
public class Modelfriezathird<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "friezathird"), "main");
	...
	private final ModelPart LargeHead;
	private final ModelPart LargeHead2;
	...
	private final ModelPart ArmThingy;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone9 = Horns.addOrReplaceChild("bone9", CubeListBuilder.create(),
				PartPose.offset(0.2F, 0.1F, 0.0F));

		PartDefinition Horn_r1 = bone9.addOrReplaceChild("Horn_r1",
				CubeListBuilder.create().texOffs(25, 27).mirror()
						.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(4.5648F, -31.9884F, 0.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition Horn_r2 = bone9.addOrReplaceChild("Horn_r2",
				CubeListBuilder.create().texOffs(23, 27).mirror()
						.addBox(15.0F, -28.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition bone8 = Horns.addOrReplaceChild("bone8", CubeListBuilder.create(),
				PartPose.offset(-0.2F, 0.1F, 0.0F));

		PartDefinition Horn_r3 = bone8.addOrReplaceChild("Horn_r3",
				CubeListBuilder.create().texOffs(25, 27).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.5648F, -31.9884F, 0.0F, 0.0F, 0.0F, 1.5708F));

		PartDefinition Horn_r4 = bone8
				.addOrReplaceChild("Horn_r4",
						CubeListBuilder.create().texOffs(23, 27).addBox(-17.0F, -28.5F, -1.0F, 2.0F, 2.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition bone3 = Horns.addOrReplaceChild("bone3", CubeListBuilder.create(),
				PartPose.offset(-0.2F, 1.1F, 7.0F));

		PartDefinition Horn_r5 = bone3.addOrReplaceChild("Horn_r5",
				CubeListBuilder.create().texOffs(23, 27).addBox(-1.5F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.7361F, -33.387F, 1.3536F, 1.5708F, 0.7854F, 1.9635F));

		PartDefinition Horn_r6 = bone3
				.addOrReplaceChild("Horn_r6",
						CubeListBuilder.create().texOffs(23, 27).addBox(-20.0F, -28.5F, -1.0F, 5.0F, 2.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition bone4 = Horns.addOrReplaceChild("bone4", CubeListBuilder.create(),
				PartPose.offset(0.2F, 1.1F, 7.0F));

		PartDefinition Horn_r7 = bone4.addOrReplaceChild("Horn_r7",
				CubeListBuilder.create().texOffs(23, 27).mirror()
						.addBox(-1.5F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(6.7361F, -33.387F, 1.3536F, 1.5708F, -0.7854F, -1.9635F));

		PartDefinition Horn_r8 = bone4.addOrReplaceChild("Horn_r8",
				CubeListBuilder.create().texOffs(23, 27).mirror()
						.addBox(15.0F, -28.5F, -1.0F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition LargeHead = Head.addOrReplaceChild("LargeHead", CubeListBuilder.create(),
		...
		PartDefinition LargeHead2 = LargeHead.addOrReplaceChild("LargeHead2",
				CubeListBuilder.create().texOffs(16, 7)
						.addBox(-5.0F, -28.0F, 8.0F, 1.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-5.0F, -31.0F, 8.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-4.0F, -30.0F, 8.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-4.0F, -27.0F, 8.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-4.0F, -27.0F, 4.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-4.0F, -30.0F, 4.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-3.0F, -30.0F, 4.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-2.0F, -28.0F, 4.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-1.0F, -28.0F, 4.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-2.0F, -28.0F, 8.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-1.0F, -28.0F, 8.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-3.0F, -27.0F, 4.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-3.0F, -30.0F, 8.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-3.0F, -27.0F, 8.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-5.0F, -31.0F, 4.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-2.0F, -31.0F, 4.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(-4, 44)
						.addBox(-4.0F, -31.0F, 4.0F, 2.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(-4, 44)
						.addBox(-3.0F, -32.0F, 4.0F, 2.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(-4, 44)
						.addBox(-5.0F, -32.0F, 4.0F, 2.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-1.0F, -31.0F, 4.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-2.0F, -31.0F, 8.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-1.0F, -31.0F, 8.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-1.0F, -32.0F, 8.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-1.0F, -32.0F, 4.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-2.0F, -27.0F, 4.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-1.0F, -27.0F, 4.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-2.0F, -27.0F, 8.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-1.0F, -27.0F, 8.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
		...
		PartDefinition bone5 = LargeHead.addOrReplaceChild("bone5",
				CubeListBuilder.create().texOffs(16, 7)
						.addBox(-5.0F, -28.0F, 8.0F, 1.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-5.0F, -32.0F, 8.0F, 1.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-5.0F, -32.0F, 4.0F, 1.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 7)
						.addBox(-5.0F, -28.0F, 4.0F, 1.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition ArmThingy = Body.addOrReplaceChild("ArmThingy",
				CubeListBuilder.create().texOffs(19, 10)
						.addBox(4.0F, -25.0F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(19, 10)
						.addBox(-6.0F, -25.0F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(19, 10)
						.addBox(6.0F, -25.0F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(19, 10)
						.addBox(8.0F, -25.0F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(19, 10)
						.addBox(10.0F, -25.0F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(19, 10)
						.addBox(-8.0F, -25.0F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(19, 10)
						.addBox(-10.0F, -25.0F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(19, 10)
						.addBox(-12.0F, -25.0F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
