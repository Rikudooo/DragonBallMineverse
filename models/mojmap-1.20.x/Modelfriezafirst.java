...
public class Modelfriezafirst<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "friezafirst"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Horn_r2 = Head
				.addOrReplaceChild("Horn_r2",
		...
		PartDefinition ShoulderPadLeft = Body.addOrReplaceChild("ShoulderPadLeft", CubeListBuilder.create()
				.texOffs(0, 32).addBox(4.0F, -25.0F, -2.0F, 6.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition shoulderpad_r1 = ShoulderPadLeft.addOrReplaceChild("shoulderpad_r1",
				CubeListBuilder.create().texOffs(0, 62).mirror()
						.addBox(-3.0F, 0.0F, 0.0F, 6.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition bone = Tail4.addOrReplaceChild("bone", CubeListBuilder.create(),
				PartPose.offset(0.0F, -5.075F, -9.1F));

		PartDefinition cube_r13 = bone.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(9, 2).addBox(-1.0F, 0.0F, -1.0F, 1.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r15 = bone.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(9, 2)
						.addBox(-1.0F, 0.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(9, 2)
						.addBox(-0.05F, 0.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition ShoulderPadRight = Body.addOrReplaceChild("ShoulderPadRight",
				CubeListBuilder.create().texOffs(0, 32).mirror()
						.addBox(4.0F, -25.0F, -2.0F, 6.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(-14.0F, 24.0F, 0.0F));

		PartDefinition shoulderpad_r3 = ShoulderPadRight.addOrReplaceChild("shoulderpad_r3",
				CubeListBuilder.create().texOffs(0, 62).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 2.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.0F, -24.0F, 2.0F, 0.0175F, 0.0F, 0.0F));
