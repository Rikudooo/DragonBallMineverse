...
public class Modelhair_t_base<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "hair_t_base"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hairsmall_R4 = Bangs2.addOrReplaceChild("hairsmall_R4", CubeListBuilder.create(),
				PartPose.offset(-1.0F, -8.0F, -3.0F));

		PartDefinition cube_r10 = hairsmall_R4.addOrReplaceChild("cube_r10",
		...
		PartDefinition hairsmall_R3 = Bangs2.addOrReplaceChild("hairsmall_R3", CubeListBuilder.create(),
				PartPose.offset(-3.0F, -8.0F, -3.0F));

		PartDefinition cube_r15 = hairsmall_R3.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(56, 59).addBox(-1.0F, -0.25F, -1.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3655F, 0.147F, 0.3655F));

		PartDefinition hairsmall_L4 = Bangs2.addOrReplaceChild("hairsmall_L4", CubeListBuilder.create(),
				PartPose.offset(3.0F, -8.0F, -3.0F));

		PartDefinition cube_r16 = hairsmall_L4.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(56, 59).mirror()
						.addBox(-1.0F, -0.325F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3655F, -0.147F, -0.3655F));

		PartDefinition hairsmall_L3 = Bangs2.addOrReplaceChild("hairsmall_L3", CubeListBuilder.create(),
				PartPose.offset(1.0F, -8.0F, -3.0F));

		PartDefinition cube_r22 = hairsmall_L3.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(56, 59).mirror()
