...
public class Modelhair_zamasu_ssj2<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "hair_zamasu_ssj2"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r6 = hair.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(54, 57).addBox(-0.2296F, -3.0394F, -0.6619F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone2 = hair.addOrReplaceChild("bone2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-3.6828F, -0.1567F, -6.9174F, 3.1416F, -0.7854F, 0.0F));
