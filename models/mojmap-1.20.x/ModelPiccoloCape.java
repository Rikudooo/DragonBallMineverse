...
public class ModelPiccoloCape<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "piccolocape"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition piccolocape = Body.addOrReplaceChild("piccolocape",
				CubeListBuilder.create().texOffs(96, 39)
						.addBox(-5.0F, -24.5F, 3.0F, 10.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(74, 21)
						.addBox(-10.0F, -24.5F, -3.0F, 7.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(74, 21)
						.addBox(3.0F, -24.5F, -3.0F, 7.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(79, 26)
						.addBox(-4.0F, -24.5F, 2.0F, 8.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(79, 26)
						.addBox(-4.0F, -24.5F, -3.0F, 8.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(103, 31)
						.addBox(-4.0F, -24.625F, -4.25F, 8.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(103, 31)
						.addBox(3.9F, -24.625F, -4.25F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(104, 32)
						.addBox(-4.975F, -24.625F, 4.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(104, 32)
						.addBox(-5.0F, -24.625F, 4.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(103, 31)
						.addBox(-2.0F, -22.75F, -4.25F, 4.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(87, 40)
						.addBox(-9.0F, -23.5F, -3.0F, 18.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(99, 35)
						.addBox(-5.0F, -22.5F, -3.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(99, 35)
						.addBox(-3.0F, -21.5F, -3.0F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(99, 35)
						.addBox(-2.0F, -20.5F, -3.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition Body_r1 = piccolocape.addOrReplaceChild("Body_r1",
				CubeListBuilder.create().texOffs(75, 43).addBox(-9.0F, 0.5F, 0.0F, 18.0F, 21.0F, 0.0F,
		...
		PartDefinition Body_r2 = piccolocape.addOrReplaceChild("Body_r2",
				CubeListBuilder.create().texOffs(104, 32)
						.addBox(-1.5F, -1.225F, 4.0F, 9.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(104, 32)
						.addBox(-1.5F, -1.225F, -5.025F, 9.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition turban = Head.addOrReplaceChild("turban",
				CubeListBuilder.create().texOffs(50, 8)
						.addBox(-4.1F, -9.0F, -4.2F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(34, 1)
						.addBox(1.1F, -9.0F, -4.2F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(34, 1)
						.addBox(1.1F, -9.0F, 0.175F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(36, 9)
						.addBox(-1.5F, -8.0F, -4.2F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(38, 11)
						...
						.addBox(-1.5F, -8.0F, 0.175F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(53, 11)
						.addBox(-4.1F, -9.0F, -0.2F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(53, 11)
						.addBox(1.1F, -9.0F, -0.35F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(50, 8)
						.addBox(-4.1F, -9.0F, 0.175F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
