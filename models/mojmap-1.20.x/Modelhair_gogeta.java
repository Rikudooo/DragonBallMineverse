...
public class Modelhair_gogeta<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "hair_gogeta"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bunch_r1 = bunch.addOrReplaceChild("bunch_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-1.0297F, -2.4679F, -1.1965F, 1.8018F, 2.375F, 1.8018F,
		...
		PartDefinition bunch_r2 = bunch.addOrReplaceChild("bunch_r2",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.6802F, -0.7769F, -1.2595F, 1.8018F, 1.7F, 1.8018F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch_r3 = bunch.addOrReplaceChild("bunch_r3",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.5983F, -0.3999F, -1.5815F, 2.002F, 3.0F, 2.002F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4931F, -2.7075F, 1.5815F, 0.0F, 0.0F, -0.0654F));

		PartDefinition bunch8 = Left.addOrReplaceChild("bunch8",
				CubeListBuilder.create().texOffs(53, 58).addBox(-1.8018F, -0.87F, -0.9009F, 1.8018F, 1.8F, 1.8018F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch8_r1 = bunch8.addOrReplaceChild("bunch8_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-2.2973F, -1.81F, -0.8108F, 2.2973F, 1.62F, 1.6216F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.8018F, 1.03F, 0.0F, 0.0F, 0.0F, 0.48F));

		PartDefinition bunch9 = Left.addOrReplaceChild("bunch9",
				CubeListBuilder.create().texOffs(53, 58).addBox(-2.8028F, -0.872F, -0.9009F, 2.8028F, 1.8F, 1.8018F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch9_r1 = bunch9.addOrReplaceChild("bunch9_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-2.973F, -1.81F, -0.8108F, 2.973F, 1.62F, 1.6216F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.8028F, 1.028F, 0.0F, 0.0F, 0.0F, 0.5236F));

		PartDefinition bunch10 = Left.addOrReplaceChild("bunch10",
				CubeListBuilder.create().texOffs(53, 58).addBox(-2.8028F, -0.874F, -0.9009F, 2.8028F, 1.8F, 1.8018F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch10_r1 = bunch10.addOrReplaceChild("bunch10_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-2.4224F, -1.81F, -0.8108F, 2.4224F, 1.62F, 1.6216F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch11_r1 = bunch11.addOrReplaceChild("bunch11_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.5005F, -1.3F, -0.8008F, 1.6016F, 2.6F, 1.6016F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch11_r2 = bunch11.addOrReplaceChild("bunch11_r2",
				CubeListBuilder.create().texOffs(53, 58).addBox(-1.001F, -0.3408F, -1.2119F, 2.002F, 3.0F, 2.002F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch15 = Left.addOrReplaceChild("bunch15",
				CubeListBuilder.create().texOffs(53, 58).addBox(-1.001F, -2.968F, -1.001F, 2.002F, 3.0F, 2.002F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch15_r1 = bunch15.addOrReplaceChild("bunch15_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -2.825F, 0.2002F, 1.6016F, 2.825F, 1.6016F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch17_r1 = bunch17.addOrReplaceChild("bunch17_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -6.4F, -0.4254F, 1.6016F, 2.4F, 2.2272F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch17_r2 = bunch17.addOrReplaceChild("bunch17_r2",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -1.625F, -0.5756F, 1.6016F, 1.625F, 1.6016F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.968F, -1.001F, -0.3927F, 0.0F, 0.0F));
		...
		PartDefinition bunch18_r1 = bunch18.addOrReplaceChild("bunch18_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-2.6476F, -1.81F, -0.8108F, 2.6476F, 1.62F, 1.6216F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch19_r1 = bunch19.addOrReplaceChild("bunch19_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-3.1481F, -1.81F, -0.8108F, 3.1481F, 1.62F, 1.6216F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.8028F, 1.028F, 0.0F, 0.0F, 0.0F, 0.829F));

		PartDefinition bunch20 = Left.addOrReplaceChild("bunch20",
				CubeListBuilder.create().texOffs(53, 58).addBox(-2.8028F, -0.871F, -0.9009F, 2.8028F, 1.8F, 1.8018F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch20_r1 = bunch20.addOrReplaceChild("bunch20_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-3.2983F, -1.81F, -0.8108F, 3.2983F, 1.62F, 1.6216F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.8028F, 1.029F, 0.0F, 0.0F, 0.0F, 0.6545F));

		PartDefinition bunch31 = Left.addOrReplaceChild("bunch31",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.9009F, -0.874F, 0.2002F, 1.8018F, 1.8F, 2.7027F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch31_r1 = bunch31.addOrReplaceChild("bunch31_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8108F, 0.19F, 0.0F, 1.6216F, 1.62F, 1.4314F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.974F, 2.9029F, -0.5672F, 0.0F, 0.0F));

		PartDefinition bunch32 = Left.addOrReplaceChild("bunch32",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.9009F, -0.872F, 0.2002F, 1.8018F, 1.8F, 2.7027F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch38 = Left.addOrReplaceChild("bunch38",
				CubeListBuilder.create().texOffs(53, 58).addBox(-1.001F, -2.969F, -1.001F, 2.002F, 3.0F, 2.002F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch38_r1 = bunch38.addOrReplaceChild("bunch38_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -2.225F, 0.2002F, 1.6016F, 2.225F, 1.6016F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch40_r1 = bunch40.addOrReplaceChild("bunch40_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-2.4474F, -1.81F, -0.8108F, 2.4474F, 1.62F, 1.6216F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch41_r1 = bunch41.addOrReplaceChild("bunch41_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -1.4F, 0.2002F, 1.6016F, 1.4F, 1.6016F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch46 = Left.addOrReplaceChild("bunch46",
				CubeListBuilder.create().texOffs(53, 58).addBox(-1.001F, -2.974F, -1.001F, 2.002F, 3.0F, 2.002F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch46_r1 = bunch46.addOrReplaceChild("bunch46_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -2.0527F, 0.2306F, 1.6016F, 2.4F, 1.6016F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.974F, -1.001F, -0.2618F, 0.0F, 0.0F));

		PartDefinition bunch48 = Left.addOrReplaceChild("bunch48",
				CubeListBuilder.create().texOffs(53, 58).addBox(-1.001F, -2.97F, -1.001F, 2.002F, 3.0F, 2.002F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch48_r1 = bunch48.addOrReplaceChild("bunch48_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -2.025F, 0.2002F, 1.6016F, 2.025F, 1.6016F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch2 = Right.addOrReplaceChild("bunch2",
				CubeListBuilder.create().texOffs(53, 58).addBox(-1.001F, -1.97F, -1.001F, 2.002F, 2.0F, 2.002F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch2_r1 = bunch2.addOrReplaceChild("bunch2_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.9009F, -3.55F, 0.1001F, 1.8018F, 3.55F, 1.8018F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.97F, -1.001F, -0.48F, 0.0F, 0.0F));

		PartDefinition bunch6 = Right.addOrReplaceChild("bunch6",
				CubeListBuilder.create().texOffs(53, 58).addBox(-1.001F, -1.97F, 0.0F, 2.002F, 2.0F, 2.002F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch6_r1 = bunch6.addOrReplaceChild("bunch6_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.9009F, -2.45F, 0.1001F, 1.8018F, 2.45F, 1.8018F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch6_r2 = bunch6.addOrReplaceChild("bunch6_r2",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.9009F, -1.7F, 0.1001F, 1.8018F, 1.7F, 1.8018F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.97F, 0.0F, -0.3927F, 0.0F, 0.0F));

		PartDefinition bunch7 = Right.addOrReplaceChild("bunch7",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -1.569F, 0.0F, 1.6016F, 1.6F, 1.6016F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch7_r1 = bunch7.addOrReplaceChild("bunch7_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.7207F, -2.44F, 0.1001F, 1.4414F, 2.44F, 1.4414F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.569F, 0.0F, -0.4363F, 0.0F, 0.0F));

		PartDefinition bunch12 = Right.addOrReplaceChild("bunch12",
				CubeListBuilder.create().texOffs(53, 58).addBox(-1.001F, -2.968F, -1.001F, 2.002F, 3.225F, 2.002F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch12_r1 = bunch12.addOrReplaceChild("bunch12_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -2.875F, 0.2002F, 1.6016F, 2.875F, 1.6016F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch13_r1 = bunch13.addOrReplaceChild("bunch13_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -3.175F, 0.2002F, 1.6016F, 3.175F, 1.6016F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.968F, -1.001F, -0.1745F, 0.0F, 0.0F));

		PartDefinition bunch14 = Right.addOrReplaceChild("bunch14",
				CubeListBuilder.create().texOffs(53, 58).addBox(-1.001F, -1.968F, -1.001F, 2.002F, 2.0F, 2.002F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch14_r1 = bunch14.addOrReplaceChild("bunch14_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -2.8F, 0.2002F, 1.6016F, 2.8F, 1.6016F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch16_r1 = bunch16.addOrReplaceChild("bunch16_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -2.85F, 0.2002F, 1.6016F, 2.85F, 1.6016F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch16_r2 = bunch16.addOrReplaceChild("bunch16_r2",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -2.4F, 0.2002F, 1.6016F, 2.4F, 1.6016F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.968F, -1.001F, -0.3927F, 0.0F, 0.0F));
		...
		PartDefinition bunch21_r1 = bunch21.addOrReplaceChild("bunch21_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -2.575F, 0.2002F, 1.6016F, 2.575F, 1.6016F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch22 = Right.addOrReplaceChild("bunch22",
				CubeListBuilder.create().texOffs(53, 58).addBox(0.0F, -0.872F, -0.9009F, 2.8028F, 1.8F, 1.8018F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.003F, -4.004F, -2.002F, -0.214F, -0.1766F, -0.7609F));

		PartDefinition bunch22_r1 = bunch22.addOrReplaceChild("bunch22_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(0.0F, -1.81F, -0.8108F, 3.4735F, 1.62F, 1.6216F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.8028F, 1.028F, 0.0F, 0.0F, 0.0F, -0.5236F));

		PartDefinition bunch23 = Right.addOrReplaceChild("bunch23",
				CubeListBuilder.create().texOffs(53, 58).addBox(0.0F, -0.874F, -0.9009F, 2.8028F, 1.8F, 1.8018F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch23_r1 = bunch23.addOrReplaceChild("bunch23_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(0.0F, -1.81F, -0.8108F, 2.8979F, 1.62F, 1.6216F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.8028F, 1.026F, 0.0F, 0.0F, 0.0F, -0.48F));

		PartDefinition bunch24 = Right.addOrReplaceChild("bunch24",
				CubeListBuilder.create().texOffs(53, 58).addBox(0.0F, -0.871F, -0.9009F, 2.8028F, 1.8F, 1.8018F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.003F, -5.005F, 0.0F, 0.1706F, -0.1996F, -0.7153F));

		PartDefinition bunch24_r1 = bunch24.addOrReplaceChild("bunch24_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(0.0F, -1.81F, -0.8108F, 3.2232F, 1.62F, 1.6216F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.8028F, 1.029F, 0.0F, 0.0F, 0.0F, -0.6545F));
		...
		PartDefinition bunch25_r1 = bunch25.addOrReplaceChild("bunch25_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(0.0F, -1.81F, -0.8108F, 2.3974F, 1.62F, 1.6216F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch27 = Right.addOrReplaceChild("bunch27",
				CubeListBuilder.create().texOffs(53, 58).addBox(0.0F, -0.87F, -0.9009F, 1.8018F, 1.8F, 1.8018F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch27_r1 = bunch27.addOrReplaceChild("bunch27_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(0.0F, -1.81F, -0.8108F, 2.5225F, 1.62F, 1.6216F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch33_r1 = bunch33.addOrReplaceChild("bunch33_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.7007F, -5.4F, 0.3003F, 1.4014F, 1.4F, 1.4014F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch35_r1 = bunch35.addOrReplaceChild("bunch35_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -4.4F, 0.2002F, 1.6016F, 1.4F, 1.6016F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch36_r1 = bunch36.addOrReplaceChild("bunch36_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -6.65F, 0.2002F, 1.6016F, 2.65F, 1.6016F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch37_r1 = bunch37.addOrReplaceChild("bunch37_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -2.5F, 0.2002F, 1.6016F, 2.5F, 1.6016F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch42_r1 = bunch42.addOrReplaceChild("bunch42_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(0.0F, -1.81F, -0.8108F, 2.0721F, 1.62F, 1.6216F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.8028F, 1.026F, 0.0F, 0.0F, 0.0F, -0.4363F));
		...
		PartDefinition bunch43_r1 = bunch43.addOrReplaceChild("bunch43_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(0.0F, -1.81F, -0.8108F, 2.2472F, 1.62F, 1.6216F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.8028F, 1.028F, 0.0F, 0.0F, 0.0F, -0.3054F));
		...
		PartDefinition bunch44_r1 = bunch44.addOrReplaceChild("bunch44_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -4.075F, 0.2002F, 1.6016F, 2.075F, 1.6016F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch45 = Right.addOrReplaceChild("bunch45",
				CubeListBuilder.create().texOffs(53, 58).addBox(-1.001F, -2.971F, -1.001F, 2.002F, 3.0F, 2.002F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch45_r1 = bunch45.addOrReplaceChild("bunch45_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.7507F, -5.2F, 0.2503F, 1.5015F, 2.2F, 1.5015F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch47_r1 = bunch47.addOrReplaceChild("bunch47_r1",
				CubeListBuilder.create().texOffs(53, 58).addBox(-0.8008F, -2.375F, 0.2002F, 1.6016F, 2.375F, 1.6016F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch3_r1 = Bottom.addOrReplaceChild("bunch3_r1",
				CubeListBuilder.create().texOffs(53, 59).addBox(3.3015F, -3.3033F, -2.8473F, 1.8018F, 1.8F, 3.1031F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Top_r1 = Top.addOrReplaceChild("Top_r1",
				CubeListBuilder.create().texOffs(54, 60).addBox(3.3916F, -4.0121F, -2.5826F, 1.6216F, 1.62F, 1.0F,
						new CubeDeformation(0.0F)),
