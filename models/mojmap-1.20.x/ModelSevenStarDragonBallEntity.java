...
public class ModelSevenStarDragonBallEntity<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "sevenstardragonballentity"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Stars = DragonBall.addOrReplaceChild("Stars",
				CubeListBuilder.create().texOffs(13, 15)
						...
						.addBox(0.25F, -0.95F, -1.0F, 0.5F, 0.5F, 0.5F, new CubeDeformation(0.0F)).texOffs(13, 15)
						.addBox(0.0F, 0.55F, -1.0F, 0.5F, 0.5F, 0.5F, new CubeDeformation(0.0F)).texOffs(13, 15)
						.addBox(0.0F, -0.95F, -1.75F, 0.5F, 0.5F, 0.5F, new CubeDeformation(0.0F)).texOffs(13, 15)
