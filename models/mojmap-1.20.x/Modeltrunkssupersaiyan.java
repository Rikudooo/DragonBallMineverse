...
public class Modeltrunkssupersaiyan<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "trunkssupersaiyan"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = bone13.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(39, 1)
						.addBox(-0.5F, -4.0F, -1.0F, 1.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(39, 1)
						.addBox(-0.5F, -1.0F, -7.0F, 1.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, -10.0F, 3.0F, 0.0F, 0.0F, 2.8362F));

		PartDefinition cube_r2 = bone13.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(39, 1).addBox(-0.5F, -2.0F, -1.0F, 1.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, -10.0F, 1.0F, 0.0F, 0.0F, 2.7053F));

		PartDefinition cube_r3 = bone13.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(39, 1).addBox(-0.5F, -3.0F, -1.0F, 1.0F, 7.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, -10.0F, -1.0F, 0.0F, 0.0F, 2.4871F));

		PartDefinition bone12 = bone13.addOrReplaceChild("bone12",
				CubeListBuilder.create().texOffs(39, 1).addBox(-0.2929F, 0.0F, -1.0F, 1.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = bone11.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(39, 1).addBox(-0.5F, -1.0F, -1.0F, 1.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = bone11.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(39, 1).addBox(-0.5F, -6.0F, -1.0F, 1.0F, 10.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone10 = bone11.addOrReplaceChild("bone10",
				CubeListBuilder.create().texOffs(39, 1).addBox(-1.0F, 0.0F, -1.0F, 1.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, -1.0F, -3.25F, -0.6353F, -0.4981F, -2.1457F));

		PartDefinition bone9 = Hair.addOrReplaceChild("bone9",
				CubeListBuilder.create().texOffs(39, 1).addBox(-0.25F, -0.25F, -3.0F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, -9.0F, -4.0F, 1.2053F, -0.147F, -0.3655F));

		PartDefinition bone8 = Hair.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(39, 1).addBox(-0.25F, -0.25F, -3.0F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Hair2 = Hair.addOrReplaceChild("Hair2",
				CubeListBuilder.create().texOffs(39, 1)
						.addBox(-4.0F, -10.0F, -4.0F, 3.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(39, 1)
						.addBox(-4.5F, -9.5F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(39, 1)
						.addBox(-4.5F, -8.65F, -3.85F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(39, 1)
						.addBox(3.5F, -8.65F, -3.85F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(39, 1)
						.addBox(-1.0F, -9.0F, -4.0F, 2.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(39, 1)
						.addBox(-1.25F, -9.5F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(39, 1)
						.addBox(0.25F, -9.5F, -4.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(39, 1)
						.addBox(1.0F, -10.0F, -4.0F, 3.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(39, 1)
						.addBox(2.0F, -12.25F, -4.25F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(39, 1)
						.addBox(-3.0F, -12.25F, -4.25F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r8 = Hair2.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(39, 1).addBox(-1.0F, -5.0F, -0.5F, 2.0F, 9.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -9.0F, 4.5F, 2.9671F, 0.0F, 0.0F));

		PartDefinition cube_r9 = Hair2.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(39, 1).addBox(-1.25F, -5.0F, -0.5F, 2.0F, 9.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11_r1 = cube_r9.addOrReplaceChild("cube_r11_r1",
				CubeListBuilder.create().texOffs(39, 1).mirror()
		...
		PartDefinition cube_r10_r1 = cube_r9.addOrReplaceChild("cube_r10_r1",
				CubeListBuilder.create().texOffs(39, 1).addBox(8.0F, -38.0F, 1.0F, 2.0F, 9.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.25F, 33.0F, -4.5F, -0.0873F, 0.0F, -0.2182F));
