...
public class Modelhair_sbroly_ssj2<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "hair_sbroly_ssj2"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bunch5_r3 = Bottom17.addOrReplaceChild("bunch5_r3",
				CubeListBuilder.create().texOffs(56, 60).mirror()
		...
		PartDefinition bunch5_r4 = Bottom18.addOrReplaceChild("bunch5_r4",
				CubeListBuilder.create().texOffs(51, 58).mirror()
						.addBox(-2.0563F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.4025F, 0.8696F, 4.1343F, -1.4268F, -0.4483F, 0.686F));

		PartDefinition bunch4_r3 = Bottom18.addOrReplaceChild("bunch4_r3",
				CubeListBuilder.create().texOffs(51, 58).mirror()
		...
		PartDefinition bunch5_r5 = Top19.addOrReplaceChild("bunch5_r5",
		...
		PartDefinition bunch5_r6 = Bottom22.addOrReplaceChild("bunch5_r6",
		...
		PartDefinition bunch5_r7 = Bottom13.addOrReplaceChild("bunch5_r7",
				CubeListBuilder.create().texOffs(56, 60).addBox(-1.3413F, -0.8374F, -0.6959F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.6614F, -31.0456F, -1.1421F, -2.3422F, 0.4864F, -0.7071F));
		...
		PartDefinition bunch5_r8 = Bottom14.addOrReplaceChild("bunch5_r8",
				CubeListBuilder.create().texOffs(51, 58).addBox(0.2545F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4025F, 0.8696F, 4.1343F, -1.4268F, 0.4483F, -0.686F));
		...
		PartDefinition bunch5_r9 = Top14.addOrReplaceChild("bunch5_r9",
		...
		PartDefinition bunch5_r10 = Bottom5.addOrReplaceChild("bunch5_r10",
				CubeListBuilder.create().texOffs(56, 60).addBox(-1.3413F, -0.8374F, -0.6959F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.6614F, -31.0456F, -1.1421F, -2.3422F, 0.4864F, -0.7071F));

		PartDefinition bunch4_r4 = Bottom5.addOrReplaceChild("bunch4_r4",
		...
		PartDefinition bunch5_r11 = Bottom6.addOrReplaceChild("bunch5_r11",
				CubeListBuilder.create().texOffs(51, 58).addBox(0.2545F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4025F, 0.8696F, 4.1343F, -1.4268F, 0.4483F, -0.686F));

		PartDefinition bunch4_r5 = Bottom6.addOrReplaceChild("bunch4_r5",
				CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1001F, 1.2323F, 0.4004F, -0.1745F, 0.2182F, 0.0F));
		...
		PartDefinition bunch5_r12 = Top6.addOrReplaceChild("bunch5_r12",
				CubeListBuilder.create().texOffs(54, 59).addBox(0.3952F, -1.4682F, -2.9576F, 1.6216F, 1.62F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0025F, 1.1696F, 4.4343F, -0.5716F, 0.4483F, -0.686F));
		...
		PartDefinition bunch5_r13 = Bottom7.addOrReplaceChild("bunch5_r13",
		...
		PartDefinition bunch5_r14 = Top7.addOrReplaceChild("bunch5_r14",
		...
		PartDefinition bunch6_r11 = Bang9.addOrReplaceChild("bunch6_r11",
				CubeListBuilder.create().texOffs(51, 58).mirror()
						.addBox(-2.0563F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F))
						.mirror(false),
		...
		PartDefinition bunch6_r13 = SuperBang.addOrReplaceChild("bunch6_r13",
				CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch7_r5 = SuperBang2
				.addOrReplaceChild("bunch7_r5",
		...
		PartDefinition bunch7_r6 = SuperBang2.addOrReplaceChild("bunch7_r6",
				CubeListBuilder.create().texOffs(51, 58).mirror()
						.addBox(-1.6684F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.8104F, -0.7773F, -3.1097F, -0.1745F, -0.2182F, 0.0F));
		...
		PartDefinition bunch8_r1 = SuperBang3
		...
		PartDefinition bunch8_r2 = SuperBang3.addOrReplaceChild("bunch8_r2",
				CubeListBuilder.create().texOffs(51, 58).mirror()
						.addBox(-1.6684F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.8104F, -0.7773F, -3.1097F, -0.1745F, -0.2182F, 0.0F));
