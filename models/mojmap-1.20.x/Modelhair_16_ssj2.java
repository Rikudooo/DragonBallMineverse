...
public class Modelhair_16_ssj2<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "hair_16_ssj2"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r3 = hair.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(51, 59).addBox(-0.3594F, -2.3558F, -0.4097F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = hair.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(50, 58).addBox(-2.0938F, -2.45F, -5.9F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = hair.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(50, 58).addBox(-2.0938F, -2.5F, -5.25F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = hair.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(50, 58)
		...
		PartDefinition cube_r8 = hair.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(48, 56)
		...
		PartDefinition bone2 = hair.addOrReplaceChild("bone2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(1.3651F, -31.7645F, -4.9695F, 0.0F, 0.5672F, 3.0107F));
		...
		PartDefinition bone3 = hair.addOrReplaceChild("bone3", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-0.1605F, -30.8642F, -3.259F, 0.5236F, 0.0F, 3.098F));

		PartDefinition cube_r11 = bone3.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(49, 57).addBox(-0.8185F, -1.0772F, -2.077F, 1.3125F, 1.5625F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone = hair.addOrReplaceChild("bone", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-2.0F, -32.0F, -4.0F, 2.252F, -0.7025F, 1.9336F));
