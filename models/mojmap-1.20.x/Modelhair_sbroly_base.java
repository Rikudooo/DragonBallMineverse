...
public class Modelhair_sbroly_base<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "hair_sbroly_base"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Back = Hair.addOrReplaceChild("Back", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.1167F, -29.9912F, 5.3554F, 0.4363F, 0.0F, 0.0F));

		PartDefinition cube_r1 = Back.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(51, 53).addBox(-0.2646F, -2.0883F, -4.5069F, 2.0F, 2.0F, 4.0F,
		...
		PartDefinition cube_r2 = Back.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(51, 53).addBox(-0.6858F, -1.7425F, -1.8311F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = Back.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(51, 53).addBox(-0.429F, -2.6577F, 0.5642F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = Back.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(51, 53).addBox(-1.6154F, -2.0883F, -4.5069F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = Back.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(51, 53).addBox(-1.5122F, -1.7425F, -1.8311F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = Back.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(51, 53).addBox(-2.034F, -2.6577F, 0.5642F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = Back.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(51, 53).addBox(-1.7178F, -2.0676F, -4.491F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = Back.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(51, 53).addBox(-1.6147F, -1.7175F, -1.8369F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = Back.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(51, 53).addBox(-2.1326F, -2.6329F, 0.5357F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = Back.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(51, 53).addBox(-0.1622F, -2.0676F, -4.491F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r17 = Back.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(51, 53).addBox(-0.5833F, -1.7175F, -1.8369F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = Back.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(51, 53).addBox(-0.3304F, -2.6329F, 0.5357F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r34 = Back.addOrReplaceChild("cube_r34",
				CubeListBuilder.create().texOffs(51, 53).addBox(-1.4017F, -1.7208F, -1.8292F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r35 = Back.addOrReplaceChild("cube_r35",
				CubeListBuilder.create().texOffs(51, 53).addBox(-1.5119F, -2.0676F, -4.5461F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r36 = Back.addOrReplaceChild("cube_r36",
				CubeListBuilder.create().texOffs(51, 53).addBox(-1.9339F, -2.6394F, 0.6127F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r37 = Back.addOrReplaceChild("cube_r37",
				CubeListBuilder.create().texOffs(51, 53).addBox(-0.5955F, -0.2775F, -2.2194F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r38 = Back.addOrReplaceChild("cube_r38",
				CubeListBuilder.create().texOffs(51, 53).addBox(-2.2385F, -1.6688F, 0.9341F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r39 = Back.addOrReplaceChild("cube_r39",
				CubeListBuilder.create().texOffs(51, 53).addBox(-1.5627F, -0.94F, -1.8881F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1167F, -2.0621F, -0.087F, -0.8158F, -0.1816F, 0.1896F));

		PartDefinition Back2 = Hair.addOrReplaceChild("Back2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(2.1167F, -29.9912F, 3.3554F, 0.6041F, 0.7318F, 0.4321F));
		...
		PartDefinition Back3 = Hair.addOrReplaceChild("Back3", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-2.1167F, -29.9912F, 3.3554F, 0.6041F, -0.7318F, -0.4321F));

		PartDefinition cube_r79 = Back3.addOrReplaceChild("cube_r79", CubeListBuilder.create().texOffs(51, 53).mirror()
				.addBox(-1.7354F, -2.0883F, -4.5069F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0056F, 2.0666F, -1.8249F, -1.3688F, 0.1657F, 0.6158F));

		PartDefinition cube_r80 = Back3.addOrReplaceChild("cube_r80", CubeListBuilder.create().texOffs(51, 53).mirror()
				.addBox(-1.3142F, -1.7425F, -1.8311F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0056F, 2.0666F, -1.8249F, -1.8283F, 0.2179F, 0.3137F));

		PartDefinition cube_r81 = Back3.addOrReplaceChild("cube_r81",
				CubeListBuilder.create().texOffs(51, 53).mirror()
						.addBox(-1.571F, -2.6577F, 0.5642F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0056F, 2.0666F, -1.8249F, -2.342F, -0.0205F, 0.0629F));

		PartDefinition cube_r82 = Back3.addOrReplaceChild("cube_r82", CubeListBuilder.create().texOffs(51, 53).mirror()
				.addBox(-1.7354F, -2.0883F, -4.5069F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-1.5182F, 3.0868F, -0.4072F, -1.3688F, 0.1657F, 0.6158F));
		...
		PartDefinition cube_r85 = Back3.addOrReplaceChild("cube_r85", CubeListBuilder.create().texOffs(51, 53).mirror()
				.addBox(-0.3846F, -2.0883F, -4.5069F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(1.2084F, 3.0868F, -0.4072F, -1.3688F, -0.1657F, 0.1783F));

		PartDefinition cube_r86 = Back3.addOrReplaceChild("cube_r86", CubeListBuilder.create().texOffs(51, 53).mirror()
				.addBox(-0.4878F, -1.7425F, -1.8311F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(1.2084F, 3.0868F, -0.4072F, -1.8283F, -0.2179F, 0.4804F));

		PartDefinition cube_r87 = Back3.addOrReplaceChild("cube_r87",
				CubeListBuilder.create().texOffs(51, 53).mirror()
						.addBox(0.034F, -2.6577F, 0.5642F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(1.2084F, 3.0868F, -0.4072F, -2.342F, 0.0205F, 0.7312F));

		PartDefinition cube_r88 = Back3.addOrReplaceChild("cube_r88",
				CubeListBuilder.create().texOffs(51, 53).mirror()
						.addBox(-0.2822F, -2.0676F, -4.491F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-0.0897F, -2.2132F, 1.4478F, -0.6558F, -0.0002F, -0.2501F));

		PartDefinition cube_r89 = Back3.addOrReplaceChild("cube_r89", CubeListBuilder.create().texOffs(51, 53).mirror()
				.addBox(-0.3853F, -1.7175F, -1.8369F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-0.0897F, -2.2132F, 1.4478F, -1.0796F, -0.2374F, -0.063F));

		PartDefinition cube_r90 = Back3.addOrReplaceChild("cube_r90",
				CubeListBuilder.create().texOffs(51, 53).mirror()
						.addBox(0.1326F, -2.6329F, 0.5357F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-0.0897F, -2.2132F, 1.4478F, -1.6501F, -0.2241F, 0.2909F));
		...
		PartDefinition cube_r94 = Back3.addOrReplaceChild("cube_r94",
				CubeListBuilder.create().texOffs(51, 53).mirror()
						.addBox(-1.8378F, -2.0676F, -4.491F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-3.1483F, -1.6567F, -0.0362F, -1.0076F, 0.088F, 0.649F));

		PartDefinition cube_r95 = Back3.addOrReplaceChild("cube_r95", CubeListBuilder.create().texOffs(51, 53).mirror()
				.addBox(-1.4167F, -1.7175F, -1.8369F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-3.1483F, -1.6567F, -0.0362F, -1.4526F, 0.2441F, 0.3876F));

		PartDefinition cube_r96 = Back3.addOrReplaceChild("cube_r96",
				CubeListBuilder.create().texOffs(51, 53).mirror()
						.addBox(-1.6696F, -2.6329F, 0.5357F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-3.1483F, -1.6567F, -0.0362F, -1.9985F, 0.1089F, 0.0652F));
		...
		PartDefinition cube_r101 = Back3.addOrReplaceChild("cube_r101",
				CubeListBuilder.create().texOffs(51, 53).mirror()
						.addBox(-1.4167F, -1.7175F, -1.8369F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(-0.1803F, -1.8289F, 0.3481F, -0.9398F, 0.0106F, 0.3237F));
		...
		PartDefinition cube_r109 = Back3.addOrReplaceChild("cube_r109",
				CubeListBuilder.create().texOffs(51, 53).mirror()
						.addBox(-0.3853F, -1.7175F, -1.8369F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(2.229F, -0.3966F, -0.1359F, -1.2129F, -0.0207F, -0.5647F));
		...
		PartDefinition cube_r112 = Back3.addOrReplaceChild("cube_r112",
				CubeListBuilder.create().texOffs(51, 53).mirror()
						.addBox(-0.5983F, -1.7208F, -1.8292F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(1.7681F, 0.5543F, -1.3119F, -1.2461F, -0.0417F, -0.3019F));

		PartDefinition cube_r113 = Back3.addOrReplaceChild("cube_r113",
				CubeListBuilder.create().texOffs(51, 53).mirror()
						.addBox(-0.4881F, -2.0676F, -4.5461F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(1.7681F, 0.5543F, -1.3119F, -0.8579F, 0.1575F, -0.5284F));

		PartDefinition cube_r114 = Back3.addOrReplaceChild("cube_r114",
				CubeListBuilder.create().texOffs(51, 53).mirror()
						.addBox(-0.0661F, -2.6394F, 0.6127F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(1.7681F, 0.5543F, -1.3119F, -1.7393F, 0.0159F, 0.038F));

		PartDefinition cube_r115 = Back3.addOrReplaceChild("cube_r115",
				CubeListBuilder.create().texOffs(51, 53).mirror()
						.addBox(-1.4045F, -0.2775F, -2.2194F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(1.0072F, 3.9345F, 2.873F, -1.6913F, 0.014F, 0.3704F));

		PartDefinition cube_r116 = Back3.addOrReplaceChild("cube_r116",
				CubeListBuilder.create().texOffs(51, 53).mirror()
						.addBox(0.2385F, -1.6688F, 0.9341F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1167F, -2.0621F, -0.087F, -1.2003F, -0.0274F, 0.0281F));

		PartDefinition cube_r117 = Back3.addOrReplaceChild("cube_r117",
				CubeListBuilder.create().texOffs(51, 53).mirror()
						.addBox(-0.4373F, -0.94F, -1.8881F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.1167F, -2.0621F, -0.087F, -0.8158F, 0.1816F, -0.1896F));
		...
		PartDefinition bunch4_r2 = Bottom2.addOrReplaceChild("bunch4_r2",
		...
		PartDefinition bunch5_r3 = Top2.addOrReplaceChild("bunch5_r3",
				CubeListBuilder.create().texOffs(54, 59).addBox(-0.2368F, -1.422F, -3.0352F, 1.6216F, 1.62F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.4934F, 1.0321F, 5.9826F, -1.9506F, -0.7973F, 1.9545F));

		PartDefinition bunch4_r3 = Top2.addOrReplaceChild("bunch4_r3",
		...
		PartDefinition bunch4_r4 = Bottom3.addOrReplaceChild("bunch4_r4",
		...
		PartDefinition bunch4_r5 = Top3.addOrReplaceChild("bunch4_r5",
		...
		PartDefinition Bottom4 = Bang3.addOrReplaceChild("Bottom4", CubeListBuilder.create().texOffs(55, 58)
		...
		PartDefinition bunch5_r4 = Top4.addOrReplaceChild("bunch5_r4",
				CubeListBuilder.create().texOffs(56, 60).addBox(-0.4913F, -0.0085F, -1.4957F, 1.4414F, 1.44F, 2.1622F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bunch5_r5 = Bottom17.addOrReplaceChild("bunch5_r5",
				CubeListBuilder.create().texOffs(56, 60).mirror()
		...
		PartDefinition bunch5_r6 = Bottom18.addOrReplaceChild("bunch5_r6",
				CubeListBuilder.create().texOffs(51, 58).mirror()
						.addBox(-2.0563F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.4025F, 0.8696F, 4.1343F, -1.4268F, -0.4483F, 0.686F));

		PartDefinition bunch4_r6 = Bottom18.addOrReplaceChild("bunch4_r6",
				CubeListBuilder.create().texOffs(51, 58).mirror()
		...
		PartDefinition bunch6_r3 = Top18.addOrReplaceChild("bunch6_r3",
				CubeListBuilder.create().texOffs(54, 59).mirror()
						.addBox(-1.3848F, -1.422F, -3.0352F, 1.6216F, 1.62F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(-4.4934F, 1.0321F, 5.9826F, -1.9506F, 0.7973F, -1.9545F));

		PartDefinition bunch5_r7 = Top18.addOrReplaceChild("bunch5_r7",
				CubeListBuilder.create().texOffs(54, 59).mirror()
						.addBox(-2.0168F, -1.4682F, -2.9576F, 1.6216F, 1.62F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.0025F, 1.1696F, 4.4343F, -0.5716F, -0.4483F, 0.686F));

		PartDefinition bunch4_r7 = Top18.addOrReplaceChild("bunch4_r7",
				CubeListBuilder.create().texOffs(55, 60).mirror()
						.addBox(-1.5894F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0323F, 0.0F, 0.1745F, -0.2182F, 0.0F));
		...
		PartDefinition bunch5_r8 = Top19.addOrReplaceChild("bunch5_r8",
		...
		PartDefinition bunch6_r4 = Top20.addOrReplaceChild("bunch6_r4",
				CubeListBuilder.create().texOffs(56, 60).mirror()
		...
		PartDefinition bunch6_r5 = Bottom21.addOrReplaceChild("bunch6_r5",
				CubeListBuilder.create().texOffs(56, 60).addBox(-1.3413F, -0.8374F, -0.6959F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.6614F, -31.0456F, -1.1421F, -2.3422F, 0.4864F, -0.7071F));
		...
		PartDefinition bunch6_r6 = Bottom22.addOrReplaceChild("bunch6_r6",
				CubeListBuilder.create().texOffs(51, 58).addBox(0.2545F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4025F, 0.8696F, 4.1343F, -1.4268F, 0.4483F, -0.686F));

		PartDefinition bunch5_r9 = Bottom22.addOrReplaceChild("bunch5_r9",
				CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1001F, 1.2323F, 0.4004F, -0.1745F, 0.2182F, 0.0F));
		...
		PartDefinition bunch7_r3 = Top22.addOrReplaceChild("bunch7_r3",
				CubeListBuilder.create().texOffs(54, 59).addBox(-0.2368F, -1.422F, -3.0352F, 1.6216F, 1.62F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.4934F, 1.0321F, 5.9826F, -1.9506F, -0.7973F, 1.9545F));

		PartDefinition bunch6_r7 = Top22.addOrReplaceChild("bunch6_r7",
				CubeListBuilder.create().texOffs(54, 59).addBox(0.3952F, -1.4682F, -2.9576F, 1.6216F, 1.62F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0025F, 1.1696F, 4.4343F, -0.5716F, 0.4483F, -0.686F));

		PartDefinition bunch5_r10 = Top22.addOrReplaceChild("bunch5_r10",
				CubeListBuilder.create().texOffs(55, 60).addBox(-0.0323F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0323F, 0.0F, 0.1745F, 0.2182F, 0.0F));
		...
		PartDefinition Bottom24 = Bang23.addOrReplaceChild("Bottom24", CubeListBuilder.create().texOffs(55, 58)
				.addBox(-0.5714F, -1.052F, -1.9696F, 1.6016F, 1.6F, 2.4024F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition bunch7_r4 = Top24.addOrReplaceChild("bunch7_r4",
				CubeListBuilder.create().texOffs(56, 60).addBox(-0.4913F, -0.0085F, -1.4957F, 1.4414F, 1.44F, 2.1622F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0067F, 0.025F, 0.5236F, 0.0F, 0.0F));
		...
		PartDefinition bunch6_r8 = Bottom13.addOrReplaceChild("bunch6_r8",
				CubeListBuilder.create().texOffs(56, 60).addBox(-0.4274F, -0.4426F, -0.6215F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.8068F, -30.1974F, 0.3136F, 2.5868F, -0.7856F, 2.0333F));

		PartDefinition bunch5_r11 = Bottom13.addOrReplaceChild("bunch5_r11",
				CubeListBuilder.create().texOffs(56, 60).addBox(-1.3413F, -0.8374F, -0.6959F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.6614F, -31.0456F, -1.1421F, -2.3422F, 0.4864F, -0.7071F));
		...
		PartDefinition bunch6_r9 = Bottom14.addOrReplaceChild("bunch6_r9",
				CubeListBuilder.create().texOffs(51, 58).addBox(-0.7736F, -1.5467F, -0.5592F, 1.8018F, 1.8F, 3.8038F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0934F, 1.3321F, 6.4826F, -2.8058F, -0.7973F, 1.9545F));

		PartDefinition bunch5_r12 = Bottom14.addOrReplaceChild("bunch5_r12",
				CubeListBuilder.create().texOffs(51, 58).addBox(0.2545F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4025F, 0.8696F, 4.1343F, -1.4268F, 0.4483F, -0.686F));

		PartDefinition bunch4_r8 = Bottom14.addOrReplaceChild("bunch4_r8",
				CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1001F, 1.2323F, 0.4004F, -0.1745F, 0.2182F, 0.0F));
		...
		PartDefinition bunch6_r10 = Top14.addOrReplaceChild("bunch6_r10",
				CubeListBuilder.create().texOffs(54, 59).addBox(-0.2368F, -1.422F, -3.0352F, 1.6216F, 1.62F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.4934F, 1.0321F, 5.9826F, -1.9506F, -0.7973F, 1.9545F));

		PartDefinition bunch5_r13 = Top14.addOrReplaceChild("bunch5_r13",
				CubeListBuilder.create().texOffs(54, 59).addBox(0.3952F, -1.4682F, -2.9576F, 1.6216F, 1.62F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0025F, 1.1696F, 4.4343F, -0.5716F, 0.4483F, -0.686F));

		PartDefinition bunch4_r9 = Top14.addOrReplaceChild("bunch4_r9",
				CubeListBuilder.create().texOffs(55, 60).addBox(-0.0323F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0323F, 0.0F, 0.1745F, 0.2182F, 0.0F));
		...
		PartDefinition bunch5_r14 = Bottom15.addOrReplaceChild("bunch5_r14",
				CubeListBuilder.create().texOffs(55, 59).addBox(-1.1126F, -1.2629F, -0.3133F, 1.6016F, 1.6F, 2.4024F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5963F, -30.955F, -5.7829F, -0.1567F, 0.6959F, -0.3871F));
		...
		PartDefinition bunch5_r15 = Top15.addOrReplaceChild("bunch5_r15",
				CubeListBuilder.create().texOffs(57, 60).addBox(-1.0325F, -1.0713F, -1.358F, 1.4414F, 1.44F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5963F, 0.7266F, 0.5984F, 0.4978F, 0.6959F, -0.3871F));
		...
		PartDefinition Bottom16 = Bang15.addOrReplaceChild("Bottom16", CubeListBuilder.create().texOffs(55, 58)
				.addBox(-0.5714F, -1.052F, -1.9696F, 1.6016F, 1.6F, 2.4024F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition bunch6_r11 = Top16.addOrReplaceChild("bunch6_r11",
				CubeListBuilder.create().texOffs(56, 60).addBox(-0.4913F, -0.0085F, -1.4957F, 1.4414F, 1.44F, 2.1622F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0067F, 0.025F, 0.5236F, 0.0F, 0.0F));
		...
		PartDefinition bunch6_r12 = Bottom5.addOrReplaceChild("bunch6_r12",
				CubeListBuilder.create().texOffs(56, 60).addBox(-0.4274F, -0.4426F, -0.6215F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.8068F, -30.1974F, 0.3136F, 2.5868F, -0.7856F, 2.0333F));

		PartDefinition bunch5_r16 = Bottom5.addOrReplaceChild("bunch5_r16",
				CubeListBuilder.create().texOffs(56, 60).addBox(-1.3413F, -0.8374F, -0.6959F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.6614F, -31.0456F, -1.1421F, -2.3422F, 0.4864F, -0.7071F));

		PartDefinition bunch4_r10 = Bottom5.addOrReplaceChild("bunch4_r10",
		...
		PartDefinition bunch6_r13 = Bottom6.addOrReplaceChild("bunch6_r13",
				CubeListBuilder.create().texOffs(51, 58).addBox(-0.7736F, -1.5467F, -0.5592F, 1.8018F, 1.8F, 3.8038F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0934F, 1.3321F, 6.4826F, -2.8058F, -0.7973F, 1.9545F));

		PartDefinition bunch5_r17 = Bottom6.addOrReplaceChild("bunch5_r17",
				CubeListBuilder.create().texOffs(51, 58).addBox(0.2545F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4025F, 0.8696F, 4.1343F, -1.4268F, 0.4483F, -0.686F));

		PartDefinition bunch4_r11 = Bottom6.addOrReplaceChild("bunch4_r11",
				CubeListBuilder.create().texOffs(51, 58).addBox(-0.1334F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1001F, 1.2323F, 0.4004F, -0.1745F, 0.2182F, 0.0F));
		...
		PartDefinition bunch6_r14 = Top6.addOrReplaceChild("bunch6_r14",
				CubeListBuilder.create().texOffs(54, 59).addBox(-0.2368F, -1.422F, -3.0352F, 1.6216F, 1.62F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.4934F, 1.0321F, 5.9826F, -1.9506F, -0.7973F, 1.9545F));

		PartDefinition bunch5_r18 = Top6.addOrReplaceChild("bunch5_r18",
				CubeListBuilder.create().texOffs(54, 59).addBox(0.3952F, -1.4682F, -2.9576F, 1.6216F, 1.62F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0025F, 1.1696F, 4.4343F, -0.5716F, 0.4483F, -0.686F));

		PartDefinition bunch4_r12 = Top6.addOrReplaceChild("bunch4_r12",
				CubeListBuilder.create().texOffs(55, 60).addBox(-0.0323F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0323F, 0.0F, 0.1745F, 0.2182F, 0.0F));
		...
		PartDefinition bunch5_r19 = Bottom7.addOrReplaceChild("bunch5_r19",
				CubeListBuilder.create().texOffs(55, 59).addBox(-1.1126F, -1.2629F, -0.3133F, 1.6016F, 1.6F, 2.4024F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5963F, -30.955F, -5.7829F, -0.1567F, 0.6959F, -0.3871F));
		...
		PartDefinition bunch5_r20 = Top7.addOrReplaceChild("bunch5_r20",
				CubeListBuilder.create().texOffs(57, 60).addBox(-1.0325F, -1.0713F, -1.358F, 1.4414F, 1.44F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5963F, 0.7266F, 0.5984F, 0.4978F, 0.6959F, -0.3871F));
		...
		PartDefinition bunch6_r15 = Top8.addOrReplaceChild("bunch6_r15",
				CubeListBuilder.create().texOffs(56, 60).addBox(-0.4913F, -0.0085F, -1.4957F, 1.4414F, 1.44F, 2.1622F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0067F, 0.025F, 0.5236F, 0.0F, 0.0F));
		...
		PartDefinition bunch7_r5 = Bottom9.addOrReplaceChild("bunch7_r5",
				CubeListBuilder.create().texOffs(56, 60).mirror()
						.addBox(-0.5726F, -0.4426F, -0.6215F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(1.8068F, -30.1974F, 0.3136F, 2.5868F, 0.7856F, -2.0333F));

		PartDefinition bunch6_r16 = Bottom9.addOrReplaceChild("bunch6_r16",
				CubeListBuilder.create().texOffs(56, 60).mirror()
						.addBox(0.3413F, -0.8374F, -0.6959F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(2.6614F, -31.0456F, -1.1421F, -2.3422F, -0.4864F, 0.7071F));

		PartDefinition bunch5_r21 = Bottom9.addOrReplaceChild("bunch5_r21",
				CubeListBuilder.create().texOffs(56, 60).mirror()
						.addBox(-2.2235F, -1.6532F, 0.708F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(2.002F, -30.8336F, -5.7678F, -0.4171F, 0.3189F, -0.0649F));
		...
		PartDefinition Top_r14 = Top9.addOrReplaceChild("Top_r14",
				CubeListBuilder.create().texOffs(52, 60).mirror()
						.addBox(-1.2327F, -0.38F, -0.165F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-0.9214F, 1.348F, 0.302F, 0.5429F, 0.3189F, -0.0649F));

		PartDefinition Bang9 = BangSection5.addOrReplaceChild("Bang9", CubeListBuilder.create(),
				PartPose.offset(1.7517F, -0.0883F, -0.3825F));

		PartDefinition Bottom10 = Bang9.addOrReplaceChild("Bottom10", CubeListBuilder.create(),
				PartPose.offset(0.1001F, -1.2012F, -2.002F));

		PartDefinition bunch7_r6 = Bottom10.addOrReplaceChild("bunch7_r6",
				CubeListBuilder.create().texOffs(51, 58).mirror()
						.addBox(-1.0282F, -1.5467F, -0.5592F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(-5.0934F, 1.3321F, 6.4826F, -2.8058F, 0.7973F, -1.9545F));

		PartDefinition bunch6_r17 = Bottom10.addOrReplaceChild("bunch6_r17",
				CubeListBuilder.create().texOffs(51, 58).mirror()
						.addBox(-2.0563F, -1.2574F, -0.7436F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.4025F, 0.8696F, 4.1343F, -1.4268F, -0.4483F, 0.686F));

		PartDefinition bunch5_r22 = Bottom10.addOrReplaceChild("bunch5_r22",
				CubeListBuilder.create().texOffs(51, 58).mirror()
						.addBox(-1.6684F, -1.3112F, -0.4204F, 1.8018F, 1.8F, 3.8038F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(-0.1001F, 1.2323F, 0.4004F, -0.1745F, -0.2182F, 0.0F));
		...
		PartDefinition bunch7_r7 = Top10.addOrReplaceChild("bunch7_r7",
				CubeListBuilder.create().texOffs(54, 59).mirror()
						.addBox(-1.3848F, -1.422F, -3.0352F, 1.6216F, 1.62F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(-4.4934F, 1.0321F, 5.9826F, -1.9506F, 0.7973F, -1.9545F));

		PartDefinition bunch6_r18 = Top10.addOrReplaceChild("bunch6_r18",
				CubeListBuilder.create().texOffs(54, 59).mirror()
						.addBox(-2.0168F, -1.4682F, -2.9576F, 1.6216F, 1.62F, 3.0F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.0025F, 1.1696F, 4.4343F, -0.5716F, -0.4483F, 0.686F));

		PartDefinition bunch5_r23 = Top10.addOrReplaceChild("bunch5_r23",
				CubeListBuilder.create().texOffs(55, 60).mirror()
						.addBox(-1.5894F, -0.0173F, -1.7496F, 1.6216F, 1.62F, 2.0971F, new CubeDeformation(0.0F))
						.mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0323F, 0.0F, 0.1745F, -0.2182F, 0.0F));
