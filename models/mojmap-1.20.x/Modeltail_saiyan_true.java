...
public class Modeltail_saiyan_true<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "tail_saiyan_true"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(55, 61).addBox(-0.9787F, -14.3286F, 1.4893F, 2.0F, 2.0F, 1.0F,
		...
		PartDefinition Tail1 = Body.addOrReplaceChild("Tail1", CubeListBuilder.create(),
				PartPose.offset(0.0213F, 10.7067F, 2.5054F));

		PartDefinition cube_r2 = Tail1.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(53, 59).addBox(-0.9787F, -14.3286F, 2.4893F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Tail2 = Tail1.addOrReplaceChild("Tail2", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.1928F, 2.4742F));

		PartDefinition cube_r3 = Tail2.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(54, 59).addBox(-0.9788F, -9.8484F, 10.9752F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Tail3 = Tail2.addOrReplaceChild("Tail3", CubeListBuilder.create(),
				PartPose.offset(0.0F, -0.955F, 2.0665F));

		PartDefinition cube_r4 = Tail3.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(54, 59).addBox(-0.9788F, -0.982F, 15.9675F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Tail4 = Tail3.addOrReplaceChild("Tail4", CubeListBuilder.create(),
				PartPose.offset(0.0F, -2.433F, 1.2134F));

		PartDefinition cube_r5 = Tail4.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(54, 59).addBox(-0.9788F, -9.605F, 16.3802F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Tail5 = Tail4.addOrReplaceChild("Tail5", CubeListBuilder.create(),
				PartPose.offset(0.0F, -1.5759F, 1.9526F));

		PartDefinition cube_r6 = Tail5.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(54, 59).addBox(-0.9788F, -19.8201F, 8.6669F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Tail6 = Tail5.addOrReplaceChild("Tail6", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0803F, 2.5215F));

		PartDefinition cube_r7 = Tail6.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(54, 59).addBox(-0.9788F, -22.9974F, 0.1675F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Tail7 = Tail6.addOrReplaceChild("Tail7", CubeListBuilder.create(),
				PartPose.offset(0.0F, 1.1055F, 2.0747F));

		PartDefinition cube_r8 = Tail7.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(54, 59).addBox(-0.9788F, -17.5966F, -15.1578F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
