...
public class ModelimperfectCell<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "imperfectcell"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = Head.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(47, 11)
						.addBox(-1.5F, -10.0F, -4.5F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(38, 4)
						.addBox(-4.0F, -11.0F, -3.5F, 8.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(38, 4)
						.addBox(-4.5F, -11.0F, -4.5F, 9.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(38, 4)
						.addBox(-4.5F, -10.0F, -4.5F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(38, 4)
						.addBox(1.5F, -10.0F, -4.5F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(38, 4)
						.addBox(-4.5F, -7.0F, -4.5F, 9.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 1.0F, 0.0F));

		PartDefinition Head_r1 = bone.addOrReplaceChild("Head_r1",
				CubeListBuilder.create().texOffs(40, 34).addBox(-0.5F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F,
		...
		PartDefinition Head_r2 = bone.addOrReplaceChild("Head_r2",
				CubeListBuilder.create().texOffs(40, 34).mirror()
						.addBox(-2.5F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(6.9749F, -11.3536F, -3.0F, 0.0F, 0.0F, 0.7854F));
		...
		PartDefinition cube_r1 = Tail.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(16, 38)
						.addBox(0.125F, -0.75F, -5.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 38)
		...
		PartDefinition cube_r2 = Tail.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 39).addBox(-1.0F, -5.5F, 2.75F, 2.0F, 11.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -8.6915F, 13.3085F, 1.4137F, 0.0F, 0.0F));

		PartDefinition cube_r3 = Tail.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 39).addBox(-1.5F, -4.5F, -1.0F, 3.0F, 11.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = Wings.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(48, 49).addBox(-2.125F, -5.5F, -0.0625F, 5.0F, 13.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = Wings.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(48, 49).addBox(-2.5F, -6.5F, 0.125F, 5.0F, 13.0F, 2.0F,
						new CubeDeformation(0.0F)),
