...
public class Modelhair_16_ssj<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "hair_16_ssj"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r8 = hair.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(50, 58)
		...
		PartDefinition cube_r9 = hair.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(48, 56)
