...
public class ModelOneStarDragonBallEntity<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "onestardragonballentity"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Stars = DragonBall.addOrReplaceChild("Stars", CubeListBuilder.create().texOffs(13, 15).addBox(
				0.25F, -0.2F, -1.0F, 0.5F, 0.5F, 0.5F, new CubeDeformation(0.0F)), PartPose.offset(-0.7F, 6.3F, 0.75F));
