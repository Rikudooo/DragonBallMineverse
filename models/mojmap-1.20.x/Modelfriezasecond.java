...
public class Modelfriezasecond<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "friezasecond"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Ear = Head.addOrReplaceChild("Ear",
				CubeListBuilder.create().texOffs(66, 49)
						.addBox(8.0F, -59.0F, -3.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(66, 49)
						.addBox(8.0F, -59.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(66, 49)
						.addBox(8.0F, -55.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(117, 123)
						.addBox(8.0F, -57.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(66, 49)
		...
		PartDefinition Ear2 = Head.addOrReplaceChild("Ear2",
				CubeListBuilder.create().texOffs(59, 48)
						.addBox(8.0F, -59.0F, -3.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(59, 48)
						.addBox(8.0F, -59.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(59, 48)
						.addBox(8.0F, -55.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(120, 124)
						.addBox(8.0F, -57.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(59, 48)
						.addBox(8.0F, -59.0F, 1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Horn_r1 = Head2.addOrReplaceChild("Horn_r1",
				CubeListBuilder.create().texOffs(104, 120)
						.addBox(-11.0F, -2.0F, -2.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(100, 120)
						.addBox(-5.0F, -2.0F, -2.0F, 10.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Horn_r3 = Head2.addOrReplaceChild("Horn_r3",
				CubeListBuilder.create().texOffs(100, 120).mirror()
						.addBox(30.0F, -57.0F, -2.0F, 10.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 48.0F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition Horn_r4 = Head2
				.addOrReplaceChild("Horn_r4",
						CubeListBuilder.create().texOffs(100, 120).addBox(-40.0F, -57.0F, -2.0F, 10.0F, 4.0F, 4.0F,
		...
		PartDefinition Tail1 = Body.addOrReplaceChild("Tail1", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.04F, 19.27F, 3.5F, 0.0F, 0.0F, -1.5708F));

		PartDefinition cube_r1 = Tail1.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(92, 46).addBox(-1.9F, -2.7149F, -7.5348F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Tail2 = Tail1.addOrReplaceChild("Tail2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 0.05F, 10.0F, 0.0F, 0.0F, 0.9163F));

		PartDefinition cube_r3 = Tail2.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(93, 46).addBox(-2.5F, -2.875F, -1.2327F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Tail3 = Tail2.addOrReplaceChild("Tail3", CubeListBuilder.create(),
				PartPose.offset(0.0F, 4.1F, 2.2F));

		PartDefinition cube_r5 = Tail3.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(92, 46).addBox(-2.5F, 6.125F, -16.3125F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Tail4 = Tail3.addOrReplaceChild("Tail4", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 6.0F, 6.0F, -0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r7 = Tail4.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(92, 46).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = Tail4.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(92, 46).addBox(-2.5F, 15.5625F, -14.8125F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone = Tail4.addOrReplaceChild("bone", CubeListBuilder.create(),
				PartPose.offset(0.0F, -10.15F, -18.2F));

		PartDefinition cube_r13 = bone.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(18, 3).addBox(-2.0F, 0.0F, -2.0F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = bone.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(18, 5).addBox(-2.0F, 0.0F, -2.0F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r15 = bone.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(18, 5)
						.addBox(-2.0F, 0.0F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(18, 5)
						.addBox(-0.1F, 0.0F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0525F, 31.467F, 11.7228F, -2.2166F, 0.0F, 0.0F));

		PartDefinition bone2 = Tail4.addOrReplaceChild("bone2", CubeListBuilder.create(),
				PartPose.offset(0.0F, -10.15F, -18.2F));

		PartDefinition cube_r16 = bone2.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(18, 6).addBox(-2.0F, 0.0F, -2.0F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(80, 32)
				.addBox(-6.0F, -4.0F, -4.0F, 8.0F, 24.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-10.0F, -20.0F, 0.0F));

		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(64, 96)
				.addBox(-2.0F, -4.0F, -4.0F, 8.0F, 24.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(10.0F, -20.0F, 0.0F));

		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(0, 32)
				.addBox(-4.0F, 0.0F, -4.0F, 8.0F, 24.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-3.8F, 0.0F, 0.0F));

		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(32, 96)
				.addBox(-4.0F, 0.0F, -4.0F, 8.0F, 24.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.8F, 0.0F, 0.0F));
