...
public class Modelhair_vegeta<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "hair_vegeta"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hair = Head.addOrReplaceChild("hair", CubeListBuilder.create().texOffs(50, 54)
				.addBox(-1.0F, -37.5017F, -1.5554F, 4.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(53, 57)
				.addBox(-2.125F, -35.5017F, -2.1804F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 57)
				.addBox(-2.125F, -34.0017F, 0.8196F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 57)
				.addBox(-1.125F, -33.5017F, 0.0696F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 57)
				.addBox(-0.625F, -32.5017F, 1.0696F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 57)
				.addBox(-1.625F, -32.7517F, 1.5696F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 57)
				.addBox(-1.375F, -33.0017F, 0.5696F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 57)
				.addBox(-3.0F, -34.9392F, -1.0554F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 57)
				.addBox(-2.375F, -34.2517F, -0.1804F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 57)
				.addBox(-3.625F, -33.6892F, -0.1804F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 57)
				.addBox(-3.0625F, -34.0642F, 0.5696F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 57)
				.addBox(-3.0625F, -33.5642F, 1.8196F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 57)
				.addBox(-0.0625F, -33.5642F, 1.8196F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 57)
				.addBox(-3.0625F, -33.0642F, 0.0696F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 57)
		...
		PartDefinition cube_r1 = hair.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(54, 57).addBox(-0.7123F, -2.5895F, -0.6722F, 3.0F, 5.0F, 2.0F,
		...
		PartDefinition cube_r2 = hair.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(54, 57).addBox(-0.4892F, -4.9037F, -0.4871F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0377F, -30.0372F, -1.0082F, -0.225F, -0.0104F, -0.4753F));

		PartDefinition cube_r3 = hair.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(54, 57).mirror()
				.addBox(-2.2877F, -2.5895F, -0.6722F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r5 = hair.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(54, 57)
				.addBox(1.3233F, -4.9037F, -0.4871F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(54, 57)
				.addBox(-0.4892F, -4.9037F, -0.4871F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = hair.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(54, 57).addBox(-0.7123F, -3.5645F, -0.6722F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r23 = hair.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(54, 57).addBox(-0.7123F, -4.5895F, -0.6722F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r26 = hair.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(54, 57).mirror()
				.addBox(-2.2877F, -2.3895F, -0.6722F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r27 = hair.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(54, 57).addBox(-0.7123F, -2.3895F, -0.6722F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.5873F, -29.7872F, -1.8832F, -2.6822F, -0.3687F, -2.7587F));

		PartDefinition cube_r28 = hair.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(54, 57).addBox(-0.7123F, -2.5895F, -1.9847F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r29 = hair.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(54, 57).addBox(-0.4892F, -4.9037F, -1.7996F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r37 = hair.addOrReplaceChild("cube_r37", CubeListBuilder.create().texOffs(54, 57)
				.addBox(-2.638F, -4.7932F, -1.4503F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(54, 57)
				.addBox(-2.3039F, -5.4461F, -1.7768F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(54, 57)
				.addBox(-0.6961F, -5.1789F, -0.2232F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(54, 57)
				.addBox(-0.362F, -5.8318F, -0.5497F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r44 = hair.addOrReplaceChild("cube_r44",
				CubeListBuilder.create().texOffs(54, 57).addBox(-0.4892F, -3.9037F, -1.7996F, 3.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r49 = hair.addOrReplaceChild("cube_r49", CubeListBuilder.create().texOffs(54, 57)
				.addBox(-0.4892F, -4.9037F, -1.7996F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(54, 57)
				.addBox(-0.4892F, -4.9037F, -0.4871F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.5873F, -31.4747F, -0.2582F, -2.9004F, -0.2929F, -3.1062F));

		PartDefinition cube_r50 = hair.addOrReplaceChild("cube_r50", CubeListBuilder.create().texOffs(54, 57)
				.addBox(-0.7123F, -2.5895F, -1.9847F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(54, 57)
				.addBox(-0.7123F, -2.5895F, -0.6722F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r59 = hair.addOrReplaceChild("cube_r59",
				CubeListBuilder.create().texOffs(54, 57).addBox(-0.7123F, -3.8645F, -0.6722F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r60 = hair.addOrReplaceChild("cube_r60",
				CubeListBuilder.create().texOffs(53, 57).addBox(-0.4892F, -4.9037F, -0.4871F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r61 = hair.addOrReplaceChild("cube_r61",
				CubeListBuilder.create().texOffs(53, 57).addBox(-0.7123F, -2.5895F, -0.6722F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r64 = hair.addOrReplaceChild("cube_r64",
				CubeListBuilder.create().texOffs(53, 57).addBox(-0.375F, -3.75F, -0.375F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r70 = hair.addOrReplaceChild("cube_r70", CubeListBuilder.create().texOffs(54, 55).mirror()
				.addBox(-1.5F, -3.5F, -1.0F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(54, 55)
				.mirror().addBox(-1.5F, -0.5F, 2.0F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r71 = hair.addOrReplaceChild("cube_r71",
				CubeListBuilder.create().texOffs(54, 55).addBox(-1.5F, -3.5F, -1.0F, 3.0F, 7.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r72 = hair.addOrReplaceChild("cube_r72",
				CubeListBuilder.create().texOffs(54, 55).mirror()
						.addBox(-0.9F, -2.6F, 0.6F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r73 = hair.addOrReplaceChild("cube_r73",
				CubeListBuilder.create().texOffs(54, 55).addBox(-2.1F, -2.6F, 0.6F, 3.0F, 7.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0109F, -31.9626F, 4.8556F, -0.8658F, -0.4718F, 0.0344F));
		...
		PartDefinition cube_r75 = hair.addOrReplaceChild("cube_r75",
				CubeListBuilder.create().texOffs(54, 55).addBox(-1.5F, -3.275F, -0.575F, 3.0F, 7.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r76 = hair.addOrReplaceChild("cube_r76",
				CubeListBuilder.create().texOffs(54, 55).mirror()
						.addBox(-1.5F, -3.275F, -0.575F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-4.2686F, -29.0699F, 2.6539F, -1.3684F, -1.1426F, 0.7517F));

		PartDefinition cube_r77 = hair.addOrReplaceChild("cube_r77",
				CubeListBuilder.create().texOffs(54, 55).addBox(-0.6F, -3.2F, -1.0F, 3.0F, 7.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r78 = hair.addOrReplaceChild("cube_r78",
				CubeListBuilder.create().texOffs(54, 55).mirror()
						.addBox(-2.4F, -3.2F, -1.0F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-4.821F, -28.8232F, 0.6879F, -1.8533F, -1.1164F, 1.2281F));

		PartDefinition cube_r79 = hair.addOrReplaceChild("cube_r79",
				CubeListBuilder.create().texOffs(54, 55).mirror()
						.addBox(-2.1F, -1.7F, 0.3F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r80 = hair.addOrReplaceChild("cube_r80",
				CubeListBuilder.create().texOffs(54, 55).addBox(-0.9F, -1.7F, 0.3F, 3.0F, 7.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.5937F, -32.3889F, 4.5589F, -0.7241F, 0.5108F, 0.127F));

		PartDefinition cube_r81 = hair.addOrReplaceChild("cube_r81",
				CubeListBuilder.create().texOffs(54, 55)
						.addBox(-1.5F, -0.5F, 2.0F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(54, 55)
						.addBox(-1.5F, -3.5F, -1.0F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.5937F, -32.3889F, 4.5589F, -0.7979F, 0.36F, -0.0471F));

		PartDefinition cube_r82 = hair.addOrReplaceChild("cube_r82",
				CubeListBuilder.create().texOffs(53, 57).addBox(-0.8434F, -1.1078F, -0.772F, 3.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r92 = hair.addOrReplaceChild("cube_r92",
				CubeListBuilder.create().texOffs(52, 54)
						.addBox(-5.0875F, -0.55F, 0.8812F, 1.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(52, 54)
						.addBox(-4.0875F, -0.55F, 0.8812F, 1.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(52, 54)
						.addBox(-3.0875F, -0.55F, 0.8812F, 1.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(52, 54)
						.addBox(-2.0875F, -0.55F, 0.8812F, 1.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(52, 56)
						.addBox(-2.1875F, -2.75F, 2.2813F, 5.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 56)
						.addBox(-2.1875F, -2.75F, 3.2813F, 5.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 56)
						.addBox(-2.1875F, -2.75F, 4.2813F, 5.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 56)
						.addBox(-2.1875F, -2.75F, 1.2813F, 5.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 56)
						.addBox(-2.1875F, -2.75F, 0.2813F, 5.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 56)
						.addBox(-2.1875F, -2.75F, -0.7188F, 5.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone2 = hair.addOrReplaceChild("bone2", CubeListBuilder.create(),
				PartPose.offset(-0.0212F, -29.5962F, -3.485F));

		PartDefinition cube_r93 = bone2.addOrReplaceChild("cube_r93", CubeListBuilder.create().texOffs(53, 56).mirror()
				.addBox(-0.0388F, -4.9262F, -0.9129F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0564F, 0.0F, 0.0F, 3.1416F, 0.0F, -2.312F));

		PartDefinition cube_r94 = bone2.addOrReplaceChild("cube_r94",
				CubeListBuilder.create().texOffs(53, 56).addBox(-1.9612F, -4.9262F, -0.9129F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone = bone2.addOrReplaceChild("bone", CubeListBuilder.create(),
				PartPose.offset(2.0585F, -3.0036F, 0.9518F));

		PartDefinition cube_r95 = bone.addOrReplaceChild("cube_r95",
				CubeListBuilder.create().texOffs(56, 58).mirror()
						.addBox(-1.625F, -1.9F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-2.0087F, -0.424F, -0.9379F, -3.1024F, 0.0184F, -2.758F));

		PartDefinition cube_r96 = bone.addOrReplaceChild("cube_r96",
				CubeListBuilder.create().texOffs(56, 58).addBox(-0.375F, -1.9F, -1.0F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.066F, -0.424F, -0.9379F, -3.1024F, -0.0184F, 2.758F));

		PartDefinition cube_r97 = bone.addOrReplaceChild("cube_r97", CubeListBuilder.create().texOffs(53, 56).mirror()
				.addBox(-4.0388F, -2.9262F, -0.7879F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-2.0161F, 3.0036F, -0.9518F, 3.1416F, 0.032F, 3.1326F));

		PartDefinition cube_r98 = bone.addOrReplaceChild("cube_r98",
				CubeListBuilder.create().texOffs(53, 56).addBox(2.0388F, -2.9262F, -0.7879F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0585F, 3.0036F, -0.9518F, 3.1416F, -0.032F, -3.1326F));

		PartDefinition cube_r99 = bone.addOrReplaceChild("cube_r99",
				CubeListBuilder.create().texOffs(53, 56).addBox(-0.9612F, -5.9262F, -0.9129F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
