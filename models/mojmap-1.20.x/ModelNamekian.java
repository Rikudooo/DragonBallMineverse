...
public class ModelNamekian<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "namekian"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 22).addBox(
				-4.0F, -5.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 0.0F));

		PartDefinition antenna2 = Head.addOrReplaceChild("antenna2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.1134F, -5.9647F, -5.0879F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r1 = antenna2.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(11, 23).addBox(-0.5F, -0.125F, -1.5F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.2003F, -0.1054F, -1.5836F, 0.2967F, -0.3927F, 0.0F));

		PartDefinition cube_r2 = antenna2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(11, 23).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.8866F, -0.2853F, 1.5879F, 0.0524F, -0.3927F, 0.0F));

		PartDefinition cube_r3 = antenna2.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(11, 23).addBox(-0.5F, -0.125F, -1.5F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.9581F, -0.0412F, -1.7999F, 0.2967F, 0.2443F, 0.0F));

		PartDefinition cube_r4 = antenna2.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(11, 23).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition head_r1 = Ears.addOrReplaceChild("head_r1",
				CubeListBuilder.create().texOffs(21, 32).addBox(-0.425F, -1.0F, -2.4F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, -4.0F, 0.5F, 0.8249F, 0.274F, 0.2849F));

		PartDefinition head_r2 = Ears.addOrReplaceChild("head_r2",
				CubeListBuilder.create().texOffs(21, 32).addBox(-0.25F, -0.7F, -1.5F, 1.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition head_r3 = Ears2.addOrReplaceChild("head_r3",
				CubeListBuilder.create().texOffs(23, 32).mirror()
		...
		PartDefinition Torso = partdefinition.addOrReplaceChild("Torso", CubeListBuilder.create().texOffs(0, 0).addBox(
				-4.0F, -5.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 6.0F, 0.0F));

		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(41, 15)
				.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-6.0F, 1.0F, 0.0F));

		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(25, 15)
				.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(6.0F, 1.0F, 0.0F));

		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(40, 0)
				.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)),
